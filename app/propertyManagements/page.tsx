...
useEffect(() => {
    const node = ref.current; // ✅ Cache the ref value
    ...
    return () => {
        observer.unobserve(node); // ✅ Use cached ref value for cleanup
    };
}, [isVisible]);
...
useEffect(() => {
    ...
    return () => {
        observer.unobserve(node); // ✅ Use the cached ref for cleanup
    };
}, [index]);
