...
import { FileText, Clock, Users, Star, CheckCircle, ArrowRight, Bot, Shield, Zap, BarChart3, Globe, Play, ChevronRight, Brain, Cpu, Database, Settings, Mail, MessageSquare, Smartphone, FolderOpen, Search } from 'lucide-react';
...
export default function MedicalRecordsAIAgent() {
    ...
    const stats = [
        { label: 'Avg Record Retrieval', value: '<5s', icon: Clock, color: 'from-blue-500 to-cyan-500' },
        { label: 'Records Managed', value: '10M+', icon: Database, color: 'from-yellow-500 to-orange-500' },
        { label: 'Compliance Rate', value: '100%', icon: CheckCircle, color: 'from-emerald-500 to-teal-500' },
        { label: 'Supported Integrations', value: '25+', icon: Zap, color: 'from-purple-500 to-pink-500' },
    ];

    const features = [
        {
            title: 'Unified Medical Record Access',
            description: 'Search, retrieve, and manage all patient records instantly from a single dashboard.',
            icon: FolderOpen,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'AI-Powered Data Extraction',
            description: 'Extracts structured data (diagnoses, labs, medications) from unstructured notes and scanned documents.',
            icon: Search,
            gradient: 'from-purple-500 to-pink-500'
        },
        {
            title: 'Automated Summaries',
            description: 'Generate concise summaries for any patient or visit, highlighting key clinical events.',
            icon: FileText,
            gradient: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Role-Based Access Control',
            description: 'Granular permissions ensure only authorized personnel access sensitive health information.',
            icon: Shield,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: 'Interoperability',
            description: 'Seamless integration with major EHR systems, labs, imaging, and telehealth platforms.',
            icon: Globe,
            gradient: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Audit Logs & Compliance',
            description: 'Track every access, modification, and export with full audit trails for HIPAA/GDPR compliance.',
            icon: BarChart3,
            gradient: 'from-pink-500 to-rose-500'
        },
        {
            title: 'Patient Portal Integration',
            description: 'Secure sharing of records and updates directly with patients or caregivers.',
            icon: Users,
            gradient: 'from-rose-500 to-pink-500'
        },
        {
            title: 'Continuous Data Backup',
            description: 'Automated, encrypted backups to ensure data integrity and disaster recovery.',
            icon: Database,
    ...
    const howItWorks = [
        {
            ...
            description: 'User, provider, or patient initiates a request for medical records via the portal or EHR.',
            icon: MessageSquare,
        ...
        },
        {
            ...
            description: 'AI locates all relevant records, regardless of format (EHR, PDF, fax, scanned images).',
            icon: Search,
            color: 'from-purple-500 to-pink-500'
        },
        {
            step: 3,
            title: 'Data Structuring & Summarization',
            description: 'Extracts, organizes, and summarizes information for easy review.',
            icon: FileText,
            color: 'from-emerald-500 to-teal-500'
        },
        {
            step: 4,
            title: 'Secure Delivery & Audit',
            description: 'Records are delivered to authorized users and all actions are logged for compliance.',
            icon: Shield,
    ...
    const integrations = [
        ...
        { name: 'DICOM', category: 'Imaging', logo: '🩻' },
        { name: 'LabCorp', category: 'Lab Data', logo: '🧪' },
        ...
        { name: 'OneDrive', category: 'Cloud', logo: '💾' },
        { name: 'Dropbox', category: 'Cloud', logo: '📁' },
        { name: 'DocuSign', category: 'e-Signature', logo: '✍️' },
    ];

    const channels = [
        { name: 'Web Dashboard', icon: Smartphone, description: 'Manage records anywhere, anytime, on any device.' },
        { name: 'Secure Email', icon: Mail, description: 'Send records or notifications to authorized users.' },
        { name: 'EHR Integration', icon: Database, description: 'Automatic sync and updates in your native EHR.' },
        { name: 'Patient Portal', icon: Users, description: 'Patients access their records directly and securely.' }
    ];

    const benefits = [
        {
            title: 'Faster Record Retrieval',
            description: 'Reduce manual searching—AI finds and organizes records instantly.',
            percentage: '95%',
            metric: 'time savings'
        },
        {
            title: 'Reduce Errors',
            description: 'AI cross-checks identifiers and data to minimize mismatches and duplication.',
            percentage: '98.7%',
            metric: 'accuracy'
        },
        {
            title: 'Boost Compliance',
            description: 'Automated audit trails and role-based access ensure regulatory compliance.',
            percentage: '100%',
            metric: 'compliance rate'
        },
        {
            title: 'Decrease Costs',
            description: 'Eliminate paper and manual workflows, reducing operational costs.',
            percentage: '60%',
            metric: 'cost reduction'
        },
        {
            title: 'Patient Empowerment',
            description: 'Enable patients to view and share their health records securely and easily.',
            percentage: '7x',
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Streamline medical record management with AI. Instantly retrieve, organize, and share patient health records—securely and compliantly.
                    </div>
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            ...
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">Medical Records AI Agent</h3>
                                ...
                                <div className="flex items-center gap-4">
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-emerald-400">&lt;5s</div>
                                        <div className="text-xs text-slate-400">Record Retrieval</div>
                                    </div>
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-blue-400">100%</div>
                            ...
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3 animate-slideInLeft">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Can you retrieve the latest lab results for patient John Doe?</span>
                                        <span className="text-xs text-slate-400 mt-1 block">09:21 AM</span>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '0.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Lab results for John Doe retrieved: CBC (Normal), Glucose (110 mg/dL), Cholesterol (Borderline). Would you like a summary report?</span>
                                        <span className="text-xs text-blue-100 mt-1 block">09:21 AM</span>
                                    </div>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Yes, and please share it with the cardiology team.</span>
                                        <span className="text-xs text-slate-400 mt-1 block">09:22 AM</span>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Summary generated and securely shared with cardiology.</span>
                                        <span className="text-xs text-slate-400 mt-1 block">09:22 AM</span>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> medical records management</span>
                        </h2>
                    </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('channels') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-blue-400 to-cyan-600 bg-clip-text text-transparent"> health systems</span>
                        </h2>
                    </div>
            ...
            <section id="capabilities" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Smarter record management with
                        ...
                        <div className={`relative transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
                            <div className="relative">
                                <div className="relative w-80 h-80 mx-auto">
                                    ...
                                    {[
                                        { label: 'Extraction', angle: 0, color: 'from-blue-500 to-cyan-500' },
                                        { label: 'Summarization', angle: 60, color: 'from-emerald-500 to-teal-500' },
                                        { label: 'Audit', angle: 120, color: 'from-orange-500 to-red-500' },
                                        { label: 'Compliance', angle: 180, color: 'from-purple-500 to-pink-500' },
                                        { label: 'Patient Portal', angle: 240, color: 'from-yellow-500 to-orange-500' },
                                        { label: 'Interoperability', angle: 300, color: 'from-indigo-500 to-purple-500' }
                                    ].map((node, index) => {
                            ...
                            {[
                                {
                                    ...
                                    description: 'Automatically extracts structured data from scanned forms, notes, and PDFs to reduce manual entry.',
                                    icon: Search,
                                    color: 'from-blue-500 to-cyan-500'
                                },
                                {
                                    title: 'Automated Record Summarization',
                                    description: 'Summarizes patient visits, hospitalizations, and labs for quick review.',
                                    icon: FileText,
                                    color: 'from-purple-500 to-pink-500'
                                },
                                {
                                    title: 'Advanced Interoperability',
                                    description: 'Connects effortlessly to EHRs, labs, and imaging for a unified view.',
                                    icon: Globe,
                                    color: 'from-emerald-500 to-teal-500'
                                },
                                {
                                    title: 'Audit & Compliance',
                                    description: 'Logs every access and modification, providing full transparency for HIPAA/GDPR audits.',
                                    icon: BarChart3,
                                    color: 'from-orange-500 to-red-500'
                                },
                                {
                                    title: 'Patient-Centric Access',
                                    description: 'Empowers patients to securely view, download, and share their health data.',
                                    icon: Users,
                                    color: 'from-indigo-500 to-purple-500'
                                },
                                {
                                    title: 'Continuous Backup & Security',
                                    description: 'Encrypts data at rest and in transit, with automated backups for disaster recovery.',
                                    icon: Shield,
            ...
            <section id="cta" className="py-16 sm:py-24 lg:py-32 px-4 bg-gradient-to-br from-slate-900/50 to-slate-800/30">
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        <div className="inline-flex items-center px-4 sm:px-6 py-2 mb-6 sm:mb-8 rounded-full border border-slate-700/50 bg-slate-800/30 backdrop-blur-sm text-xs sm:text-sm text-slate-300">
                            <Zap className="w-4 h-4 mr-2 text-emerald-400" />
                            Ready for next-gen medical records?
                        </div>
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 sm:mb-8 leading-tight">
                            Unlock seamless health data management
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> with AI</span>
                        </h2>
                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Join hospitals, clinics, and practices using AI to manage, share, and secure medical records. Start your journey today—no setup fees or credit card required.
                        </p>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-8 border-t border-slate-700/50">
                            {[
                                ...
                                { label: 'Records Managed', value: '10M+' },
