...
export default function TransactionMonitoringAIAgent() {
    ...
    const stats = [
        { label: 'Detection Speed', value: '<1s', icon: Clock, color: 'from-blue-500 to-cyan-500' },
        { label: 'False Positive Rate', value: '<0.2%', icon: CheckCircle, color: 'from-emerald-500 to-teal-500' },
        { label: 'Fraud Caught', value: '99.9%', icon: Star, color: 'from-yellow-500 to-orange-500' },
    ...
    const features = [
        {
            ...
            description: 'Continuously monitor transactions as they occur, instantly flagging suspicious activity.',
            icon: Zap,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Anomaly Detection',
            description: 'ML models detect outliers and abnormal patterns across millions of transactions.',
            icon: Brain,
            gradient: 'from-purple-500 to-pink-500'
        },
        {
            title: 'Automated Alerts',
            description: 'Send instant alerts to compliance teams and freeze or flag questionable transactions.',
            icon: MessageCircle,
            gradient: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Rule & AI Hybrid Engine',
            description: 'Combine business rules with AI to maximize fraud detection and minimize false positives.',
            icon: Cpu,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: 'Case Management',
            description: 'Automatically create, track, and escalate investigation cases for flagged transactions.',
            icon: Database,
            gradient: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Comprehensive Reporting',
            description: 'Generate regulatory-ready reports for AML, KYC, and fraud audits.',
            icon: BarChart3,
            gradient: 'from-pink-500 to-rose-500'
        },
        {
            title: 'Global Coverage',
            description: 'Monitor cross-border and multi-currency transactions with country-specific compliance.',
            icon: Globe,
            gradient: 'from-amber-500 to-orange-500'
        },
        {
            title: 'Enterprise Security',
            description: 'End-to-end encryption, SOC2/GDPR/PCI compliance, and full audit trails.',
            icon: Shield,
    ...
    const howItWorks = [
        {
            ...
            description: 'AI ingests transaction streams from banking, payments, and financial platforms.',
            icon: MessageSquare,
        ...
        },
        {
            ...
            description: 'AI/ML engines scan each transaction for patterns, anomalies, and rule violations.',
            icon: Brain,
            color: 'from-purple-500 to-pink-500'
        },
        {
            step: 3,
            title: 'Alert & Case Creation',
            description: 'Suspicious transactions trigger alerts and open cases for compliance review.',
            icon: Cpu,
        ...
        },
        {
            ...
            description: 'Compliance teams manage cases, annotate, resolve, and export regulatory reports.',
            icon: Database,
    ...
    const integrations = [
        { name: 'SWIFT', category: 'Banking', logo: '🌐' },
        { name: 'Visa', category: 'Card Network', logo: '💳' },
        { name: 'Mastercard', category: 'Card Network', logo: '💳' },
        { name: 'Stripe', category: 'Payments', logo: '💲' },
        { name: 'PayPal', category: 'Payments', logo: '🅿️' },
        { name: 'Plaid', category: 'Banking', logo: '🏦' },
        { name: 'FinTech APIs', category: 'API', logo: '🔌' },
        ...
        { name: 'KYC/AML Providers', category: 'Compliance', logo: '🛡️' },
    ...
    const channels = [
        { name: 'Web Dashboard', icon: MessageCircle, description: 'Monitor, investigate, and report in real time' },
        { name: 'Email Alerts', icon: Mail, description: 'Receive critical alerts and daily summaries' },
        { name: 'API Integration', icon: Cpu, description: 'Connect transaction streams and automate actions' },
        { name: 'Mobile App', icon: Smartphone, description: 'Investigate and approve on the go' }
    ];

    const benefits = [
        {
            title: 'Prevent Fraud Loss',
            description: 'Detect suspicious transactions before they cause damage.',
            percentage: '99.9%',
            metric: 'fraud caught'
        },
        {
            title: 'Meet Compliance',
            description: 'Generate AML/KYC-ready reports and always stay audit-ready.',
            percentage: '100%',
            metric: 'compliance'
        },
        {
            title: 'Reduce False Positives',
            description: 'AI minimizes noise, letting compliance focus on true risks.',
            percentage: '-80%',
            metric: 'false positive rate'
        },
        {
            title: 'Real-Time Response',
            description: 'Instantly block, hold, or escalate transactions in <1s.',
            percentage: '<1s',
            metric: 'response time'
        },
        {
            title: 'Lower Costs',
            description: 'Automate monitoring and case management, reducing manual review labor.',
            percentage: '65%',
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Instantly detect fraud, comply with AML/KYC, and automate investigations with next-gen AI. Monitor millions of transactions in real time, minimize false positives, and stay audit-ready—24/7.
                    </div>
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            ...
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">Transaction Monitoring AI Agent</h3>
                                        <div className="text-slate-400 text-sm flex items-center gap-2">
                                            <div className="w-2 h-2 bg-emerald-400 rounded-full animate-ping"></div>
                                            Online • Monitoring instantly
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3 animate-slideInLeft">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Alert: Unusual transfer of $50,000 from new account. Flagged for review.</span>
                                        <span className="text-xs text-slate-400 mt-1 block">15:22</span>
                                    </div>
                                </div>
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '0.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Case opened. Compliance team notified. All transaction details and risk scores attached.</span>
                                        <span className="text-xs text-blue-100 mt-1 block">15:22</span>
                                    </div>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Please generate a summary report for all flagged transactions this week.</span>
                                        <span className="text-xs text-slate-400 mt-1 block">15:23</span>
                                    </div>
                                </div>
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1.2s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">And export all open cases to the compliance dashboard.</span>
                                        <span className="text-xs text-slate-400 mt-1 block">15:24</span>
                                    </div>
                                </div>
                            </div>
                            {/* Typing Indicator */}
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('how-it-works') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            From transaction to insight in
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> secure monitoring</span>
                        </h2>
                    </div>
            ...
            <section id="channels" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('channels') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Integrate monitoring with all your
                            <span className="bg-gradient-to-r from-blue-400 to-cyan-600 bg-clip-text text-transparent"> financial systems</span>
                        </h2>
                    </div>
            ...
            <section id="capabilities" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Advanced AI for
                            <span className="bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent"> fraud prevention</span>
                        </h2>
                    </div>
                            ...
                            <div className="relative">
                                <div className="relative w-80 h-80 mx-auto">
                                    ...
                                    {[
                                        ...
                                        { label: 'Rules', angle: 60, color: 'from-emerald-500 to-teal-500' },
                                        { label: 'KYC', angle: 120, color: 'from-orange-500 to-red-500' },
                            ...
                            {[
                                {
                                    ...
                                    description: 'AI learns evolving fraud tactics, catching new and unseen threats.',
                                    icon: Brain,
                                    color: 'from-blue-500 to-cyan-500'
                                },
                                {
                                    title: 'Hybrid Rule & AI Engine',
                                    description: 'Combines your rules with advanced AI for maximum detection coverage.',
                                    icon: Cpu,
                                    color: 'from-purple-500 to-pink-500'
                                },
                                {
                                    title: 'KYC/AML Compliance',
                                    description: 'Integrated third-party checks and instant reporting for AML audits.',
                                    icon: Shield,
                                    color: 'from-emerald-500 to-teal-500'
                                },
                                {
                                    title: 'Real-Time Analytics',
                                    description: 'Drill down into transaction patterns, risk hotspots, and case resolution.',
                                    icon: BarChart3,
                                    color: 'from-orange-500 to-red-500'
                                },
                                {
                                    title: 'Enterprise Security',
                                    description: 'SOC2, PCI DSS, and GDPR ready. All data is encrypted and auditable.',
                                    icon: Shield,
                                    color: 'from-indigo-500 to-purple-500'
                                },
                                {
                                    title: 'API-First Integration',
                                    description: 'Plug into any banking, payment, or compliance infrastructure.',
                                    icon: Cpu,
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 sm:mb-8 leading-tight">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> Transaction Monitoring AI</span>
                        </h2>
                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Join financial institutions and fintechs worldwide using AI to safeguard every transaction. Try it free. Stop fraud before it starts.
                        </p>
                        {/* Trust Indicators */}
