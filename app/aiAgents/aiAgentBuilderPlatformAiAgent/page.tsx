...
export default function AiAgentBuilderPlatformAIAgent() {
    ...
    const stats = [
        { label: 'Agents Built', value: '200K+', icon: LayoutGrid, color: 'from-blue-500 to-cyan-500' },
        { label: 'Avg Build Time', value: '5m', icon: Clock, color: 'from-yellow-500 to-orange-500' },
        { label: 'Custom Integrations', value: '50+', icon: Code, color: 'from-emerald-500 to-teal-500' },
    ...
    const features = [
        {
            ...
            description: 'Design and deploy AI agents with a drag-and-drop interface—no coding required.',
            icon: LayoutGrid,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Custom Code & Extensions',
            description: 'Add custom scripts, logic, and integrations to make your agent unique.',
            icon: Code,
            gradient: 'from-purple-500 to-pink-500'
        },
        {
            title: 'Multi-Channel Deployment',
            description: 'Launch your AI agent on web, mobile, chat, email, and phone—all from one dashboard.',
            icon: Globe,
            gradient: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Built-in Integrations',
            description: 'Connect instantly with CRMs, databases, APIs, and cloud platforms.',
            icon: Database,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: 'Template Library',
            description: 'Start from industry-specific templates for support, sales, HR, IT, and more.',
            icon: FileText,
            gradient: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Live Testing & Debugging',
            description: 'Test your agents in real time with detailed logs and step-by-step debugging tools.',
            icon: Cpu,
            gradient: 'from-pink-500 to-rose-500'
        },
        {
            title: 'Enterprise Security',
            description: 'SOC 2, GDPR, and encrypted data storage with full audit trails.',
            icon: Shield,
            gradient: 'from-amber-500 to-orange-500'
        },
        {
            title: 'Collaboration & Versioning',
            description: 'Invite team members, manage permissions, and track all changes.',
            icon: Users,
    ...
    const howItWorks = [
        {
            ...
            description: 'Select a pre-built template or build your own with easy drag-and-drop tools.',
            icon: FileText,
        ...
        },
        {
            ...
            description: 'Configure workflows, add knowledge, connect APIs, and brand the experience.',
            icon: Settings,
        ...
        },
        {
            step: 3,
            title: 'Test & Deploy',
            description: 'Run live tests, debug, and deploy your agent across all channels with just a click.',
            icon: Upload,
        ...
        },
        {
            ...
            description: 'Track analytics, iterate workflows, and update your AI agent as your needs evolve.',
            icon: BarChart3,
    ...
    const integrations = [
        ...
        { name: 'Custom API', category: 'Integrations', logo: '🔗' },
    ];

    const channels = [
        { name: 'Website Widget', icon: Globe, description: 'Embed AI agents on any website or web app' },
        { name: 'Mobile App', icon: Smartphone, description: 'Deploy agents for native iOS and Android apps' },
        { name: 'Email Bot', icon: Mail, description: 'Automate responses and workflows for email' },
        { name: 'Phone/IVR', icon: Phone, description: 'Voice-enabled agents for customer support lines' }
    ];

    const benefits = [
        {
            title: 'Accelerate AI Adoption',
            description: 'Build, customize, and deploy business AI agents in minutes, not months.',
            percentage: '10x',
            metric: 'faster launch'
        },
        {
            title: 'Reduce IT Costs',
            description: 'No-code tools and reusable components mean less engineering overhead.',
            percentage: '60%',
            metric: 'cost savings'
        },
        {
            title: 'Enterprise-Grade Security',
            description: 'Keep your data safe and compliant across all integrations and channels.',
            percentage: 'SOC 2',
            metric: 'certified'
        },
        {
            title: 'Total Flexibility',
            description: 'Support every workflow, department, and use case with a modular builder.',
            percentage: '∞',
            metric: 'customization'
        },
        {
            title: 'Continuous Optimization',
            description: 'Iterate, test, and improve your agents with real-time analytics.',
            percentage: '24/7',
            metric: 'agility'
        }
    ];
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">AI Agent Builder</h3>
                                        <div className="text-slate-400 text-sm flex items-center gap-2">
                                            <div className="w-2 h-2 bg-emerald-400 rounded-full animate-ping"></div>
                                            Online • Building custom agents
                                        </div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-blue-400">5m</div>
                            ...
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3 animate-slideInLeft">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Can I connect my CRM and Slack to my agent?</span>
                                ...
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '0.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Yes! Choose integrations in the builder and deploy on Slack, web, or any channel instantly.</span>
                                        <span className="text-xs text-blue-100 mt-1 block">1:23 PM</span>
                                    </div>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Do I need to write any code?</span>
                                        <span className="text-xs text-slate-400 mt-1 block">1:24 PM</span>
                                    </div>
                                </div>
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '1.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Not at all! But if you want, add custom scripts for advanced logic and integrations.</span>
                                        <span className="text-xs text-blue-100 mt-1 block">1:24 PM</span>
                                    </div>
                                    <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center">
                                        <Bot className="w-4 h-4 text-white" />
                                    </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> build smarter</span>
                        </h2>
                    </div>
            ...
            <section id="channels" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('channels') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Launch across every
                            <span className="bg-gradient-to-r from-blue-400 to-cyan-600 bg-clip-text text-transparent"> business touchpoint</span>
                        </h2>
                    </div>
            ...
            <section id="benefits" className="py-16 sm:py-24 lg:py-32 px-4 bg-gradient-to-br from-slate-900/50 to-slate-800/30">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('benefits') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Deliver value with
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> every agent built</span>
                        </h2>
                    </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent"> build advanced AI</span>
                        </h2>
                    </div>
                        ...
                        <div className={`relative transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
                            <div className="relative">
                                <div className="relative w-80 h-80 mx-auto">
                                    ...
                                    {[
                                        { label: 'No-Code', angle: 0, color: 'from-blue-500 to-cyan-500' },
                                        { label: 'Custom Logic', angle: 60, color: 'from-emerald-500 to-teal-500' },
                                        ...
                                        { label: 'Collaboration', angle: 300, color: 'from-indigo-500 to-purple-500' }
                                    ].map((node, index) => {
                            ...
                            {[
                                {
                                    ...
                                    description: 'Easily create and connect workflows, skills, and integrations using an intuitive UI.',
                                    icon: LayoutGrid,
                                    color: 'from-blue-500 to-cyan-500'
                                },
                                {
                                    title: 'Custom Scripting',
                                    description: 'Add JavaScript, Python, or Node.js for advanced logic and behaviors.',
                                    icon: Code,
                                    color: 'from-purple-500 to-pink-500'
                                },
                                {
                                    title: 'Real-Time Collaboration',
                                    description: 'Build, review, and deploy AI agents as a team, with version control.',
                                    icon: Users,
                                    color: 'from-emerald-500 to-teal-500'
                                },
                                {
                                    title: 'Comprehensive Analytics',
                                    description: 'Monitor performance, engagement, and improvement opportunities.',
                                    icon: BarChart3,
                                    color: 'from-orange-500 to-red-500'
                                },
                                {
                                    title: 'Enterprise Security',
                                    description: 'Full encryption, RBAC, and compliance for sensitive workflows.',
                                    icon: Shield,
                                    color: 'from-indigo-500 to-purple-500'
                                },
                                {
                                    title: 'Multi-Channel Deployment',
                                    description: 'Go live on web, mobile, chat, phone, and more from a single interface.',
                                    icon: Globe,
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 sm:mb-8 leading-tight">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> AI Agent Builder Platform</span>
                        </h2>
                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Join thousands of businesses building custom AI solutions—no code, instant deployment, endless possibilities.
                        </p>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-8 border-t border-slate-700/50">
                            {[
                                { label: 'No-Code Builder', value: 'Drag & Drop' },
