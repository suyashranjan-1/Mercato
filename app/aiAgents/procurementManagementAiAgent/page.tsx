...
export default function ProcurementManagementAIAgent() {
    ...
    // --- DATA for ProcurementManagementAIAgent ---

    const stats = [
        { label: 'Order Cycle Time', value: '-43%', icon: Clock, color: 'from-blue-500 to-cyan-500' },
        { label: 'Savings Identified', value: '+19%', icon: Star, color: 'from-yellow-500 to-orange-500' },
        { label: 'Contract Compliance', value: '99.8%', icon: CheckCircle, color: 'from-emerald-500 to-teal-500' },
        { label: 'System Uptime', value: '99.99%', icon: Zap, color: 'from-purple-500 to-pink-500' },
    ];

    const features = [
        {
            title: 'Automated Purchase Requests',
            description: 'Streamline and automate PR/PO creation, approval routing, and supplier selection with smart templates.',
            icon: Zap,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Supplier Insights & Scorecards',
            description: 'AI evaluates supplier performance, risk, and compliance using real-time analytics and historic data.',
            icon: BarChart3,
            gradient: 'from-purple-500 to-pink-500'
        },
        {
            title: 'Contract & Policy Enforcement',
            description: 'Enforce negotiated contracts, policy adherence, and approval rules in every transaction.',
            icon: Shield,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: 'Spend Analysis & Cost Optimization',
            description: 'AI categorizes spend, reveals savings opportunities, and automates compliance checks.',
            icon: Database,
            gradient: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Real-Time Inventory Insights',
            description: 'Get proactive alerts on low stock, demand surges, or supplier delays across all locations.',
            icon: Brain,
            gradient: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Multi-Channel Request Handling',
            description: 'Manage procurement tickets, queries, and approvals via chat, email, mobile app, or portal.',
            icon: MessageCircle,
            gradient: 'from-pink-500 to-rose-500'
        },
        {
            title: 'Supplier Collaboration',
            description: 'Secure supplier portals for bids, order status, document exchange, and direct messaging.',
            icon: Users,
            gradient: 'from-rose-500 to-pink-500'
        },
        {
            title: 'Audit Trail & Compliance',
            description: 'Automated logging, digital signatures, and audit-ready records for every procurement action.',
            icon: Settings,
    ...
    const howItWorks = [
        {
            ...
            description: 'Employee starts a PR via chat, portal, or email; AI guides compliant input and auto-fills details.',
            icon: MessageSquare,
        ...
        },
        {
            ...
            description: 'AI checks policy, budget, and contract compliance, routes to approvers, and flags exceptions.',
            icon: Brain,
            color: 'from-purple-500 to-pink-500'
        },
        {
            step: 3,
            title: 'Supplier Selection & Order',
            description: 'Best-fit supplier is recommended via AI scoring; PO is generated and sent automatically.',
            icon: Cpu,
        ...
        },
        {
            ...
            description: 'Order status, delivery, and spend are tracked end-to-end; full audit trail is maintained.',
            icon: Database,
    ...
    const integrations = [
        ...
        { name: 'Coupa', category: 'Spend Management', logo: '💳' },
        { name: 'Oracle Procurement Cloud', category: 'ERP', logo: '☁️' },
        { name: 'NetSuite', category: 'ERP', logo: '💼' },
        { name: 'Workday', category: 'Finance', logo: '📊' },
        ...
        { name: 'Box', category: 'Document Storage', logo: '🗂️' }
    ];

    const channels = [
        { name: 'Web Portal', icon: Globe, description: 'Centralized procurement dashboard and request portal' },
        { name: 'Mobile App', icon: Smartphone, description: 'Approve, track, and request on-the-go' },
        { name: 'Email Approvals', icon: Mail, description: 'Approve or comment on requests by email' },
        { name: 'Chat & Collaboration', icon: MessageCircle, description: 'Procurement actions in Slack, Teams, or chat' }
    ];

    const benefits = [
        {
            title: 'Accelerate Procure-to-Pay',
            description: 'AI reduces cycle times and manual touchpoints, making purchasing fast and compliant.',
            percentage: '43%',
            metric: 'faster cycle'
        },
        {
            title: 'Increase Cost Savings',
            description: 'Identify duplicate spend, leverage contracts, and negotiate smarter with AI insights.',
            percentage: '19%',
            metric: 'savings found'
        },
        {
            title: 'Boost Compliance',
            description: 'Ensure every transaction meets company and regulatory policies with automated checks.',
            percentage: '99.8%',
            metric: 'compliance'
        },
        {
            title: 'Empower Teams',
            description: 'Let employees request, approve, and track from any device, anywhere.',
            percentage: '5x',
            metric: 'team efficiency'
        },
        {
            title: 'Reduce Supplier Risk',
            description: 'AI alerts you to supplier issues and provides full transparency for every transaction.',
            percentage: '-37%',
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Transform your procurement lifecycle with <span className="text-white font-medium">AI-powered automation, cost savings, and compliance</span>. Accelerate purchasing, empower teams, and mitigate supplier risk—all in real time and across every channel.
                    </div>
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            ...
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">Procurement Management AI Agent</h3>
                                        <div className="text-slate-400 text-sm flex items-center gap-2">
                                            <div className="w-2 h-2 bg-emerald-400 rounded-full animate-ping"></div>
                                            Online • Managing procurement
                                        </div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-blue-400">-43%</div>
                                        <div className="text-xs text-slate-400">Order Cycle</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3 animate-slideInLeft">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">I need to order more laptops for our team. Is Lenovo a preferred supplier?</span>
                                        <span className="text-xs text-slate-400 mt-1 block">9:22 AM</span>
                                    </div>
                                </div>
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '0.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Yes, Lenovo is preferred with a negotiated contract. I’ve created a PR for 15 units. Please review and approve.</span>
                                        <span className="text-xs text-blue-100 mt-1 block">9:22 AM</span>
                                    </div>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Can I see spend analytics for IT hardware this quarter?</span>
                                        <span className="text-xs text-slate-400 mt-1 block">9:23 AM</span>
                                    </div>
                                </div>
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '1.2s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Absolutely! Here’s a breakdown by supplier and category. Would you like to export or schedule a report?</span>
                                        <span className="text-xs text-blue-100 mt-1 block">9:23 AM</span>
                                    </div>
                                    <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center">
                                        <Bot className="w-4 h-4 text-white" />
                                    </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('how-it-works') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            From request to fulfillment in
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> modern procurement</span>
                        </h2>
                    </div>
            ...
            <section id="capabilities" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Smart AI for every procurement
                            <span className="bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent"> action and team</span>
                        </h2>
                    </div>
                            ...
                            <div className="relative">
                                <div className="relative w-80 h-80 mx-auto">
                                    ...
                                    {[
                                        ...
                                        { label: 'Inventory', angle: 120, color: 'from-orange-500 to-red-500' },
                                        { label: 'Analytics', angle: 180, color: 'from-purple-500 to-pink-500' },
                                        { label: 'Supplier', angle: 240, color: 'from-yellow-500 to-orange-500' },
                                        { label: 'Integration', angle: 300, color: 'from-indigo-500 to-purple-500' }
                                    ].map((node, index) => {
                            ...
                            {[
                                {
                                    ...
                                    description: 'AI ensures every procurement follows company policy, budget limits, and approval flows.',
                                    icon: Settings,
                                    color: 'from-blue-500 to-cyan-500'
                                },
                                {
                                    title: 'Compliance & Audit',
                                    description: 'Automated compliance checks and audit-ready records for every transaction.',
                                    icon: Shield,
                                    color: 'from-purple-500 to-pink-500'
                                },
                                {
                                    title: 'Inventory Optimization',
                                    description: 'Predicts stockouts, demand surges, and automates reorder points for every location.',
                                    icon: Database,
                                    color: 'from-emerald-500 to-teal-500'
                                },
                                {
                                    title: 'Spend & Savings Analytics',
                                    description: 'Analyzes spend, finds cost savings, and optimizes contract utilization.',
                                    icon: BarChart3,
                                    color: 'from-orange-500 to-red-500'
                                },
                                {
                                    title: 'Supplier Management',
                                    description: 'AI-powered supplier scorecards, risk alerts, and bid automation.',
                                    icon: Users,
                                    color: 'from-yellow-500 to-orange-500'
                                },
                                {
                                    title: 'Multi-System Integration',
                                    description: 'Connects with ERP, e-signature, analytics, and collaboration tools.',
                                    icon: Globe,
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Get started with guided onboarding, expert procurement support, and proven compliance workflows. Unlock savings, speed, and transparency for your business.
                        </p>
