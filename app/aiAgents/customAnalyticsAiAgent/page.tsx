...
export default function CustomAnalyticsAIAgent() {
    ...
    const stats = [
        { label: 'Dashboards Deployed', value: '10K+', icon: BarChart3, color: 'from-blue-500 to-cyan-500' },
        { label: 'Avg Query Time', value: '<2s', icon: Clock, color: 'from-yellow-500 to-orange-500' },
        { label: 'Data Sources Connected', value: '75+', icon: Database, color: 'from-emerald-500 to-teal-500' },
    ...
    const features = [
        {
            ...
            description: 'AI finds trends, anomalies, and actionable insights in your data automatically.',
            icon: Brain,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Custom Dashboard Builder',
            description: 'Drag-and-drop dashboards, charts, and widgets tailored to your KPIs.',
            icon: LayoutGrid,
            gradient: 'from-purple-500 to-pink-500'
        },
        {
            title: 'Natural Language Queries',
            description: 'Ask questions in plain English and get instant answers or visualizations.',
            icon: MessageCircle,
            gradient: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Real-Time Analytics',
            description: 'Stream, process, and visualize live data for up-to-the-second decisions.',
            icon: BarChart3,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: 'Multi-Source Integration',
            description: 'Combine data from SQL, NoSQL, spreadsheets, APIs, and cloud sources.',
            icon: Database,
            gradient: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Predictive Analytics',
            description: 'Use AI to forecast trends and outcomes for smarter planning.',
            icon: LineChart,
            gradient: 'from-pink-500 to-rose-500'
        },
        {
            title: 'Automated Reports',
            description: 'Schedule and deliver interactive reports to your team or clients.',
            icon: FileText,
            gradient: 'from-rose-500 to-pink-500'
        },
        {
            title: 'Enterprise Security',
            description: 'SOC 2, GDPR, and end-to-end encryption for all analytics and data.',
            icon: Shield,
    ...
    const howItWorks = [
        {
            ...
            description: 'Securely link databases, APIs, spreadsheets and more to the analytics agent.',
            icon: Database,
            color: 'from-blue-500 to-cyan-500'
        },
        {
            step: 2,
            title: 'Ask Questions or Set KPIs',
            description: 'Use natural language or visual builder to define what matters for your business.',
            icon: MessageCircle,
        ...
        },
        {
            ...
            description: 'Agent generates dashboards, insights, and alerts tailored to your needs.',
            icon: PieChart,
        ...
        },
        {
            ...
            description: 'Distribute dashboards, schedule reports, and trigger workflow automations.',
            icon: Cpu,
    ...
    const integrations = [
        { name: 'Google Analytics', category: 'Web', logo: '📈' },
        { name: 'BigQuery', category: 'Cloud Data', logo: '🌐' },
        ...
        { name: 'Looker', category: 'BI', logo: '👁️' },
        { name: 'Custom API', category: 'Data', logo: '🔗' },
    ];

    const channels = [
        { name: 'Web Dashboard', icon: Globe, description: 'Access analytics on any web browser' },
        { name: 'Mobile App', icon: Smartphone, description: 'Monitor KPIs and receive alerts on mobile' },
        { name: 'Email Reports', icon: Mail, description: 'Get scheduled insight reports via email' },
        { name: 'Chat Integration', icon: MessageCircle, description: 'Ask questions and get analytics in chat' }
    ];

    const benefits = [
        {
            title: 'Faster Data-Driven Decisions',
            description: 'Instantly surface insights and trends, reducing manual data crunching.',
            percentage: '7x',
            metric: 'decision speed'
        },
        {
            title: 'Save Analyst Hours',
            description: 'Automate reports, alerts, and data cleaning with AI.',
            percentage: '65%',
            metric: 'time saved'
        },
        {
            title: 'Increase Data Adoption',
            description: 'Make analytics accessible to everyone with natural language queries.',
            percentage: '3x',
            metric: 'more users'
        },
        {
            title: 'Boost Accuracy',
            description: 'Reduce human error and bias with automated, repeatable analyses.',
            percentage: '98%',
            metric: 'accuracy'
        },
        {
            title: 'Secure Sensitive Data',
            description: 'Enterprise-grade encryption, access controls, and audit logs.',
            percentage: 'SOC 2',
            metric: 'certified'
        }
    ];
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Transform raw data into actionable insights with an AI agent that automates analytics, reporting, and dashboarding—tailored for your unique business needs.
                    </div>
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">Analytics AI Assistant</h3>
                                        <div className="text-slate-400 text-sm flex items-center gap-2">
                                            <div className="w-2 h-2 bg-emerald-400 rounded-full animate-ping"></div>
                                            Online • Generating Insights
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3 animate-slideInLeft">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Show me the sales trend for the last 12 months.</span>
                                        <span className="text-xs text-slate-400 mt-1 block">2:05 PM</span>
                                    </div>
                                </div>
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '0.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Here’s a line chart with monthly sales and a forecast for the next quarter.</span>
                                        <span className="text-xs text-blue-100 mt-1 block">2:05 PM</span>
                                    </div>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Notify me if churn rate spikes above 5%.</span>
                                        <span className="text-xs text-slate-400 mt-1 block">2:06 PM</span>
                                    </div>
                                </div>
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '1.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Alert rule created! You’ll receive instant notifications for churn spikes.</span>
                                        <span className="text-xs text-blue-100 mt-1 block">2:06 PM</span>
                                    </div>
                                    <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center">
                                        <Bot className="w-4 h-4 text-white" />
                                    </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> smarter analytics</span>
                        </h2>
                    </div>
            ...
            <section id="channels" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('channels') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Share insights across every
                            <span className="bg-gradient-to-r from-blue-400 to-cyan-600 bg-clip-text text-transparent"> business channel</span>
                        </h2>
                    </div>
            ...
            <section id="benefits" className="py-16 sm:py-24 lg:py-32 px-4 bg-gradient-to-br from-slate-900/50 to-slate-800/30">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('benefits') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Unlock insights and
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> empower your team</span>
                        </h2>
                    </div>
            ...
            <section id="capabilities" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Powering
                            <span className="bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent"> advanced analytics</span>
                        </h2>
                    </div>
                            ...
                            <div className="relative">
                                <div className="relative w-80 h-80 mx-auto">
                                    ...
                                    {[
                                        ...
                                        { label: 'Realtime', angle: 60, color: 'from-emerald-500 to-teal-500' },
                                        { label: 'Predictive', angle: 120, color: 'from-orange-500 to-red-500' },
                                        { label: 'Multi-Source', angle: 180, color: 'from-purple-500 to-pink-500' },
                            ...
                            {[
                                {
                                    ...
                                    description: 'Ask questions in plain language and get instant, actionable insights.',
                                    icon: MessageCircle,
                                    color: 'from-blue-500 to-cyan-500'
                                },
                                {
                                    title: 'Realtime Data Processing',
                                    description: 'Stream and analyze high-velocity data for live dashboards and alerts.',
                                    icon: BarChart3,
                                    color: 'from-purple-500 to-pink-500'
                                },
                                {
                                    title: 'Predictive Analytics',
                                    description: 'Use ML/AI to forecast sales, churn, and business KPIs.',
                                    icon: LineChart,
                                    color: 'from-emerald-500 to-teal-500'
                                },
                                {
                                    title: 'Data Integration',
                                    description: 'Connect and blend data from APIs, databases, and files.',
                                    icon: Database,
                                    color: 'from-orange-500 to-red-500'
                                },
                                {
                                    title: 'Enterprise Security',
                                    description: 'End-to-end encryption, RBAC, and compliance for all analytics.',
                                    icon: Shield,
                                    color: 'from-indigo-500 to-purple-500'
                                },
                                {
                                    title: 'Workflow Automation',
                                    description: 'Trigger alerts, schedule reports, and automate analytics tasks.',
                                    icon: Cpu,
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 sm:mb-8 leading-tight">
                            Start unlocking insights with your
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> AI Analytics Agent</span>
                        </h2>
                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Connect your data, ask questions, and empower your team with analytics—no data science degree required.
                        </p>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-8 border-t border-slate-700/50">
                            {[
                                { label: 'Setup Time', value: '< 5 Days' },
                                { label: 'Live Insights', value: 'Realtime' },
                                { label: 'Enterprise-Ready', value: 'SOC 2' },
