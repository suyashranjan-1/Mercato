...
import { Pill, Clock, Star, CheckCircle, ArrowRight, Zap, BarChart3, Globe, Play, ChevronRight, Brain, CalendarClock, Bell, Users, Smartphone, Mail, Cpu, Database, Settings, Shield, ServerCog } from 'lucide-react';
import { NavbarDemo } from "@/components/navbar";
import Footer from "@/components/Footer";
import Link from 'next/link';

export default function MedicationReminderAIAgent() {
    ...
    // DATA FOR MEDICATION REMINDER AI AGENT
    const stats = [
        { label: 'Avg Setup Time', value: '<1min', icon: Clock, color: 'from-blue-500 to-cyan-500' },
        { label: 'Adherence Boost', value: '42%', icon: Star, color: 'from-yellow-500 to-orange-500' },
        { label: 'Reminders Sent', value: '2M+/day', icon: Bell, color: 'from-green-500 to-emerald-500' },
        { label: 'Satisfaction', value: '99%', icon: CheckCircle, color: 'from-pink-500 to-purple-500' }
    ];

    const features = [
        {
            title: 'Intelligent Reminders',
            description: 'AI schedules and sends reminders via SMS, push, voice, or email based on your habits and routines.',
            icon: Bell,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Flexible Scheduling',
            description: 'Supports daily, weekly, PRN (as-needed), and complex medication schedules.',
            icon: CalendarClock,
            gradient: 'from-violet-500 to-pink-500'
        },
        {
            title: 'Drug Interaction Warnings',
            description: 'Detects possible drug interactions and sends instant alerts to you and caregivers.',
            icon: Zap,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: 'Refill & Expiry Notifications',
            description: 'Never run out again—get proactive reminders to refill and avoid expired meds.',
            icon: Clock,
            gradient: 'from-yellow-400 to-orange-400'
        },
        {
            title: 'Caregiver & Family Alerts',
            description: 'Involve caregivers or loved ones for added accountability and safety.',
            icon: Users,
            gradient: 'from-green-500 to-emerald-500'
        },
        {
            title: 'Multi-Channel Support',
            description: 'Works via app, SMS, email, voice assistant, or smart speaker.',
            icon: Smartphone,
            gradient: 'from-indigo-500 to-blue-500'
        },
        {
            title: 'Health Data Integration',
            description: 'Syncs with Apple Health, Google Fit, EHRs, and pharmacy systems.',
            icon: Database,
            gradient: 'from-pink-500 to-rose-500'
        },
        {
            title: 'HIPAA & GDPR Compliant',
            description: 'Bank-level encryption and privacy by design for all health data.',
            icon: Shield,
    ...
    const howItWorks = [
        {
            ...
            description: 'List your prescriptions and supplements, including dose and timing.',
            icon: Pill,
            color: 'from-blue-500 to-cyan-500'
        },
        {
            step: 2,
            title: 'AI Schedules Reminders',
            description: 'AI tailors reminders to your medication plan, lifestyle, and risk factors.',
            icon: Brain,
        ...
        },
        {
            ...
            description: 'Get reminders via your favorite channel: app, SMS, voice, or email.',
            icon: Bell,
        ...
        },
        {
            step: 4,
            title: 'Track & Report',
            description: 'Mark doses as taken, log side effects, and share reports with your healthcare provider.',
            icon: BarChart3,
    ...
    const integrations = [
        { name: 'Apple Health', category: 'Health Data', logo: '🍏' },
        { name: 'Google Fit', category: 'Health Data', logo: '📱' },
        { name: 'Epic', category: 'EHR', logo: '🩺' },
        { name: 'Cerner', category: 'EHR', logo: '🏥' },
        { name: 'Walgreens', category: 'Pharmacy', logo: '💊' },
        { name: 'CVS', category: 'Pharmacy', logo: '🏪' },
        { name: 'Twilio', category: 'SMS/Voice', logo: '📲' },
        { name: 'Amazon Alexa', category: 'Voice', logo: '🗣️' },
        { name: 'Google Assistant', category: 'Voice', logo: '🎙️' },
        ...
        { name: 'Pharmacy Fax', category: 'Legacy', logo: '📠' },
        { name: 'SMS', category: 'Messaging', logo: '💬' }
    ];

    const channels = [
        { name: 'Mobile App', icon: Smartphone, description: 'Full-featured app for scheduling, reminders, and tracking.' },
        { name: 'Text/SMS', icon: Mail, description: 'Get reminders and mark meds as taken via text.' },
        { name: 'Voice Assistant', icon: Zap, description: 'Reminders and confirmations via Alexa or Google.' },
        { name: 'API Integration', icon: ServerCog, description: 'Integrate into EHRs, pharmacy, or care platforms.' }
    ];

    const benefits = [
        {
            title: 'Improve Adherence',
            description: 'Patients are 42% more likely to take meds on time with AI-powered reminders.',
            percentage: '42%',
            metric: 'adherence boost'
        },
        {
            title: 'Reduce Hospitalizations',
            description: 'Avoid complications from missed doses and drug interactions.',
            percentage: '30%',
            metric: 'hospitalization reduction'
        },
        {
            title: 'Peace of Mind',
            description: 'Automated reminders and family alerts mean you never miss a critical dose.',
            percentage: '99%',
            metric: 'satisfaction'
        },
        {
            title: 'Easy for All Ages',
            description: 'Simple, multilingual, and accessible reminders for seniors and caregivers.',
            percentage: '4x',
            metric: 'adoption rate'
        },
        {
            title: 'Secure & Private',
            description: 'HIPAA/GDPR compliant with encrypted storage and secure sharing.',
            percentage: '100%',
            metric: 'privacy'
        }
    ];
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    <div className="inline-flex items-center px-4 sm:px-6 py-2 mb-6 sm:mb-8 rounded-full border border-slate-700/50 bg-slate-800/30 backdrop-blur-sm text-xs sm:text-sm text-slate-300 hover:border-slate-600/50 transition-all duration-300">
                        <Pill className="w-4 h-4 mr-2 text-blue-400 animate-pulse" />
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Never miss a dose again. <span className="text-white font-medium">Get personalized, multi-channel medication reminders</span> and boost your health with smart AI.
                    </div>
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            ...
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">Medication Reminder AI Agent</h3>
                                        <div className="text-slate-400 text-sm flex items-center gap-2">
                                            <div className="w-2 h-2 bg-green-400 rounded-full animate-ping"></div>
                                            Online • Reminding Instantly
                                        </div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4">
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-green-400">99%</div>
                                        <div className="text-xs text-slate-400">Satisfaction</div>
                                    </div>
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-blue-400">&lt;1min</div>
                            ...
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3 animate-slideInLeft">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Please remind me to take Metformin 500mg before breakfast daily.</span>
                                        <span className="text-xs text-slate-400 mt-1 block">8:00 AM</span>
                                    </div>
                                </div>
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '0.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-green-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Reminder set for Metformin 500mg before breakfast at 8:00 AM. Would you like refill reminders as well?</span>
                                        <span className="text-xs text-blue-100 mt-1 block">8:01 AM</span>
                                    </div>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Yes, please alert me 5 days before I run out.</span>
                                        <span className="text-xs text-slate-400 mt-1 block">8:02 AM</span>
                                    </div>
                                </div>
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '1.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-green-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Refill alerts enabled. You will be notified by SMS and email as you approach the end of your supply.</span>
                                        <span className="text-xs text-blue-100 mt-1 block">8:02 AM</span>
                                    </div>
                                    <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-green-600 rounded-full flex items-center justify-center">
                                        <Pill className="w-4 h-4 text-white" />
                                    </div>
                            ...
                            <div className="flex gap-3 justify-end">
                                <div className="bg-gradient-to-r from-blue-600/20 to-green-600/20 rounded-2xl p-3 border border-blue-500/30">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-xs text-blue-300">AI is learning your plan...</span>
                                    </div>
                                </div>
                                <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-green-600 rounded-full flex items-center justify-center">
                                    <Pill className="w-4 h-4 text-white" />
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('how-it-works') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            <span className="bg-gradient-to-r from-green-400 to-blue-600 bg-clip-text text-transparent">Personalized reminders</span> in seconds
                        </h2>
                    </div>
                    <div className="relative">
            ...
            <section id="features" className="py-16 sm:py-24 lg:py-32 px-4 bg-gradient-to-br from-slate-900/50 to-slate-800/30">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            <span className="bg-gradient-to-r from-green-400 to-blue-600 bg-clip-text text-transparent">Never miss a dose</span> with smart reminders
                        </h2>
                    </div>
            ...
            <section id="channels" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('channels') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            <span className="bg-gradient-to-r from-blue-400 to-green-600 bg-clip-text text-transparent">Remind</span> across every channel
                        </h2>
                    </div>
            ...
            <section id="benefits" className="py-16 sm:py-24 lg:py-32 px-4 bg-gradient-to-br from-slate-900/50 to-slate-800/30">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('benefits') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            <span className="bg-gradient-to-r from-green-400 to-blue-600 bg-clip-text text-transparent">Better outcomes</span> with smart adherence
                        </h2>
                    </div>
            ...
            <section id="capabilities" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            <span className="bg-gradient-to-r from-green-400 to-blue-600 bg-clip-text text-transparent">AI-powered</span> adherence and safety
                        </h2>
                    </div>
                                ...
                                <div className="relative w-80 h-80 mx-auto">
                                    ...
                                    <div className="relative w-full h-full bg-gradient-to-r from-slate-800/50 to-slate-700/50 rounded-full border border-slate-600/50 backdrop-blur-sm flex items-center justify-center">
                                        <div className="w-32 h-32 bg-gradient-to-r from-blue-600 to-green-600 rounded-full flex items-center justify-center">
                                            <Pill className="w-16 h-16 text-white animate-pulse" />
                                        </div>
                                    </div>
                                    {[
                                        { label: 'NLP', angle: 0, color: 'from-blue-500 to-cyan-500' },
                                        { label: 'Remind', angle: 60, color: 'from-green-500 to-emerald-500' },
                                        { label: 'Interaction', angle: 120, color: 'from-orange-500 to-red-500' },
                                        { label: 'Reports', angle: 180, color: 'from-violet-500 to-pink-500' },
                            ...
                            {[
                                {
                                    ...
                                    description: 'Set up reminders by simply texting or speaking your schedule—no complex apps required.',
                                    icon: Pill,
                                    color: 'from-blue-500 to-cyan-500'
                                },
                                {
                                    title: 'Flexible Scheduling Logic',
                                    description: 'AI parses any medication regimen—complex, PRN, tapering, or as-needed.',
                                    icon: Cpu,
                                    color: 'from-green-500 to-emerald-500'
                                },
                                {
                                    title: 'Drug Interaction Checks',
                                    description: 'Instant alerts for high-risk combinations and contraindications.',
                                    icon: Zap,
                                    color: 'from-orange-500 to-red-500'
                                },
                                {
                                    title: 'Caregiver & Family Support',
                                    description: 'Invite family or caregivers to monitor adherence and receive missed-dose alerts.',
                                    icon: Users,
                                    color: 'from-violet-500 to-pink-500'
                                },
                                {
                                    title: 'Secure, Compliant Data',
                                    description: 'Encrypted, role-based access for patients, clinicians, and caregivers.',
                                    icon: Shield,
                                    color: 'from-yellow-500 to-orange-500'
                                },
                                {
                                    title: 'Multi-Platform Integration',
                                    description: 'Syncs with health apps, EHRs, pharmacies, and wearables.',
                                    icon: ServerCog,
            ...
            <section id="cta" className="py-16 sm:py-24 lg:py-32 px-4 bg-gradient-to-br from-slate-900/50 to-slate-800/30">
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        <div className="inline-flex items-center px-4 sm:px-6 py-2 mb-6 sm:mb-8 rounded-full border border-slate-700/50 bg-slate-800/30 backdrop-blur-sm text-xs sm:text-sm text-slate-300">
                            <Pill className="w-4 h-4 mr-2 text-blue-400" />
                            Ready for Better Adherence?
                        </div>
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 sm:mb-8 leading-tight">
                            <span className="bg-gradient-to-r from-green-400 to-blue-600 bg-clip-text text-transparent">Never miss a dose again</span>
                        </h2>
                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Join millions using Medication Reminder AI Agent to boost health, avoid missed doses, and keep families safe—no matter where you are.
                        </p>
