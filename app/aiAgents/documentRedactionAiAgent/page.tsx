...
import { FileMinus, Shield, Clock, Users, Star, CheckCircle, ArrowRight, Bot, Zap, BarChart3, Globe, Play, ChevronRight, Brain, Cpu, Database, Settings, Mail, MessageSquare, Smartphone, ServerCog, EyeOff, Layers, Lock, Search, AlertOctagon } from 'lucide-react';
import { NavbarDemo } from "@/components/navbar";
import Footer from "@/components/Footer";

export default function DocumentRedactionAIAgent() {
    ...
    // DATA FOR DOCUMENT REDACTION AI AGENT
    const stats = [
        { label: 'Redaction Speed', value: '<5s/page', icon: Clock, color: 'from-blue-500 to-cyan-500' },
        { label: 'PII Detection Accuracy', value: '99.3%', icon: Star, color: 'from-yellow-500 to-orange-500' },
        { label: 'Supported File Types', value: 'PDF, DOCX, TXT, +', icon: FileMinus, color: 'from-emerald-500 to-teal-500' },
        { label: 'Compliance Coverage', value: 'GDPR, HIPAA, CCPA', icon: Shield, color: 'from-purple-500 to-pink-500' },
    ];

    const features = [
        {
            title: 'Automatic PII & Sensitive Data Detection',
            description: 'AI scans and identifies personal, financial, health, and confidential data in documents instantly.',
            icon: Search,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Custom Redaction Rules',
            description: 'Define your own keywords, phrases, and patterns for industry or org-specific redaction.',
            icon: Layers,
            gradient: 'from-purple-500 to-pink-500'
        },
        {
            title: 'Batch & Bulk Processing',
            description: 'Redact entire folders or thousands of documents in one go, with full audit logs.',
            icon: Database,
            gradient: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Smart Contextual Redaction',
            description: 'AI understands context to avoid over-redacting and preserves document utility.',
            icon: Brain,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: 'Visual Redaction Preview',
            description: 'See before/after redaction with highlights, overlays, and export to secure formats.',
            icon: EyeOff,
            gradient: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Export & Integration',
            description: 'Export redacted docs to PDF, DOCX, or connect to your DMS, cloud, or custom workflow.',
            icon: ServerCog,
            gradient: 'from-pink-500 to-rose-500'
        },
        {
            title: 'Audit, Logs & Compliance',
            description: 'Immutable logs of every redaction for compliance and legal defensibility.',
            icon: CheckCircle,
            gradient: 'from-rose-500 to-pink-500'
        },
        {
            title: 'Military-grade Security',
            description: 'AES-256 encryption, access controls, and secure deletion for all data.',
            icon: Lock,
    ...
    const howItWorks = [
        {
            ...
            description: 'Bring files from your computer, cloud, or integrate with your document system.',
            icon: FileMinus,
        ...
        },
        {
            ...
            description: 'AI analyzes each page, finding PII, PHI, PCI, and confidential data instantly.',
            icon: Search,
        ...
        },
        {
            ...
            description: 'Preview redactions, adjust as needed, and approve for secure processing.',
            icon: EyeOff,
        ...
        },
        {
            step: 4,
            title: 'Export & Audit',
            description: 'Download redacted docs or send to workflows; audit logs are automatically created.',
            icon: CheckCircle,
    ...
    const integrations = [
        ...
        { name: 'Google Drive', category: 'Cloud Storage', logo: '☁️' },
        { name: 'Box', category: 'Cloud Storage', logo: '🗃️' },
        { name: 'OneDrive', category: 'Cloud Storage', logo: '🔗' },
        ...
        { name: 'FTP/SFTP', category: 'File Transfer', logo: '🔒' },
    ];

    const channels = [
        { name: 'Web Dashboard', icon: BarChart3, description: 'Redact and manage files in a secure browser interface.' },
        { name: 'Email Upload', icon: Mail, description: 'Forward documents for instant redaction and return.' },
        { name: 'Mobile App', icon: Smartphone, description: 'Redact on the go, preview and download securely.' },
        { name: 'API Integration', icon: ServerCog, description: 'Automate redaction in your custom workflows.' }
    ];

    const benefits = [
        {
            title: 'Protect Sensitive Data',
            description: 'Block leaks of PII, PHI, PCI, and trade secrets before documents leave your organization.',
            percentage: '99%',
            metric: 'risk reduction'
        },
        {
            title: 'Accelerate Compliance',
            description: 'Meet GDPR, HIPAA, CCPA, and more with automated, auditable redaction workflows.',
            percentage: '85%',
            metric: 'faster compliance'
        },
        {
            title: 'Boost Productivity',
            description: 'Slash manual review time from hours to seconds and enable high-volume processing.',
            percentage: '10x',
            metric: 'efficiency gain'
        },
        {
            title: 'Reduce Human Error',
            description: 'AI-driven detection reduces missed redactions and over-redaction.',
            percentage: '94%',
            metric: 'accuracy improvement'
        },
        {
            title: 'Secure Collaboration',
            description: 'Share only what’s needed – redact and distribute safe document versions with teams or partners.',
            percentage: '5x',
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-black text-white overflow-hidden">
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                <div className="absolute inset-0 bg-gradient-to-br from-blue-600/10 via-transparent to-pink-600/10"></div>
                <div
                ...
                ></div>
                <div
                    className="absolute bottom-1/4 right-1/4 w-40 h-40 sm:w-60 sm:h-60 lg:w-80 lg:h-80 bg-pink-500/10 rounded-full blur-3xl animate-pulse"
                ...
                <div className="absolute inset-0 pointer-events-none">
                    {[...Array(20)].map((_, i) => (
                        <div
                            key={i}
                            className="absolute w-1 h-1 bg-gradient-to-br from-blue-400/40 to-pink-400/30 rounded-full animate-float"
                            style={{
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    <div className="inline-flex items-center px-4 sm:px-6 py-2 mb-6 sm:mb-8 rounded-full border border-slate-700/50 bg-slate-800/30 backdrop-blur-sm text-xs sm:text-sm text-slate-300 hover:border-slate-600/50 transition-all duration-300">
                        <FileMinus className="w-4 h-4 mr-2 text-blue-400 animate-pulse" />
                    ...
                    <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold mb-6 sm:mb-8 bg-gradient-to-r from-white via-slate-200 to-slate-400 bg-clip-text text-transparent leading-tight">
                        Document Redaction
                        <br />
                        <span className="bg-gradient-to-r from-blue-400 to-pink-600 bg-clip-text text-transparent animate-glow">
                            AI Agent
                        </span>
                    </h1>
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Instantly and accurately remove sensitive information from documents. <span className="text-white font-medium">AI-powered redaction</span> for compliance, privacy, and secure sharing at scale.
                    </div>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center px-4 mb-16">
                        <button className="px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-blue-600 to-pink-600 text-white font-semibold rounded-2xl hover:shadow-2xl hover:shadow-blue-500/25 transform hover:scale-105 transition-all duration-300 text-sm sm:text-base flex items-center justify-center gap-2">
                            Create Agent
                    ...
                    <div className="relative max-w-5xl mx-auto">
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            ...
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    <div className="relative">
                                        <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-pink-600 rounded-2xl flex items-center justify-center">
                                            <FileMinus className="w-6 h-6 text-white" />
                                        </div>
                                        <div className="absolute -top-1 -right-1 w-4 h-4 bg-emerald-400 rounded-full animate-pulse"></div>
                                    </div>
                                    <div>
                                        <h3 className="text-lg font-semibold">Document Redaction AI Agent</h3>
                                        <div className="text-slate-400 text-sm flex items-center gap-2">
                                            <div className="w-2 h-2 bg-emerald-400 rounded-full animate-ping"></div>
                                            Online • Redacting Instantly
                                        </div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4">
                                    <div className="text-right">
                                        ...
                                        <div className="text-xs text-slate-400">PII Accuracy</div>
                                    </div>
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-blue-400">&lt;5s/page</div>
                                        <div className="text-xs text-slate-400">Redaction Speed</div>
                                    </div>
                                </div>
                            </div>
                            {/* Document Redaction Preview */}
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3 animate-slideInLeft">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Upload: “Q2_Financial_Report.pdf”</span>
                                ...
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '0.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-pink-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">PII Detected: 12 SSNs, 7 Credit Card Numbers, 3 Addresses.<br /><span className="text-pink-300">Ready to redact?</span></span>
                                        <span className="text-xs text-blue-100 mt-1 block">10:34 AM</span>
                                    </div>
                                    <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-pink-600 rounded-full flex items-center justify-center">
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Highlight: HIPAA-protected health data found on page 6.</span>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Exported: “Q2_Financial_Report_Redacted.pdf” – Audit log generated.</span>
                            ...
                            <div className="flex gap-3 justify-end">
                                <div className="bg-gradient-to-r from-blue-600/20 to-pink-600/20 rounded-2xl p-3 border border-blue-500/30">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-xs text-blue-300">AI is redacting...</span>
                                    </div>
                                </div>
                                <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-pink-600 rounded-full flex items-center justify-center">
                                    <FileMinus className="w-4 h-4 text-white" />
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('how-it-works') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Secure redaction <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent">in seconds</span>
                        </h2>
                    </div>
                    <div className="relative">
            ...
            <section id="features" className="py-16 sm:py-24 lg:py-32 px-4 bg-gradient-to-br from-slate-900/50 to-slate-800/30">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent">Comprehensive</span> document redaction
                        </h2>
                    </div>
            ...
            <section id="channels" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('channels') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            <span className="bg-gradient-to-r from-blue-400 to-pink-600 bg-clip-text text-transparent">Redact anywhere</span> your data lives
                        </h2>
                    </div>
                        ...
                        {channels.map((channel, index) => {
                            ...
                            return (
                                <div
                                    ...
                                    style={{ animationDelay: `${index * 100}ms` }}
                                >
                                    <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-r from-blue-500 to-pink-500 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                                        <IconComponent className="w-8 h-8 text-white" />
                                    </div>
            ...
            <section id="benefits" className="py-16 sm:py-24 lg:py-32 px-4 bg-gradient-to-br from-slate-900/50 to-slate-800/30">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('benefits') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent">Protect privacy</span> and compliance at scale
                        </h2>
                    </div>
            ...
            <section id="capabilities" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            <span className="bg-gradient-to-r from-pink-400 to-blue-600 bg-clip-text text-transparent">Intelligent</span> redaction for every document
                        </h2>
                    </div>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div className={`relative transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
                            <div className="relative">
                                <div className="relative w-80 h-80 mx-auto">
                                    <div className="absolute inset-0 bg-gradient-to-r from-blue-500/20 to-pink-500/20 rounded-full blur-3xl animate-pulse"></div>
                                    <div className="relative w-full h-full bg-gradient-to-r from-slate-800/50 to-slate-700/50 rounded-full border border-slate-600/50 backdrop-blur-sm flex items-center justify-center">
                                        <div className="w-32 h-32 bg-gradient-to-r from-blue-600 to-pink-600 rounded-full flex items-center justify-center">
                                            <FileMinus className="w-16 h-16 text-white animate-pulse" />
                                        </div>
                                    </div>
                                    {[
                                        { label: 'PII', angle: 0, color: 'from-blue-500 to-cyan-500' },
                                        { label: 'Context', angle: 60, color: 'from-emerald-500 to-teal-500' },
                                        { label: 'Custom', angle: 120, color: 'from-orange-500 to-red-500' },
                        ...
                        <div className={`space-y-8 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
                            {[
                                {
                                    title: 'PII & Sensitive Data Recognition',
                                    description: 'Finds names, addresses, SSNs, emails, phone numbers, card details, PHI, and more in any format.',
                                    icon: Search,
                                    color: 'from-blue-500 to-cyan-500'
                                },
                                {
                                    title: 'Context-Aware Redaction',
                                    description: 'Understands context to redact only what’s needed and preserve document meaning.',
                                    icon: Brain,
                                    color: 'from-purple-500 to-pink-500'
                                },
                                {
                                    title: 'Custom Rule Engine',
                                    description: 'Add your own keywords, regex, and pattern libraries for tailored redaction.',
                                    icon: Layers,
                                    color: 'from-emerald-500 to-teal-500'
                                },
                                {
                                    title: 'Visual Preview & Review',
                                    description: 'Preview all redactions, undo/redo, and export with overlays for legal defensibility.',
                                    icon: EyeOff,
                                    color: 'from-orange-500 to-red-500'
                                },
                                {
                                    title: 'Compliance & Security',
                                    description: 'Meets GDPR, HIPAA, CCPA with AES-256 encryption and role-based access.',
                                    icon: Shield,
                                    color: 'from-indigo-500 to-purple-500'
                                },
                                {
                                    title: 'API & Bulk Automation',
                                    description: 'Integrate with your DMS and automate redaction for massive document volumes.',
                                    icon: ServerCog,
            ...
            <section id="cta" className="py-16 sm:py-24 lg:py-32 px-4 bg-gradient-to-br from-slate-900/50 to-slate-800/30">
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        <div className="inline-flex items-center px-4 sm:px-6 py-2 mb-6 sm:mb-8 rounded-full border border-slate-700/50 bg-slate-800/30 backdrop-blur-sm text-xs sm:text-sm text-slate-300">
                            <Zap className="w-4 h-4 mr-2 text-emerald-400" />
                            Ready for AI-Driven Privacy?
                        </div>
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 sm:mb-8 leading-tight">
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent">Redact smarter</span> and protect your data now
                        </h2>
                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Empower your team to meet privacy, compliance, and security needs with Document Redaction AI Agent – instant, secure, and fully auditable.
                        </p>
