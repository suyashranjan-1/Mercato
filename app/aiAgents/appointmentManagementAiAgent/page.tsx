...
export default function AppointmentManagementAIAgent() {
    ...
    const stats = [
        ...
        { label: 'Customer Satisfaction', value: '4.8★', icon: Star, color: 'from-yellow-500 to-orange-500' },
    ...
    const integrations = [
        { name: 'Epic', category: 'EMR', logo: '🏥' },
        { name: 'Cerner', category: 'EMR', logo: '📋' },
        { name: 'Allscripts', category: 'EMR', logo: '📝' },
        { name: 'Google Calendar', category: 'Calendar', logo: '📅' },
        { name: 'Outlook', category: 'Calendar', logo: '📧' },
        { name: 'Zocdoc', category: 'Booking', logo: '👨‍⚕️' },
        { name: 'SimplePractice', category: 'Practice Mgmt', logo: '🏢' },
        { name: 'Athenahealth', category: 'EMR', logo: '⚕️' },
        ...
        { name: 'Doxy.me', category: 'Telehealth', logo: '💻' },
        { name: 'Apple Health', category: 'Health Data', logo: '🍎' },
        { name: 'Fitbit', category: 'Wearables', logo: '⌚' },
    ];
