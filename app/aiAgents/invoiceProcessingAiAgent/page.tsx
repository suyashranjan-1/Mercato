...
import { FileText, Clock, Users, Star, CheckCircle, ArrowRight, Bot, Shield, Zap, BarChart3, Globe, Play, ChevronRight, Brain, Cpu, Database, Settings, Mail, Smartphone } from 'lucide-react';
...
export default function InvoiceProcessingAIAgent() {
    ...
    // Invoice Processing AI stats
    const stats = [
        { label: 'Avg Invoice Processing Time', value: '<3s', icon: Clock, color: 'from-blue-500 to-cyan-500' },
        { label: 'Accuracy (Data Extraction)', value: '99.8%', icon: Star, color: 'from-yellow-500 to-orange-500' },
        { label: 'Invoices Processed Daily', value: '1M+', icon: CheckCircle, color: 'from-emerald-500 to-teal-500' },
        { label: 'System Uptime', value: '99.999%', icon: Zap, color: 'from-purple-500 to-pink-500' },
    ];

    // Features for Invoice Processing AI Agent
    const features = [
        {
            title: 'Automated Invoice Capture',
            description: 'Extract data from PDFs, scanned images, emails, and e-invoices with near-perfect accuracy. No manual entry required.',
            icon: FileText,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Multi-Format Support',
            description: 'Works with all major invoice formats, currencies, and languages, recognizing line items, taxes, and payment terms.',
            icon: Database,
            gradient: 'from-purple-500 to-pink-500'
        },
        {
            title: '3-Way Matching',
            description: 'Automate PO, invoice, and receipt matching for fraud prevention and compliance.',
            icon: CheckCircle,
            gradient: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Automated Approvals',
            description: 'Route invoices for multi-level approvals based on amount, department, or policy rules.',
            icon: Users,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: 'Duplicate & Fraud Detection',
            description: 'Sophisticated AI flags duplicate, suspicious, or non-compliant invoices before payment.',
            icon: Shield,
            gradient: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'ERP & Accounting Integration',
            description: 'Seamless integration with SAP, Oracle, QuickBooks, Xero, and more for end-to-end automation.',
            icon: Globe,
            gradient: 'from-pink-500 to-rose-500'
        },
        {
            title: 'Real-Time Analytics',
            description: 'Dashboards and reports for cashflow, outstanding payables, and vendor performance.',
            icon: BarChart3,
            gradient: 'from-amber-500 to-orange-500'
        },
        {
            title: 'Continuous Learning',
            description: 'AI models improve extraction, matching, and fraud detection based on your workflow feedback.',
            icon: Brain,
            gradient: 'from-rose-500 to-pink-500'
        }
    ];

    // How It Works for Invoice Processing
    const howItWorks = [
        {
            step: 1,
            title: 'Invoice Capture',
            description: 'Upload or email invoices in PDF, image, or electronic format directly to the AI agent.',
            icon: FileText,
        ...
        },
        {
            ...
            description: 'AI extracts invoice data, validates against POs and receipts, flags issues in real-time.',
            icon: Database,
        ...
        },
        {
            ...
            description: 'Invoices are routed for approval based on custom business rules and compliance checks.',
            icon: Users,
        ...
        },
        {
            ...
            description: 'Validated invoices are posted to your ERP/accounting system. Real-time dashboards track status, savings, and exceptions.',
            icon: BarChart3,
            color: 'from-orange-500 to-red-500'
        }
    ];

    // Integrations for Invoice Processing
    const integrations = [
        ...
        { name: 'Mailchimp', category: 'Communication', logo: '📨' },
        { name: 'Salesforce', category: 'CRM', logo: '📈' },
        { name: 'Zoho Books', category: 'Accounting', logo: '📙' },
    ];

    // Channels for Invoice Processing
    const channels = [
        { name: 'Web Upload', icon: FileText, description: 'Upload invoices through a secure online dashboard' },
        { name: 'Email Forwarding', icon: Mail, description: 'Forward invoices to your dedicated AI email' },
        { name: 'Mobile App', icon: Smartphone, description: 'Snap and process invoices on the go' },
        { name: 'ERP Integration', icon: Globe, description: 'Direct invoice ingestion from your ERP or DMS' }
    ];
    ...
    const benefits = [
        {
            ...
            description: 'Cut invoice cycle times from weeks to seconds. Pay vendors on time, every time.',
            percentage: '97%',
            metric: 'faster processing'
        },
        {
            title: 'Eliminate Manual Entry',
            description: 'AI handles all extraction, validation, and posting—reduce errors and free up your team.',
            percentage: '100%',
            metric: 'automation'
        },
        {
            title: 'Reduce Fraud & Duplicates',
            description: 'AI flags duplicates, suspicious invoices, and compliance risks before payment.',
            percentage: '91%',
            metric: 'risk reduction'
        },
        {
            title: 'Maximize Early Payment Discounts',
            description: 'Identify and capitalize on early payment discounts automatically.',
            percentage: '3x',
            metric: 'savings'
        },
        {
            title: 'Effortless Audits',
            description: 'Every invoice, approval, and exception is logged for instant audit readiness.',
            percentage: '100%',
            metric: 'audit trail'
        }
    ];
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Revolutionize your accounts payable with AI that captures, validates, and posts invoices in seconds. Eliminate manual entry, reduce fraud, and ensure 24/7 invoice automation with seamless ERP integration.
                    </div>
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            ...
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">Invoice Processing AI Agent</h3>
                                        <div className="text-slate-400 text-sm flex items-center gap-2">
                                            <div className="w-2 h-2 bg-emerald-400 rounded-full animate-ping"></div>
                                            Online • Processing invoices instantly
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3 animate-slideInLeft">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Upload invoice INV-20245.pdf for ACME Corp. Can you extract all line items and validate the PO?</span>
                                ...
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '0.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Invoice captured. 7 line items extracted, matched to PO #7821. No discrepancies found. Ready for approval workflow.</span>
                                        <span className="text-xs text-blue-100 mt-1 block">11:22 AM</span>
                                    </div>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Flag invoice for review if amount exceeds $25,000 or if a duplicate is detected.</span>
                                        <span className="text-xs text-slate-400 mt-1 block">11:23 AM</span>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> seamless invoice automation</span>
                        </h2>
                    </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('channels') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-blue-400 to-cyan-600 bg-clip-text text-transparent"> invoice sources</span>
                        </h2>
                    </div>
            ...
            <section id="benefits" className="py-16 sm:py-24 lg:py-32 px-4 bg-gradient-to-br from-slate-900/50 to-slate-800/30">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('benefits') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Process invoices with speed and confidence
            ...
            <section id="capabilities" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Advanced AI for
                            <span className="bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent"> intelligent invoice automation</span>
                        </h2>
                    </div>
                            ...
                            <div className="relative">
                                <div className="relative w-80 h-80 mx-auto">
                                    ...
                                    {[
                                        ...
                                        { label: 'Matching', angle: 60, color: 'from-emerald-500 to-teal-500' },
                            ...
                            {[
                                {
                                    ...
                                    description: 'Extracts data with 99.8% accuracy from PDFs, images, and multi-language invoices.',
                                    icon: FileText,
                                    color: 'from-blue-500 to-cyan-500'
                                },
                                {
                                    title: '3-Way Matching',
                                    description: 'Automates match between PO, invoice, and receipt for compliance and fraud prevention.',
                                    icon: CheckCircle,
                                    color: 'from-emerald-500 to-teal-500'
                                },
                                {
                                    title: 'Fraud & Duplicate Detection',
                                    description: 'Flags suspicious, duplicate, or non-compliant invoices in real time.',
                                    icon: Shield,
                                    color: 'from-orange-500 to-red-500'
                                },
                                {
                                    title: 'Analytics & Reporting',
                                    description: 'Dashboards for cashflow, AP aging, and vendor performance.',
                                    icon: BarChart3,
                                    color: 'from-purple-500 to-pink-500'
                                },
                                {
                                    title: 'Bank-Grade Security',
                                    description: 'AES-256 encryption, audit logs, and role-based access for compliance.',
                                    icon: Shield,
                                    color: 'from-yellow-500 to-orange-500'
                                },
                                {
                                    title: 'ERP & DMS Integration',
                                    description: 'Connects to all major ERP, accounting, and document management systems.',
                                    icon: Globe,
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Join global finance teams using AI to eliminate manual AP tasks, reduce risk, and accelerate payments. Get started in minutes with a free trial.
                        </p>
