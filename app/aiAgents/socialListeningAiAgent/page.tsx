...
import { Bot, Globe, Zap, BarChart3, Play, ArrowRight, Brain, Cpu, Database, Settings, Smartphone, Mail, MessageCircle, Users, Clock, Star, CheckCircle, ChevronRight, Eye } from 'lucide-react';
import { NavbarDemo } from "@/components/navbar";
import Footer from "@/components/Footer";
import Link from 'next/link';

export default function SocialListeningAIAgent() {
    ...
    const stats = [
        { label: 'Real-Time Mentions', value: '2.3M+', icon: Eye, color: 'from-blue-500 to-cyan-500' },
        { label: 'Sentiment Accuracy', value: '97.8%', icon: Star, color: 'from-yellow-500 to-orange-500' },
        { label: 'Brand Risk Alerts', value: '<10s', icon: Zap, color: 'from-emerald-500 to-teal-500' },
        { label: 'Languages Supported', value: '37+', icon: Globe, color: 'from-purple-500 to-pink-500' },
    ];

    const features = [
        {
            title: 'Real-Time Monitoring',
            description: 'Track brand, product, and competitor mentions across social networks, news, forums, blogs and reviews with instant alerts.',
            icon: Eye,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Advanced Sentiment Analysis',
            description: 'AI-powered sentiment detection reveals audience mood, intent, and influencer impact for every mention.',
            icon: Brain,
            gradient: 'from-purple-500 to-pink-500'
        },
        {
            title: 'Trend & Crisis Detection',
            description: 'Automatically detects trending topics, viral posts, and potential PR crises before they escalate.',
            icon: Zap,
            gradient: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Competitor Benchmarking',
            description: 'Compare your share of voice, sentiment, and engagement against competitors in real time.',
            icon: BarChart3,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: 'Influencer Identification',
            description: 'Find the most influential voices talking about your brand or industry using AI ranking.',
            icon: Users,
            gradient: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Custom Dashboards & Reports',
            description: 'Build interactive dashboards and schedule automated reports for your team or clients.',
            icon: Database,
            gradient: 'from-pink-500 to-rose-500'
        },
        {
            title: 'Multi-Language Support',
            description: 'Analyze brand mentions and sentiment in 37+ languages, globally.',
            icon: Globe,
            gradient: 'from-yellow-500 to-orange-500'
        },
        {
            title: 'API & Integrations',
            description: 'Connect data to Slack, Teams, CRM, and analytics platforms for unified workflows.',
            icon: Settings,
    ...
    const howItWorks = [
        {
            ...
            description: 'AI collects real-time data from social media, news, forums, blogs, and review sites.',
            icon: Database,
        ...
        },
        {
            ...
            description: 'Mentions are analyzed for sentiment, intent, topic, and influencer impact.',
            icon: Brain,
        ...
        },
        {
            ...
            description: 'Receive instant alerts for risks, trends, and viral spikes. Visualize insights in real time.',
            icon: Zap,
        ...
        },
        {
            ...
            description: 'Share reports, benchmark competitors, and drive smarter brand engagement.',
            icon: BarChart3,
    ...
    const integrations = [
        ...
        { name: 'Reddit', category: 'Forum', logo: '👽' },
        { name: 'YouTube', category: 'Video', logo: '▶️' },
        { name: 'TikTok', category: 'Social', logo: '🎵' },
        { name: 'News APIs', category: 'Media', logo: '📰' },
        { name: 'Glassdoor', category: 'Review', logo: '💬' },
        { name: 'Slack', category: 'Team', logo: '💬' },
        { name: 'Discord', category: 'Community', logo: '🎮' },
        { name: 'Google Alerts', category: 'News', logo: '🔔' },
        { name: 'Sprout Social', category: 'Analytics', logo: '🌱' },
    ...
    const channels = [
        { name: 'Web Dashboard', icon: BarChart3, description: 'Monitor, analyze, and export insights in your browser.' },
        { name: 'Mobile App', icon: Smartphone, description: 'Track brand mentions and receive alerts on the go.' },
        { name: 'Email & Push Alerts', icon: Mail, description: 'Get notified the moment a crisis or trend emerges.' },
        { name: 'Chat Integrations', icon: MessageCircle, description: 'Send real-time alerts to Slack or Teams.' }
    ];

    const benefits = [
        {
            title: 'Protect Brand Reputation',
            description: 'Detect negative sentiment and PR risks instantly, enabling swift response.',
            percentage: '10x',
            metric: 'faster crisis detection'
        },
        {
            title: 'Boost Customer Engagement',
            description: 'Respond to conversations, questions, and complaints as they happen.',
            percentage: '80%',
            metric: 'improved engagement'
        },
        {
            title: 'Benchmark Competition',
            description: 'Know your share of voice, sentiment, and trending topics versus competitors.',
            percentage: '100%',
            metric: 'market visibility'
        },
        {
            title: 'Save Analyst Hours',
            description: 'Automate insights and reporting, freeing up your team to focus on strategy.',
            percentage: '75%',
            metric: 'time saved'
        },
        {
            title: 'Uncover Influencers',
            description: 'Instantly discover and connect with the voices that shape your brand’s narrative.',
            percentage: '92%',
            metric: 'influencer detection accuracy'
        }
    ];
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Monitor, analyze, and act on every conversation about your brand, product, or industry—across social, news, forums, and reviews. AI-powered insights, sentiment analysis, and trend detection in real time.
                    </div>
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            ...
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">Social Listening AI Agent</h3>
                                        <div className="text-slate-400 text-sm flex items-center gap-2">
                                            <div className="w-2 h-2 bg-emerald-400 rounded-full animate-ping"></div>
                                            Online • Monitoring social in real-time
                                        </div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4">
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-emerald-400">97.8%</div>
                                        <div className="text-xs text-slate-400">Sentiment Accuracy</div>
                                    </div>
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-blue-400">2.3M+</div>
                                        <div className="text-xs text-slate-400">Mentions Tracked</div>
                                    </div>
                                </div>
                            </div>
                            {/* Chat Interface */}
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3 animate-slideInLeft">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Are there any negative trends about our new product launch this week?</span>
                                        <span className="text-xs text-slate-400 mt-1 block">11:07 AM</span>
                                    </div>
                                </div>
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '0.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">No major negative trends detected. 87% of mentions are positive. Three influencers are discussing your brand—would you like a detailed report?</span>
                                        <span className="text-xs text-blue-100 mt-1 block">11:07 AM</span>
                                    </div>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Yes, send me the influencer report and set an alert for any negative spikes.</span>
                                        <span className="text-xs text-slate-400 mt-1 block">11:08 AM</span>
                                    </div>
                                </div>
                            </div>
                            {/* Typing Indicator */}
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> real-time social intelligence</span>
                        </h2>
                    </div>
            ...
            <section id="channels" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('channels') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Listen & respond on every
                            <span className="bg-gradient-to-r from-blue-400 to-cyan-600 bg-clip-text text-transparent"> platform that matters</span>
                        </h2>
                    </div>
            ...
            <section id="capabilities" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Next-gen AI for
                            <span className="bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent"> deep social listening</span>
                        </h2>
                    </div>
                            ...
                            <div className="relative">
                                <div className="relative w-80 h-80 mx-auto">
                                    ...
                                    {[
                                        ...
                                        { label: 'Trends', angle: 120, color: 'from-orange-500 to-red-500' },
                                        { label: 'Influencers', angle: 180, color: 'from-purple-500 to-pink-500' },
                            ...
                            {[
                                {
                                    ...
                                    description: 'AI understands brand mentions, context, sarcasm, and emerging topics in 37+ languages.',
                                    icon: Brain,
                                    color: 'from-blue-500 to-cyan-500'
                                },
                                {
                                    title: 'Emotion & Sentiment Analysis',
                                    description: 'Detects nuanced sentiment, emotion, and intent—even with emojis, slang, and sarcasm.',
                                    icon: Star,
                                    color: 'from-purple-500 to-pink-500'
                                },
                                {
                                    title: 'Trend and Crisis Alerts',
                                    description: 'AI spots unusual surges in mentions or negative posts for fast intervention.',
                                    icon: Zap,
                                    color: 'from-emerald-500 to-teal-500'
                                },
                                {
                                    title: 'Influencer Detection',
                                    description: 'Identifies and ranks users driving the conversation about your brand.',
                                    icon: Users,
                                    color: 'from-orange-500 to-red-500'
                                },
                                {
                                    title: 'Security & Privacy',
                                    description: 'All data encrypted at rest and in transit, with GDPR compliance built-in.',
                                    icon: Database,
                                    color: 'from-indigo-500 to-purple-500'
                                },
                                {
                                    title: 'API & Extensibility',
                                    description: 'Integrate listening results with your marketing stack and workflows.',
                                    icon: Settings,
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 sm:mb-8 leading-tight">
                            Start understanding your audience with
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> SocialListening AI Agent</span>
                        </h2>
                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Uncover every conversation, sentiment, and trend shaping your brand. Talk with an expert or see the agent in action for your team.
                        </p>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-8 border-t border-slate-700/50">
                            {[
                                { label: 'Real-Time Monitoring', value: '2.3M+ Mentions' },
