...
const floatingDots = getFloatingDotPositions(28);
...
export default function CustomerReviewSummarizerAIAgent() {
    ...
    const integrations = [
        ...
        { name: 'Google Reviews', category: 'Local', logo: '🌍' },
        { name: 'Yelp', category: 'Local', logo: '🍴' },
        { name: 'Trustpilot', category: 'Review', logo: '🔗' },
                            ...
                            <div className="space-y-4 mb-6">
                                ...
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '0.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm shadow">
                                        <span className="text-sm">Most customers love the sound quality and comfort. Some mention the battery life could be improved. Overall sentiment: 4.7★ positive.</span>
