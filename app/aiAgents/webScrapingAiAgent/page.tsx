...
export default function WebScrapingAIAgent() {
    ...
    // Stats for Web Scraping AI Agent
    const stats = [
        { label: 'Pages Scraped Daily', value: '1M+', icon: Globe, color: 'from-blue-500 to-cyan-500' },
        { label: 'Avg Extraction Time', value: '<1s', icon: Clock, color: 'from-yellow-500 to-orange-500' },
        { label: 'Data Accuracy', value: '99.8%', icon: CheckCircle, color: 'from-emerald-500 to-teal-500' },
        { label: 'System Uptime', value: '99.99%', icon: Zap, color: 'from-purple-500 to-pink-500' },
    ];

    // Features for Web Scraping AI Agent
    const features = [
        {
            title: 'No-Code Data Extraction',
            description: 'Easily specify elements or patterns to extract from any website with an intuitive UI—no coding required.',
            icon: Zap,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Smart Anti-Bot Evasion',
            description: 'Bypass CAPTCHAs, rate limits, and anti-bot measures using advanced AI techniques.',
            icon: Shield,
            gradient: 'from-purple-500 to-pink-500'
        },
        {
            title: 'Automated Scheduling',
            description: 'Set up recurring scraping jobs with flexible scheduling and automated error recovery.',
            icon: Settings,
            gradient: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Multi-Format Export',
            description: 'Export scraped data to CSV, JSON, Excel, API endpoints, or integrate with your database.',
            icon: Database,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: 'Real-Time Monitoring',
            description: 'Live dashboards for job statuses, extraction logs, and performance analytics.',
            icon: BarChart3,
            gradient: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'AI-Powered Parsing',
            description: 'Extract structured data from even the most complex and dynamic pages using LLMs & NLP.',
            icon: Brain,
            gradient: 'from-pink-500 to-rose-500'
        },
        {
            title: 'Cloud & Proxy Support',
            description: 'Scrape at scale using rotating proxies, cloud deployment, and geo-distributed infrastructure.',
            icon: Globe,
            gradient: 'from-rose-500 to-pink-500'
        },
        {
            title: 'Alerting & Notifications',
            description: 'Get instant alerts via email, SMS, or app when jobs succeed, fail, or encounter changes.',
            icon: Mail,
            gradient: 'from-amber-500 to-orange-500'
        }
    ];

    // How It Works for Web Scraping AI Agent
    const howItWorks = [
        {
            step: 1,
            title: 'Define Target',
            description: 'User specifies the website, URLs, and data points to extract.',
            icon: MessageSquare,
            color: 'from-blue-500 to-cyan-500'
        },
        {
            step: 2,
            title: 'AI Parsing & Navigation',
            description: 'Agent analyzes page structure, solves JavaScript rendering, and navigates as needed.',
            icon: Cpu,
        ...
        },
        {
            ...
            description: 'AI scrapes structured data, images, and files, handling pagination and dynamic content.',
            icon: Database,
        ...
        },
        {
            ...
            description: 'Data is delivered in your preferred format, with jobs running on your schedule or on demand.',
            icon: Zap,
            color: 'from-orange-500 to-red-500'
        }
    ];

    // Integrations for Web Scraping
    const integrations = [
        { name: 'Google Sheets', category: 'Spreadsheet', logo: '📄' },
        { name: 'Airtable', category: 'Database', logo: '📊' },
        { name: 'Zapier', category: 'Automation', logo: '⚡' },
        { name: 'Slack', category: 'Notification', logo: '💬' },
        { name: 'Twilio', category: 'SMS', logo: '📲' },
        { name: 'MongoDB', category: 'Database', logo: '🍃' },
        { name: 'PostgreSQL', category: 'Database', logo: '🐘' },
        { name: 'AWS Lambda', category: 'Cloud', logo: '☁️' },
        { name: 'Google Cloud', category: 'Cloud', logo: '☁️' },
        { name: 'Excel', category: 'Spreadsheet', logo: '📈' },
        { name: 'Webhook', category: 'API', logo: '🔗' },
        { name: 'Discord', category: 'Community', logo: '🎮' },
        { name: 'Dropbox', category: 'Storage', logo: '📦' },
        { name: 'S3', category: 'Storage', logo: '🗄️' },
        { name: 'FTP/SFTP', category: 'Storage', logo: '💾' },
        { name: 'Notion', category: 'Docs', logo: '📝' },
    ];

    // Channels for Web Scraping
    const channels = [
        { name: 'Web Dashboard', icon: Globe, description: 'Manage all your scraping jobs in one place' },
        { name: 'API Access', icon: Settings, description: 'Trigger scrapes and fetch data programmatically' },
        { name: 'Email', icon: Mail, description: 'Receive exports and alerts in your inbox' },
        { name: 'Mobile App', icon: Smartphone, description: 'Monitor and control jobs from your phone' }
    ];
    ...
    const benefits = [
        {
            ...
            description: 'Crawl millions of pages with resilient, distributed cloud infrastructure.',
            percentage: '∞',
            metric: 'scalability'
        },
        {
            title: 'Save Time & Resources',
            description: 'Automate repetitive data collection and focus on insights, not manual work.',
            percentage: '90%',
            metric: 'efficiency boost'
        },
        {
            title: 'Boost Data Quality',
            description: 'AI cleansing and validation for high-accuracy, reliable datasets.',
            percentage: '99.8%',
            metric: 'data accuracy'
        },
        {
            title: 'Stay Compliant',
            description: 'Respect robots.txt, rate limits, and legal requirements with ethical scraping defaults.',
            percentage: '100%',
            metric: 'compliance'
        },
        {
            title: 'Instant Alerts',
            description: 'Get notified about website changes, job failures, or data anomalies in real time.',
            percentage: '100%',
            metric: 'real-time alerts'
        }
    ];

    // Capabilities for Web Scraping
    const capabilities = [
        {
            title: 'AI DOM Understanding',
            description: 'Parse complex, dynamic sites—single-page apps, JavaScript, and more.',
            icon: Cpu,
            color: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Captcha & Anti-Bot Bypass',
            description: 'Solve CAPTCHAs and evade anti-bot protections with adaptive strategies.',
            icon: Shield,
            color: 'from-purple-500 to-pink-500'
        },
        {
            title: 'Automated Pagination',
            description: 'Detect and scrape paginated content seamlessly across websites.',
            icon: Settings,
            color: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Multi-Format Data Export',
            description: 'Export to CSV, JSON, Excel, APIs, and direct DB connections.',
            icon: Database,
            color: 'from-orange-500 to-red-500'
        },
        {
            title: 'Change Detection',
            description: 'Track site changes and trigger notifications or workflows.',
            icon: Zap,
            color: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Natural Language Extraction',
            description: 'Use LLMs to extract text, sentiment, product info, and more from any page.',
            icon: Brain,
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Instantly extract, structure, and deliver web data at scale using AI. No coding, no limits—just clean, actionable information delivered wherever you need it.
                    </div>
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            ...
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">Web Scraping AI Agent</h3>
                                        <div className="text-slate-400 text-sm flex items-center gap-2">
                                            <div className="w-2 h-2 bg-emerald-400 rounded-full animate-ping"></div>
                                            Online • Extracting instantly
                                        </div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4">
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-emerald-400">1M+</div>
                                        <div className="text-xs text-slate-400">Pages Daily</div>
                                    </div>
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-blue-400">&lt; 1s</div>
                                        <div className="text-xs text-slate-400">Avg Extraction</div>
                                    </div>
                                </div>
                            </div>
                            {/* Chat Interface */}
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3 animate-slideInLeft">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Scrape all product prices from example.com and update my Google Sheet daily.</span>
                                ...
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '0.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Job scheduled! Data will be extracted every 24h and synced to your Google Sheet. Get notified on Slack if prices change by &gt;5%.</span>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Can you also extract product images and descriptions?</span>
                                ...
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '1.2s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Absolutely! Product images, names, and descriptions will be included in the data export.</span>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> scalable web scraping</span>
                        </h2>
                    </div>
                        ...
                        <div className={`relative transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
                            <div className="relative">
                                ...
                                <div className="relative w-80 h-80 mx-auto">
                                    ...
                                    {[
                                        { label: 'DOM', angle: 0, color: 'from-blue-500 to-cyan-500' },
                                        { label: 'NLP', angle: 60, color: 'from-emerald-500 to-teal-500' },
                                        { label: 'Anti-Bot', angle: 120, color: 'from-orange-500 to-red-500' },
                                        { label: 'Export', angle: 180, color: 'from-purple-500 to-pink-500' },
                                        { label: 'Monitor', angle: 240, color: 'from-yellow-500 to-orange-500' },
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Join thousands of teams using AI to automate web data collection, monitoring, and delivery. Try for free and see how much faster you can get insights.
                        </p>
                        {/* Trust Indicators */}
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-8 border-t border-slate-700/50">
                            {[
                                { label: 'Enterprise Scale', value: 'Millions of pages' },
