...
export default function AccountsReceivableAIAgent() {
    ...
    // Stats specifically tailored for Accounts Receivable AI
    const stats = [
        { label: 'Avg Invoice Processing Time', value: '<2m', icon: Clock, color: 'from-blue-500 to-cyan-500' },
        { label: 'Reduction in DSO', value: '27%', icon: BarChart3, color: 'from-yellow-500 to-orange-500' },
        { label: 'Automated Payment Reminders', value: '99%', icon: Zap, color: 'from-purple-500 to-pink-500' },
        { label: 'Dispute Resolution Rate', value: '93%', icon: CheckCircle, color: 'from-emerald-500 to-teal-500' },
    ];

    // Features for AR AI Agent
    const features = [
        {
            title: 'Automated Invoice Management',
            description: 'Seamlessly generate, send, and track invoices with zero manual intervention. Reduce human error and accelerate cash flow.',
            icon: Database,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Intelligent Payment Reminders',
            description: 'Send personalized, multi-channel reminders to clients before and after due dates to maximize collections with a human touch.',
            icon: MessageCircle,
            gradient: 'from-purple-500 to-pink-500'
        },
        {
            title: 'Dispute Handling Automation',
            description: 'Detect, categorize, and resolve disputes faster using AI-driven workflows and sentiment analysis.',
            icon: Users,
            gradient: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Credit Risk Analysis',
            description: 'Analyze customer payment behavior and creditworthiness in real-time to minimize bad debt.',
            icon: Shield,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: 'Collections Analytics Dashboard',
            description: 'Visualize AR aging, collector performance, and customer trends for data-driven decisions.',
            icon: BarChart3,
            gradient: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'ERP & Accounting Integration',
            description: 'Connect instantly to SAP, Oracle, QuickBooks, Xero, and more for unified AR management.',
            icon: Cpu,
            gradient: 'from-pink-500 to-rose-500'
        },
        {
            title: 'Intelligent Cash Application',
            description: 'Auto-match payments to invoices using OCR and bank reconciliation with high precision.',
            icon: Brain,
            gradient: 'from-rose-500 to-pink-500'
        },
        {
            title: 'Regulatory Compliance',
            description: 'Ensure SOX, PCI-DSS, and GDPR compliance with full audit trails and secure document storage.',
            icon: Shield,
            gradient: 'from-amber-500 to-orange-500'
        }
    ];

    // How It Works for AR AI Agent
    const howItWorks = [
        {
            step: 1,
            title: 'Invoice Generation & Dispatch',
            description: 'Invoices are automatically created from ERP/accounting systems and sent to customers via preferred channels.',
            icon: Database,
        ...
        },
        {
            ...
            description: 'AI triggers timely, personalized reminders and escalations through email, SMS, and phone based on customer behavior.',
            icon: MessageSquare,
            color: 'from-purple-500 to-pink-500'
        },
        {
            step: 3,
            title: 'Dispute & Payment Handling',
            description: 'The agent manages payment receipts, matches transactions, and guides customers through dispute resolution.',
            icon: Cpu,
        ...
        },
        {
            ...
            description: 'Finance teams get up-to-the-minute dashboards on collections, DSO, and outstanding receivables.',
            icon: BarChart3,
            color: 'from-orange-500 to-red-500'
        }
    ];

    // Integrations relevant for AR
    const integrations = [
        ...
        { name: 'Microsoft Dynamics', category: 'ERP', logo: '🟦' },
        ...
        { name: 'Mailgun', category: 'Email', logo: '✉️' },
        { name: 'Teams', category: 'Communication', logo: '👥' },
        { name: 'DocuSign', category: 'E-signature', logo: '📝' },
    ];

    // Channels for AR agent
    const channels = [
        { name: 'Email Invoices', icon: Mail, description: 'Automated, branded invoice emails' },
        { name: 'SMS Reminders', icon: Smartphone, description: 'Instant payment nudges via mobile' },
        { name: 'Phone Calls', icon: Phone, description: 'Automated voice reminders & escalations' },
        { name: 'Customer Portal', icon: Globe, description: 'Self-serve invoice management & payments' }
    ];

    // Benefits for AR agent
    const benefits = [
        {
            title: 'Accelerate Cash Flow',
            description: 'Reduce Days Sales Outstanding (DSO) and unlock working capital with faster collections.',
            percentage: '27%',
            metric: 'DSO reduction'
        },
        {
            title: 'Minimize Bad Debt',
            description: 'AI-driven risk scoring and proactive follow-ups lead to fewer write-offs.',
            percentage: '40%',
            metric: 'bad debt reduction'
        },
        {
            title: 'Free Up Finance Teams',
            description: 'Automate repetitive AR tasks so your experts focus on strategic finance, not chasing payments.',
            percentage: '60%',
            metric: 'productivity boost'
        },
        {
            title: 'Enhance Customer Experience',
            description: 'Polite, 24/7 reminders and easy payment options increase satisfaction and loyalty.',
            percentage: '4.8★',
            metric: 'average satisfaction'
        },
        {
            title: 'Ensure Compliance & Auditability',
            description: 'Secure, traceable communications and full audit trails for regulatory peace of mind.',
            percentage: '100%',
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Supercharge your collections process with AI that automates invoices, payment reminders, and dispute handling. Reduce DSO, improve cash flow, and give your finance team time to focus on growth.
                    </div>
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            ...
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">Accounts Receivable AI Agent</h3>
                                        <div className="text-slate-400 text-sm flex items-center gap-2">
                                            <div className="w-2 h-2 bg-emerald-400 rounded-full animate-ping"></div>
                                            Online • Automating collections
                                        </div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4">
                                    <div className="text-right">
                                        ...
                                        <div className="text-xs text-slate-400">DSO Reduction</div>
                                    </div>
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-blue-400">&lt;2m</div>
                                        <div className="text-xs text-slate-400">Invoice Process</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3 animate-slideInLeft">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Hi, I see invoice #1189 is overdue. Can you resend it and provide a payment link?</span>
                                        <span className="text-xs text-slate-400 mt-1 block">11:04 AM</span>
                                    </div>
                                </div>
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '0.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Invoice #1189 has been resent with a direct payment link. Would you like to set up a payment reminder or need help with payment options?</span>
                                        <span className="text-xs text-blue-100 mt-1 block">11:04 AM</span>
                                    </div>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Yes, please set a reminder for next Monday if unpaid.</span>
                                ...
                                <div className="flex gap-3 justify-end">
                                    <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 rounded-2xl p-3 border border-blue-500/30">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-xs text-blue-300">AI is scheduling reminder...</span>
                                        </div>
                                    </div>
                                    <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center">
                                        <Bot className="w-4 h-4 text-white" />
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('how-it-works') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> faster collections</span>
                        </h2>
                    </div>
                    <div className="relative">
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> smarter receivables</span>
                        </h2>
                    </div>
            ...
            <section id="channels" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('channels') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Connect with every
                            <span className="bg-gradient-to-r from-blue-400 to-cyan-600 bg-clip-text text-transparent"> customer & system</span>
                        </h2>
                    </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('benefits') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> unlock working capital</span>
                        </h2>
                    </div>
            ...
            <section id="capabilities" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            AR intelligence that
                            <span className="bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent"> maximizes collection</span>
                        </h2>
                    </div>
                        ...
                        <div className={`relative transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
                            <div className="relative">
                                ...
                                <div className="relative w-80 h-80 mx-auto">
                                    ...
                                    {[
                                        { label: 'Invoice OCR', angle: 0, color: 'from-blue-500 to-cyan-500' },
                                        { label: 'NLP', angle: 60, color: 'from-emerald-500 to-teal-500' },
                                        { label: 'Risk Scoring', angle: 120, color: 'from-orange-500 to-red-500' },
                                        ...
                                        { label: 'ERP Sync', angle: 300, color: 'from-indigo-500 to-purple-500' }
                                    ].map((node, index) => {
                            ...
                            {[
                                {
                                    ...
                                    description: 'Reads, extracts, and reconciles invoice, payment, and customer data with 99.1% accuracy using OCR and ML.',
                                    icon: Database,
                                    color: 'from-blue-500 to-cyan-500'
                                },
                                {
                                    title: 'Natural Language Processing',
                                    description: 'Understands customer replies in any language and auto-classifies disputes or payment promises.',
                                    icon: MessageCircle,
                                    color: 'from-purple-500 to-pink-500'
                                },
                                {
                                    title: 'Predictive Risk Scoring',
                                    description: 'Analyzes payment patterns to predict late payments and prioritize collection efforts.',
                                    icon: Brain,
                                    color: 'from-emerald-500 to-teal-500'
                                },
                                {
                                    title: 'Real-time AR Analytics',
                                    description: 'Dashboards for DSO, aging, and collection effectiveness, updated live from ERP and payment sources.',
                                    icon: BarChart3,
                                    color: 'from-orange-500 to-red-500'
                                },
                                {
                                    title: 'Regulatory Compliance',
                                    description: 'GDPR, SOX, and PCI-DSS compliant with full audit trail and encryption at rest & in transit.',
                                    icon: Shield,
                                    color: 'from-indigo-500 to-purple-500'
                                },
                                {
                                    title: 'Seamless ERP Connectivity',
                                    description: 'Bidirectional sync with all major ERP/accounting platforms via secure APIs.',
                                    icon: Cpu,
            ...
            <section id="cta" className="py-16 sm:py-24 lg:py-32 px-4 bg-gradient-to-br from-slate-900/50 to-slate-800/30">
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        <div className="inline-flex items-center px-4 sm:px-6 py-2 mb-6 sm:mb-8 rounded-full border border-slate-700/50 bg-slate-800/30 backdrop-blur-sm text-xs sm:text-sm text-slate-300">
                            <Zap className="w-4 h-4 mr-2 text-emerald-400" />
                            Start Your AR Automation Journey
                        </div>
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 sm:mb-8 leading-tight">
                            Automate accounts receivable
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> like never before</span>
                        </h2>
                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Experience faster collections, fewer disputes, and less manual effort. Get a personalized ROI analysis and see how much you can save with AR AI Agent.
                        </p>
                        {/* Trust Indicators */}
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-8 border-t border-slate-700/50">
                            {[
                                { label: 'Enterprise-Ready', value: 'SOC 2, GDPR, SOX' },
                                { label: 'Setup Time', value: '< 5 Days' },
                                { label: 'No-Code Setup', value: 'Drag & Drop' },
