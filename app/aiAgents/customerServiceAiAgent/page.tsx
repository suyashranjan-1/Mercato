...
export default function CustomerServiceAIAgent() {
    ...
    const stats = [
        { label: 'Avg Response Time', value: '<5s', icon: Clock, color: 'from-blue-500 to-cyan-500' },
        { label: 'Customer Satisfaction', value: '98%', icon: Star, color: 'from-yellow-500 to-orange-500' },
        { label: 'First-Contact Resolution', value: '92%', icon: CheckCircle, color: 'from-emerald-500 to-teal-500' },
    ...
    const features = [
        {
            ...
            description: 'Get immediate answers to customer queries 24/7 without waiting in queues. Our AI processes thousands of requests simultaneously.',
            icon: Zap,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Multi-Channel Support',
            description: 'Seamlessly handle inquiries across chat, email, social media, and phone with unified customer context.',
            icon: MessageCircle,
            gradient: 'from-purple-500 to-pink-500'
        },
        {
            title: 'Smart Escalation',
            description: 'Automatically route complex issues to human agents when needed with complete conversation history.',
            icon: Users,
            gradient: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Data Security',
            description: 'Enterprise-grade security ensuring customer data protection with SOC 2 Type II compliance.',
            icon: Shield,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: 'Analytics Dashboard',
            description: 'Real-time insights into customer interactions, satisfaction metrics, and performance analytics.',
            icon: BarChart3,
            gradient: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Voice Integration',
            description: 'Natural voice conversations with advanced speech recognition and text-to-speech capabilities.',
            icon: Headphones,
            gradient: 'from-pink-500 to-rose-500'
        },
        {
            title: 'Sentiment Analysis',
            description: 'Real-time emotion detection adjusts tone and escalation paths based on customer frustration levels',
            icon: Brain,
            gradient: 'from-rose-500 to-pink-500'
        },
        {
            title: 'Predictive Support',
            description: 'Anticipate customer needs using purchase history and browsing patterns with 93% accuracy',
            icon: Database,
    ...
    const howItWorks = [
        {
            ...
            description: 'Customer sends a message through any channel - chat, email, social media, or phone.',
            icon: MessageSquare,
        ...
        },
        {
            step: 2,
            title: 'AI Processing',
            description: 'Multi-model AI system analyzes text/speech with 50+ NLP models and accesses 150+ integrated data sources in real-time',
            icon: Brain,
        ...
        },
        {
            ...
            description: 'AI generates personalized responses based on customer history and business knowledge.',
            icon: Cpu,
        ...
        },
        {
            ...
            description: 'Issue is resolved instantly, and AI learns from the interaction to improve future responses.',
            icon: Database,
    ...
    const integrations = [
        ...
        { name: 'Salesforce Service Cloud', category: 'CRM', logo: '☁️' },
        { name: 'Oracle CX', category: 'Experience', logo: '🔮' },
    ];

    const channels = [
        { name: 'Website Chat', icon: MessageCircle, description: 'Embed directly on your website' },
        { name: 'Email Support', icon: Mail, description: 'Handle email inquiries automatically' },
        { name: 'Phone Support', icon: Phone, description: 'Voice-enabled customer service' },
        { name: 'Mobile App', icon: Smartphone, description: 'Native mobile app integration' }
    ];

    const benefits = [
        {
            title: 'Reduce Response Time',
            description: 'From hours to seconds - instant customer support across all channels',
            percentage: '90%',
            metric: 'faster responses'
        },
        {
            title: 'Cut Support Costs',
            description: 'Automate routine queries and reduce operational expenses significantly',
            percentage: '60%',
            metric: 'cost reduction'
        },
        {
            title: 'Increase Satisfaction',
            description: 'Higher customer satisfaction through consistent, accurate service delivery',
            percentage: '85%',
            metric: 'satisfaction boost'
        },
        {
            title: 'Scale Effortlessly',
            description: 'Handle unlimited conversations simultaneously without hiring more staff',
            percentage: '∞',
            metric: 'scalability'
        },
        {
            title: 'Reduce Agent Workload',
            description: 'Automate 85% of routine inquiries allowing human agents to focus on complex cases',
            percentage: '6.8x',
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Transform your customer support with AI that understands, responds, and resolves{' '}
                        <span className="text-white font-medium">instantly</span>. Available 24/7 across all channels with enterprise-grade security.
                    </div>
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            ...
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">Customer Service AI Agent</h3>
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-blue-400">&lt; 5s</div>
                            ...
                            <div className="space-y-4 mb-6">
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Perfect! Thank you so much. Can you also help me change my delivery address?</span>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> exceptional</span> customer service
                        </h2>
                    </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('channels') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-blue-400 to-cyan-600 bg-clip-text text-transparent"> customer touchpoints</span>
                        </h2>
                    </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent"> every customer</span>
                        </h2>
                    </div>
                            ...
                            <div className="relative">
                                ...
                                <div className="relative w-80 h-80 mx-auto">
                                    ...
                                    {[
                                        ...
                                        { label: 'Voice', angle: 120, color: 'from-orange-500 to-red-500' },
                            ...
                            {[
                                {
                                    ...
                                    description: 'Comprehends customer intent, emotions, and context across 50+ languages with 99.7% accuracy.',
                                    icon: MessageCircle,
                                    color: 'from-blue-500 to-cyan-500'
                                },
                                {
                                    title: 'Machine Learning Optimization',
                                    description: 'Continuously learns from interactions to improve response quality and resolution rates.',
                                    icon: Brain,
                                    color: 'from-purple-500 to-pink-500'
                                },
                                {
                                    title: 'Voice & Speech Processing',
                                    description: 'Advanced voice recognition and synthesis for natural phone conversations.',
                                    icon: Headphones,
                                    color: 'from-emerald-500 to-teal-500'
                                },
                                {
                                    title: 'Real-time Analytics',
                                    description: 'Instant insights into customer sentiment, satisfaction, and interaction patterns.',
                                    icon: BarChart3,
                                    color: 'from-orange-500 to-red-500'
                                },
                                {
                                    title: 'Enterprise Security',
                                    description: 'Military-grade encryption (AES-256) with GDPR/HIPAA/PCI-DSS compliance and regular penetration testing',
                                    icon: Shield,
                                    color: 'from-indigo-500 to-purple-500'
                                },
                                {
                                    title: 'Omnichannel History',
                                    description: 'Maintain complete context across 25+ communication channels with 18-month conversation memory',
                                    icon: Database,
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 sm:mb-8 leading-tight">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> customer service today</span>
                        </h2>

                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Join thousands of companies already using AI to transform their customer experience. 
