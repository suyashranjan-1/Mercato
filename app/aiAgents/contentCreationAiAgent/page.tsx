...
export default function ContentCreationAIAgent() {
    ...
    const features = [
        {
            ...
            description: 'Produce high-quality articles, blogs, and marketing copy instantly. Say goodbye to writer’s block.',
            icon: Database,
    ...
    const integrations = [
        ...
        { name: 'Buffer', category: 'Social Scheduling', logo: '📅' },
    ...
    const benefits = [
        ...
        },
        {
            ...
            description: 'Ensure every piece matches your brand’s voice and guidelines.',
            percentage: '99%',
            metric: 'consistency'
        }
    ];
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Unlock unlimited creative potential with an AI agent that crafts blogs, social posts, ad copy, and more—faster than ever, always on-brand, and SEO-optimized.
                    </div>
                            ...
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3 animate-slideInLeft">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Write a blog post on “Top 5 AI Trends in 2025” with an engaging intro and SEO focus.</span>
