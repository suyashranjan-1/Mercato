...
import {
    MessageCircle, Clock, Users, Star, CheckCircle, ArrowRight, Bot, Shield, Zap, BarChart3, Globe, Play, ChevronRight, Brain, Cpu, Database, Settings, Phone, Mail, MessageSquare, Smartphone, Receipt, PackageCheck
} from 'lucide-react';
import { NavbarDemo } from "@/components/navbar";
import Footer from "@/components/Footer";

export default function ReturnHandlingAIAgent() {
    ...
    const stats = [
        { label: 'Avg Handling Time', value: '<1m', icon: Clock, color: 'from-blue-500 to-cyan-500' },
        { label: 'Customer Satisfaction', value: '98%', icon: Star, color: 'from-yellow-500 to-orange-500' },
        { label: 'Automated Returns', value: '95%', icon: CheckCircle, color: 'from-emerald-500 to-teal-500' },
        { label: 'System Uptime', value: '99.99%', icon: Zap, color: 'from-purple-500 to-pink-500' },
    ];

    const features = [
        {
            title: 'Instant Return Processing',
            description: 'AI instantly verifies and processes return requests, reducing manual review and customer wait time.',
            icon: Receipt,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Multi-Channel Support',
            description: 'Handle returns via chat, email, app, and phone with a unified workflow and full context.',
            icon: MessageCircle,
            gradient: 'from-purple-500 to-pink-500'
        },
        {
            title: 'Fraud Detection',
            description: 'Advanced algorithms flag suspicious return patterns and reduce abuse.',
            icon: Shield,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: 'Real-Time Updates',
            description: 'Notifies customers at every step—request received, item returned, refund processed.',
            icon: Zap,
            gradient: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Policy Guidance',
            description: 'AI explains return policies and applies the correct rules to each case.',
            icon: Settings,
            gradient: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Powerful Analytics',
            description: 'Dashboards for trends, efficiency, and customer feedback on the returns process.',
            icon: BarChart3,
            gradient: 'from-pink-500 to-rose-500'
        },
        {
            title: 'Seamless Integration',
            description: 'Connects with e-commerce, CRM, POS, and warehouse systems for end-to-end automation.',
            icon: Globe,
            gradient: 'from-rose-500 to-pink-500'
        },
        {
            title: 'Self-Service Portal',
            description: 'Customers can start and track returns instantly via web or mobile app.',
            icon: Smartphone,
    ...
    const howItWorks = [
        {
            ...
            description: 'Customer starts a return via chat, app, or online portal.',
            icon: MessageSquare,
            color: 'from-blue-500 to-cyan-500'
        },
        {
            step: 2,
            title: 'AI Policy Validation',
            description: 'ReturnHandlingAiAgent checks eligibility, policy compliance, and fraud indicators.',
            icon: Brain,
        ...
        },
        {
            ...
            description: 'Customer receives instant approval (or next steps) and return shipping instructions.',
            icon: PackageCheck,
            color: 'from-emerald-500 to-teal-500'
        },
        {
            step: 4,
            title: 'Return Completion & Feedback',
            description: 'AI tracks item receipt, triggers refund, and collects customer feedback for continuous improvement.',
            icon: BarChart3,
    ...
    const channels = [
        { name: 'Web Portal', icon: Globe, description: 'Start and track returns online' },
        { name: 'Mobile App', icon: Smartphone, description: 'Self-service return on your app' },
        { name: 'Email Support', icon: Mail, description: 'Request returns via email' },
        { name: 'Phone Support', icon: Phone, description: 'Voice-enabled return handling' }
    ];

    const benefits = [
        {
            title: 'Accelerate Returns',
            description: 'Reduce the average handling time for returns from days to minutes.',
            percentage: '85%',
            metric: 'faster returns'
        },
        {
            title: 'Reduce Manual Work',
            description: 'Automate repetitive return processes so your team can focus on higher value interactions.',
            percentage: '70%',
            metric: 'manual work cut'
        },
        {
            title: 'Boost Satisfaction',
            description: 'Transparent and fast returns increase trust and repeat sales.',
            percentage: '+20%',
            metric: 'customer trust'
        },
        {
            title: 'Detect Fraud Early',
            description: 'Advanced AI flags abusive return patterns and prevents losses.',
            percentage: '-40%',
            metric: 'fraud rate'
        },
        {
            title: 'Compliance & Insights',
            description: 'Maintain compliance and audit trails, and get actionable return analytics.',
            percentage: '100%',
            metric: 'compliance'
        }
    ];
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Automate, streamline, and secure your returns process with AI. <span className="text-white font-medium">Delight customers</span>, protect your revenue, and give your team more time for what matters.
                    </div>
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            ...
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">Return Handling AI Agent</h3>
                                        <div className="text-slate-400 text-sm flex items-center gap-2">
                                            <div className="w-2 h-2 bg-emerald-400 rounded-full animate-ping"></div>
                                            Online • Processing returns
                                        </div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="text-right">
                                        ...
                                        <div className="text-xs text-slate-400">Avg Handling</div>
                                    </div>
                                </div>
                            </div>
                            {/* Chat Interface */}
                            <div className="space-y-4 mb-6">
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">How long will my refund take?</span>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> effortless returns</span>
                        </h2>
                    </div>
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 sm:mb-8 leading-tight">
                            Start automating returns with
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> Return AI</span>
                        </h2>
                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Get seamless onboarding, dedicated support, and proven automation to transform your returns and refunds experience—today.
                        </p>
