...
import { Bot, ArrowRight, Play, Clock, Star, CheckCircle, Zap, BarChart3, Globe, Settings, ChevronRight, Brain, Cpu, Database, MessageCircle, Users, Shield, Smartphone, Mail, Phone, FileText, Building2 } from 'lucide-react';
...
export default function IndustrySpecificAIAgent() {
    ...
    // Example stats for industry-specific AI
    const stats = [
        { label: 'Custom Integrations', value: '25+', icon: Database, color: 'from-blue-500 to-cyan-500' },
        { label: 'Process Automation', value: '95%', icon: Zap, color: 'from-yellow-500 to-orange-500' },
        { label: 'User Satisfaction', value: '99%', icon: Star, color: 'from-emerald-500 to-teal-500' },
        { label: 'Uptime', value: '99.99%', icon: Clock, color: 'from-purple-500 to-pink-500' },
    ];

    // Features tailored to industry
    const features = [
        {
            title: 'Domain-specific Knowledge',
            description: 'Integrates proprietary and industry data to answer nuanced queries with accuracy.',
            icon: Brain,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Automated Workflows',
            description: 'Streamline complex business processes, document handling, and compliance tasks.',
            icon: Settings,
            gradient: 'from-purple-500 to-pink-500'
        },
        {
            title: 'Custom Integrations',
            description: 'Connects with legacy systems, ERPs, CRMs, and sector-specific platforms.',
            icon: Database,
            gradient: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Multichannel Support',
            description: 'Available on web, mobile, chat, phone, and email for customer and team engagement.',
            icon: Globe,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: 'Advanced Analytics',
            description: 'Real-time dashboards and reporting for KPIs, compliance, and productivity.',
            icon: BarChart3,
            gradient: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Human-in-the-Loop',
            description: 'Seamlessly escalates complex issues to human experts and tracks outcomes.',
            icon: Users,
            gradient: 'from-pink-500 to-rose-500'
        },
        {
            title: 'Enterprise Security',
            description: 'SOC 2/ISO 27001 compliant, encrypted storage, and access controls.',
            icon: Shield,
            gradient: 'from-amber-500 to-orange-500'
        },
        {
            title: 'Regulation & Compliance',
            description: 'Built-in support for GDPR, HIPAA, PCI-DSS, and sector regulations.',
            icon: FileText,
    ...
    const howItWorks = [
        {
            step: 1,
            title: 'Industry Data Ingestion',
            description: 'Connect your databases, documents, and APIs securely to the AI agent.',
            icon: Database,
        ...
        },
        {
            ...
            description: 'AI learns your business rules, terminology, and best practices.',
            icon: Brain,
        ...
        },
        {
            ...
            description: 'Agent handles inquiries, tasks, and workflows, escalating to humans when needed.',
            icon: Cpu,
        ...
        },
        {
            ...
            description: 'Performance analytics and feedback loops ensure ongoing improvement.',
            icon: BarChart3,
            color: 'from-orange-500 to-red-500'
        }
    ];

    // Example integrations for industry
    const integrations = [
        { name: 'Salesforce', category: 'CRM', logo: '☁️' },
        { name: 'SAP', category: 'ERP', logo: '💼' },
        { name: 'Epic', category: 'Healthcare', logo: '🩺' },
        ...
        { name: 'SharePoint', category: 'Documents', logo: '📁' },
        { name: 'ServiceNow', category: 'ITSM', logo: '🛠️' },
        { name: 'Custom API', category: 'Any System', logo: '🔗' },
    ];

    const channels = [
        { name: 'Web Portal', icon: Building2, description: 'Agent embedded directly in your company portal' },
        { name: 'Mobile App', icon: Smartphone, description: 'Mobile-first agent for field teams and customers' },
        { name: 'Email Integration', icon: Mail, description: 'Handles requests and notifications via email' },
        { name: 'Phone/IVR', icon: Phone, description: 'Voice-enabled agent for phone support and routing' }
    ];

    const benefits = [
        {
            title: 'Faster Task Completion',
            description: 'Automate routine and sector-specific tasks, reducing manual effort and response times.',
            percentage: '4x',
            metric: 'efficiency gain'
        },
        {
            title: 'Lower Error Rates',
            description: 'Minimize process and data errors with AI-driven validation and compliance checks.',
            percentage: '80%',
            metric: 'fewer mistakes'
        },
        {
            title: 'Scalable Operations',
            description: 'Handle spikes in demand and multi-site operations without increasing headcount.',
            percentage: '∞',
            metric: 'scalability'
        },
        {
            title: 'Enhanced Compliance',
            description: 'Stay audit-ready with traceability, reporting, and automated record-keeping.',
            percentage: '100%',
            metric: 'compliance'
        },
        {
            title: 'Personalized Service',
            description: 'Deliver tailored responses and workflows for every industry and client segment.',
            percentage: '98%',
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Accelerate your business with an AI agent tailored for your sector. Integrate domain knowledge, automate processes, and provide personalized support—securely and at scale.
                    </div>
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">Industry AI Assistant</h3>
                                        <div className="text-slate-400 text-sm flex items-center gap-2">
                                            <div className="w-2 h-2 bg-emerald-400 rounded-full animate-ping"></div>
                                            Online • Custom to your sector
                                        </div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-blue-400">99.99%</div>
                            ...
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3 animate-slideInLeft">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Can you automate our compliance report workflow?</span>
                                        <span className="text-xs text-slate-400 mt-1 block">9:11 AM</span>
                                    </div>
                                </div>
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '0.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Absolutely! I’ve connected with your document management system and can generate compliance reports automatically.</span>
                                        <span className="text-xs text-blue-100 mt-1 block">9:11 AM</span>
                                    </div>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Can you answer sector-specific regulations questions?</span>
                                        <span className="text-xs text-slate-400 mt-1 block">9:12 AM</span>
                                    </div>
                                </div>
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '1.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Yes, I’m trained on your industry’s regulations and can provide guidance and documentation.</span>
                                        <span className="text-xs text-blue-100 mt-1 block">9:12 AM</span>
                                    </div>
                                    <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center">
                                        <Bot className="w-4 h-4 text-white" />
                                    </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('how-it-works') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Designed for your industry in
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> 4 steps</span>
                        </h2>
                    </div>
                    <div className="relative">
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> your business</span>
                        </h2>
                    </div>
            ...
            <section id="channels" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('channels') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Deploy to every
                            <span className="bg-gradient-to-r from-blue-400 to-cyan-600 bg-clip-text text-transparent"> workflow & channel</span>
                        </h2>
                    </div>
            ...
            <section id="benefits" className="py-16 sm:py-24 lg:py-32 px-4 bg-gradient-to-br from-slate-900/50 to-slate-800/30">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('benefits') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Transform your
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> sector with AI</span>
                        </h2>
                    </div>
            ...
            <section id="capabilities" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            AI skills for your
                            <span className="bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent"> unique business</span>
                        </h2>
                    </div>
                        ...
                        <div className={`relative transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
                            <div className="relative">
                                <div className="relative w-80 h-80 mx-auto">
                                    ...
                                    {[
                                        { label: 'Domain Data', angle: 0, color: 'from-blue-500 to-cyan-500' },
                                        { label: 'NLP', angle: 60, color: 'from-emerald-500 to-teal-500' },
                                        { label: 'Integrations', angle: 120, color: 'from-orange-500 to-red-500' },
                            ...
                            {[
                                {
                                    ...
                                    description: 'Understands professional jargon, acronyms, and context unique to your sector.',
                                    icon: MessageCircle,
                                    color: 'from-blue-500 to-cyan-500'
                                },
                                {
                                    title: 'Custom Workflow Automation',
                                    description: 'Automates approval cycles, document routing, and reporting for your business.',
                                    icon: Settings,
                                    color: 'from-purple-500 to-pink-500'
                                },
                                {
                                    title: 'Deep System Integration',
                                    description: 'Connects with your proprietary and 3rd-party IT stack for seamless data flow.',
                                    icon: Database,
                                    color: 'from-emerald-500 to-teal-500'
                                },
                                {
                                    title: 'Real-Time Reporting',
                                    description: 'Generates dashboards, alerts, and trends for KPIs, compliance, and productivity.',
                                    icon: BarChart3,
                                    color: 'from-orange-500 to-red-500'
                                },
                                {
                                    title: 'Compliance Intelligence',
                                    description: 'Built for sector standards (GDPR, HIPAA, PCI, etc.) with automatic documentation.',
                                    icon: FileText,
                                    color: 'from-indigo-500 to-purple-500'
                                },
                                {
                                    title: 'Enterprise Security',
                                    description: 'Implements robust encryption, RBAC, audit logs, and privacy by design.',
                                    icon: Shield,
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 sm:mb-8 leading-tight">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> industry workflows today</span>
                        </h2>
                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Deploy a secure, compliant, and scalable AI agent purpose-built for your sector. Unlock productivity, compliance, and customer value in days—not months.
                        </p>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-8 border-t border-slate-700/50">
                            {[
                                { label: 'Setup Time', value: '< 7 Days' },
                                { label: 'Compliant', value: 'GDPR/HIPAA' },
