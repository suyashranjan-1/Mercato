...
import { FileText, Search, ScanText, BookOpen, Star, CheckCircle, Clock, Zap, BarChart3, Globe, Database, Settings, Play, ArrowRight, ChevronRight, Brain, Eye, Shield, Download, UploadCloud, Layers, Columns3 } from 'lucide-react';
import { NavbarDemo } from "@/components/navbar";
import Footer from "@/components/Footer";

export default function DocumentParserAIAgent() {
    ...
    const stats = [
        { label: 'Avg Parsing Time', value: '<1s', icon: Clock, color: 'from-blue-500 to-cyan-500' },
        { label: 'Parsing Accuracy', value: '99.8%', icon: Star, color: 'from-yellow-500 to-orange-500' },
        { label: 'Multi-format Support', value: '50+', icon: CheckCircle, color: 'from-emerald-500 to-teal-500' },
    ...
    const features = [
        {
            ...
            description: 'AI-powered extraction of data, tables, and key insights from PDFs, Word, Excel, images, and more.',
            icon: ScanText,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Advanced OCR & NLP',
            description: 'Extracts text, entities, and context from scanned documents and images with industry-leading accuracy.',
            icon: Eye,
            gradient: 'from-purple-500 to-pink-500'
        },
        {
            title: 'Semantic Structuring',
            description: 'Transforms unstructured documents into clean, searchable, and analyzable datasets.',
            icon: Columns3,
            gradient: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Bulk Upload & Processing',
            description: 'Parse thousands of documents simultaneously and automate large-scale workflows.',
            icon: UploadCloud,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: 'Export to Any Format',
            description: 'Convert parsed data to Excel, CSV, JSON, or push directly to databases and business apps.',
            icon: Download,
            gradient: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Data Privacy & Security',
            description: 'All documents are encrypted, processed securely, and never stored without consent.',
            icon: Shield,
            gradient: 'from-pink-500 to-rose-500'
        },
        {
            title: 'Document Classification',
            description: 'Automatically categorize documents by type, topic, or tags using machine learning.',
            icon: Layers,
            gradient: 'from-rose-500 to-pink-500'
        },
        {
            title: 'Intelligent Search',
            description: 'Find relevant documents and content instantly with AI-powered search over your entire corpus.',
            icon: Search,
    ...
    const howItWorks = [
        {
            ...
            description: 'User uploads documents or connects storage sources (cloud, email, app integrations).',
            icon: UploadCloud,
        ...
        },
        {
            ...
            description: 'AI analyzes, extracts, and structures all text, tables, and key fields using OCR and NLP.',
            icon: ScanText,
        ...
        },
        {
            ...
            description: 'User reviews extracted data, confirms results, and makes edits if needed.',
            icon: CheckCircle,
        ...
        },
        {
            ...
            description: 'Export parsed data, trigger automations, or send results directly to your business systems.',
            icon: Download,
    ...
    const integrations = [
        ...
        { name: 'Dropbox', category: 'Cloud Storage', logo: '🗂️' },
        { name: 'Microsoft OneDrive', category: 'Cloud Storage', logo: '🪟' },
        { name: 'Box', category: 'Cloud Storage', logo: '📦' },
        ...
        { name: 'SQL Database', category: 'Database', logo: '🗃️' },
        { name: 'HubSpot', category: 'CRM', logo: '📊' },
        { name: 'Google Sheets', category: 'Spreadsheet', logo: '🧾' },
        { name: 'QuickBooks', category: 'Finance', logo: '💵' },
        { name: 'SAP Concur', category: 'Expense', logo: '💳' },
        { name: 'Oracle NetSuite', category: 'ERP', logo: '🧮' },
        { name: 'DocuSign', category: 'E-signature', logo: '✍️' },
    ];

    const channels = [
        { name: 'Web Dashboard', icon: Globe, description: 'Parse, search, and manage documents from anywhere' },
        { name: 'API Access', icon: Database, description: 'Automate parsing at scale via robust API endpoints' },
        { name: 'Email Upload', icon: FileText, description: 'Send documents by email for instant parsing' },
        { name: 'Cloud Sync', icon: UploadCloud, description: 'Auto-sync and parse documents from cloud drives' }
    ];

    const benefits = [
        {
            title: 'Save Time & Costs',
            description: 'Reduce manual data entry and document processing hours by up to 90%.',
            percentage: '90%',
            metric: 'time savings'
        },
        {
            title: 'Boost Data Quality',
            description: 'Eliminate errors and inconsistencies with AI-validated extraction.',
            percentage: '99.8%',
            metric: 'accuracy'
        },
        {
            title: 'Accelerate Workflows',
            description: 'Automate document-driven processes for faster business outcomes.',
            percentage: '5x',
            metric: 'workflow speed'
        },
        {
            title: 'Scale Effortlessly',
            description: 'Handle unlimited document volumes with no extra staffing.',
            percentage: '∞',
            metric: 'scalability'
        },
        {
            title: 'Enhance Compliance',
            description: 'Ensure data privacy and audit readiness with secure, traceable processing.',
            percentage: '100%',
            metric: 'compliance'
        }
    ];
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    <div className="inline-flex items-center px-4 sm:px-6 py-2 mb-6 sm:mb-8 rounded-full border border-slate-700/50 bg-slate-800/30 backdrop-blur-sm text-xs sm:text-sm text-slate-300 hover:border-slate-600/50 transition-all duration-300">
                        <Brain className="w-4 h-4 mr-2 text-blue-400 animate-pulse" />
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Extract, classify, and structure data from any document in seconds. <span className="text-white font-medium">Boost productivity and accuracy</span> with AI-powered document parsing and automation.
                    </div>
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">Document Parser AI Agent</h3>
                                        <div className="text-slate-400 text-sm flex items-center gap-2">
                                            <div className="w-2 h-2 bg-emerald-400 rounded-full animate-ping"></div>
                                            Online • Parsing instantly
                                        </div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="text-right">
                                        ...
                                        <div className="text-xs text-slate-400">Avg Parse</div>
                                    </div>
                                </div>
                            </div>
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3 animate-slideInLeft">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Uploaded: Invoice_2025.pdf</span>
                                ...
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '0.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Parsed fields: Invoice #1941, Date: 2025-05-26, Total: $8,200. Client: Acme Corp. Exported to Excel.</span>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Uploaded: Contract_ABC.pdf</span>
                            ...
                            <div className="flex gap-3 justify-end">
                                <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 rounded-2xl p-3 border border-blue-500/30">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-xs text-blue-300">AI is parsing...</span>
                                    </div>
                                </div>
                                <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center">
                                    <Brain className="w-4 h-4 text-white" />
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('how-it-works') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            From upload to structured data in
            ...
            <section id="features" className="py-16 sm:py-24 lg:py-32 px-4 bg-gradient-to-br from-slate-900/50 to-slate-800/30">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        <div className="inline-flex items-center px-4 sm:px-6 py-2 mb-6 sm:mb-8 rounded-full border border-slate-700/50 bg-slate-800/30 backdrop-blur-sm text-xs sm:text-sm text-slate-300">
                            <ScanText className="w-4 h-4 mr-2 text-emerald-400" />
                            Key Features
                        </div>
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Everything you need for
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> fast, accurate document parsing</span>
                        </h2>
                    </div>
            ...
            <section id="channels" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('channels') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Parse documents across all your
                            <span className="bg-gradient-to-r from-blue-400 to-cyan-600 bg-clip-text text-transparent"> business touchpoints</span>
                        </h2>
                    </div>
            ...
            <section id="capabilities" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Advanced AI for
                            <span className="bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent"> document understanding</span>
                        </h2>
                    </div>
                        ...
                        <div className={`relative transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
                            <div className="relative w-80 h-80 mx-auto">
                                ...
                                {[
                                    ...
                                    { label: 'Tables', angle: 120, color: 'from-orange-500 to-red-500' },
                                    { label: 'Classification', angle: 180, color: 'from-purple-500 to-pink-500' },
                                    { label: 'Export', angle: 240, color: 'from-yellow-500 to-orange-500' },
                            ...
                            {[
                                {
                                    ...
                                    description: 'Extract text from PDFs, images, and scans with support for 100+ languages.',
                                    icon: Eye,
                                    color: 'from-blue-500 to-cyan-500'
                                },
                                {
                                    title: 'Natural Language Processing',
                                    description: 'Understand context, extract entities, and summarize long documents.',
                                    icon: BookOpen,
                                    color: 'from-purple-500 to-pink-500'
                                },
                                {
                                    title: 'Table Extraction',
                                    description: 'Parse complex tables into clean, structured data you can analyze.',
                                    icon: Columns3,
                                    color: 'from-emerald-500 to-teal-500'
                                },
                                {
                                    title: 'Document Classification',
                                    description: 'Automatically identify and tag document type, topic, or sensitivity.',
                                    icon: Layers,
                                    color: 'from-orange-500 to-red-500'
                                },
                                {
                                    title: 'Bulk & API Processing',
                                    description: 'Scale to millions of documents with robust bulk and API workflows.',
                                    icon: Database,
                                    color: 'from-indigo-500 to-purple-500'
                                },
                                {
                                    title: 'Secure & Compliant',
                                    description: 'GDPR-ready, encrypted at rest and in transit, with full audit logs.',
                                    icon: Shield,
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 sm:mb-8 leading-tight">
                            Start extracting value from your
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> documents today</span>
                        </h2>
                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Join organizations automating document processing with next-gen AI. Get started in minutes with our free trial and see how fast and easy parsing can be.
                        </p>
