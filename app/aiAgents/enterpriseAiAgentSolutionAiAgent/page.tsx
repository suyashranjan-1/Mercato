...
export default function EnterpriseAIAgentSolution() {
    ...
    const stats = [
        { label: 'Enterprise Uptime', value: '99.999%', icon: Zap, color: 'from-blue-500 to-cyan-500' },
        { label: 'Security Compliance', value: '100%', icon: Shield, color: 'from-emerald-500 to-teal-500' },
        { label: 'Global Users Supported', value: '1M+', icon: Users, color: 'from-purple-500 to-pink-500' },
        { label: 'AI Accuracy', value: '98.8%', icon: Star, color: 'from-yellow-500 to-orange-500' },
    ];

    const features = [
        {
            title: 'Omnichannel Enterprise Support',
            description: 'Deliver consistent, AI-driven support across web, mobile, phone, chat, and email, all with a unified knowledge base.',
            icon: Globe,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'End-to-End Automation',
            description: 'Automate business processes, IT ticketing, HR, and workflow approvals with intelligent, self-learning AI agents.',
            icon: Zap,
            gradient: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Enterprise Integrations',
            description: 'Seamlessly connect with SAP, Oracle, Salesforce, ServiceNow, Microsoft, and custom APIs.',
            icon: Cpu,
            gradient: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Enterprise-Grade Security',
            description: 'SOC 2 Type II, GDPR, HIPAA, ISO 27001 compliance, data residency, encryption at rest and in transit.',
            icon: Shield,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: 'Custom AI Training',
            description: 'Fine-tune and deploy models on your private data for contextual, domain-specific accuracy.',
            icon: Brain,
            gradient: 'from-pink-500 to-rose-500'
        },
        {
            title: 'Scalable Analytics',
            description: 'Real-time dashboards, KPI monitoring, and AI-powered forecasting for every department.',
            icon: BarChart3,
            gradient: 'from-yellow-500 to-orange-500'
        },
        {
            title: 'Human-in-the-Loop',
            description: 'Seamless escalation to live agents with full AI context and audit trails.',
            icon: Users,
            gradient: 'from-cyan-500 to-blue-500'
        },
        {
            title: 'Multilingual & Globalization',
            description: 'Support for 50+ languages, timezone, and regulatory localizations.',
            icon: Globe,
    ...
    const howItWorks = [
        {
            ...
            description: 'Connect your enterprise systems, data sources, and channels to the AI Agent for secure, unified access.',
            icon: Cpu,
        ...
        },
        {
            ...
            description: 'AI orchestrates workflows, automates decisions, and delivers intelligent responses enterprise-wide.',
            icon: Brain,
        ...
        },
        {
            ...
            description: 'Automate complex processes with adaptive learning and continuous optimization.',
            icon: Zap,
            color: 'from-emerald-500 to-teal-500'
        },
        {
            step: 4,
            title: 'Insights & Human Handover',
            description: 'Provide actionable insights, real-time monitoring, and escalate seamlessly to human experts when needed.',
            icon: Settings,
    ...
    const integrations = [
        ...
        { name: 'Atlassian', category: 'DevOps', logo: '🐦' },
        { name: 'Custom API', category: 'Integration', logo: '🔌' },
        { name: 'Tableau', category: 'Analytics', logo: '📈' },
    ];

    const channels = [
        { name: 'Web Portal', icon: Globe, description: 'Enterprise dashboard & self-service portal' },
        { name: 'Email', icon: Mail, description: 'Automated responses & analytics via email' },
        { name: 'Teams/Slack', icon: MessageCircle, description: 'Instant support in your favorite chat platforms' },
        { name: 'Mobile App', icon: Smartphone, description: 'AI agent on-the-go for field teams' }
    ];

    const benefits = [
        {
            title: 'Uptime & Reliability',
            description: '99.999% uptime guaranteed with 24/7 monitoring and auto-scaling infrastructure.',
            percentage: '99.999%',
            metric: 'uptime'
        },
        {
            title: 'Data Security',
            description: 'Keep your enterprise data secure with industry-leading encryption and compliance.',
            percentage: '100%',
            metric: 'compliance'
        },
        {
            title: 'Operational Efficiency',
            description: 'Reduce manual work by over 60% across departments with smart automation.',
            percentage: '60%',
            metric: 'manual reduction'
        },
        {
            title: 'Faster Decision Making',
            description: 'Deliver insights in seconds, not days, for data-driven leadership.',
            percentage: '12x',
            metric: 'faster insights'
        },
        {
            title: 'Global Scalability',
            description: 'Support thousands of users and millions of requests with global load balancing.',
            percentage: '1M+',
    ...
    const aiCapabilities = [
        ...
        { label: 'Security', angle: 60, color: 'from-emerald-500 to-teal-500' },
        { label: 'Analytics', angle: 120, color: 'from-yellow-500 to-orange-500' },
        { label: 'Integration', angle: 180, color: 'from-indigo-500 to-purple-500' },
        { label: 'Globalization', angle: 240, color: 'from-pink-500 to-rose-500' },
        { label: 'Compliance', angle: 300, color: 'from-orange-500 to-red-500' }
    ];

    const aiCapabilityList = [
        {
            title: 'Automated Workflows',
            description: 'Configure and optimize complex workflows across departments and geographies.',
            icon: Zap,
            color: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Enterprise Security',
            description: 'Full encryption, SSO, RBAC, data residency, and compliance with global standards.',
            icon: Shield,
            color: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Scalable Analytics',
            description: 'Real-time dashboards, predictive AI, and KPI monitoring at global scale.',
            icon: BarChart3,
            color: 'from-yellow-500 to-orange-500'
        },
        {
            title: 'Seamless Integration',
            description: 'Integrate with all major enterprise platforms, legacy systems, and custom APIs.',
            icon: Cpu,
            color: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Multilingual & Global Ready',
            description: 'AI agents that support 50+ languages, multiple time zones, and local policies.',
            icon: Globe,
            color: 'from-pink-500 to-rose-500'
        },
        {
            title: 'Compliance & Audit',
            description: 'Full audit trails, compliance logging, and reporting for enterprise governance.',
            icon: CheckCircle,
            color: 'from-orange-500 to-red-500'
        }
    ];
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Unlock enterprise automation, security, and analytics at global scale. <span className="text-white font-medium">Empower every department</span> with AI agents customized for your business and compliance needs.
                    </div>
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            ...
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">Enterprise AI Agent</h3>
                                        <div className="text-slate-400 text-sm flex items-center gap-2">
                                            <div className="w-2 h-2 bg-emerald-400 rounded-full animate-ping"></div>
                                            Live • High-Availability
                                        </div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4">
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-emerald-400">98.8%</div>
                                        <div className="text-xs text-slate-400">AI Accuracy</div>
                                    </div>
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-blue-400">99.999%</div>
                            ...
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3 animate-slideInLeft">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Can you automate our employee onboarding workflow across HR and IT?</span>
                                ...
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '0.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Onboarding workflow automation is ready. Would you like to trigger a test run or customize approval steps?</span>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('how-it-works') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            AI that adapts to
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> your enterprise</span>
                        </h2>
                    </div>
                    <div className="relative">
            ...
            <section id="features" className="py-16 sm:py-24 lg:py-32 px-4 bg-gradient-to-br from-slate-900/50 to-slate-800/30">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            The best of
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> enterprise AI</span>
                        </h2>
                    </div>
            ...
            <section id="channels" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('channels') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Connect to your
                            <span className="bg-gradient-to-r from-blue-400 to-cyan-600 bg-clip-text text-transparent"> global ecosystem</span>
                        </h2>
                    </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('benefits') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> intelligent automation</span>
                        </h2>
                    </div>
            ...
            <section id="capabilities" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Enterprise AI that
                            <span className="bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent"> scales globally</span>
                        </h2>
                    </div>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className={`space-y-8 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
                            {aiCapabilityList.map((capability, index) => {
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Discover how the Enterprise AI Agent Solution can revolutionize your organization. Schedule a personalized demo or connect with our AI enterprise specialists today.
                        </p>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-8 border-t border-slate-700/50">
                            {[
                                { label: 'Enterprise Ready', value: 'SOC 2, ISO 27001' },
                                { label: 'Setup Time', value: '< 4 Days' },
                                { label: 'Customizable', value: 'Flexible Workflows' },
