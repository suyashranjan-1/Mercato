...
import {BarChart3, Star, CheckCircle, Zap, Cpu, Users, ArrowRight, 
    Bot, Globe, Play, ChevronRight, Brain, Database, Settings, Phone, Mail, 
    Smartphone, MessageCircle, Shield} from 'lucide-react';
...
export default function SalesAnalyticsAIAgent() {
    ...
    const features = [
        ...
        },
        {
            ...
            description: 'Generate and schedule in-depth sales reports—no spreadsheets, no manual work.',
            icon: Database,
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Unlock your sales data’s full potential. <span className="text-white font-medium">AI-powered analytics and forecasting</span> help you optimize pipeline, boost win rates, and grow revenue—on every device.
                    </div>
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Get instant value with guided onboarding, expert support, and real-time AI analytics. Connect your data and unlock next-level sales performance—today.
                        </p>
