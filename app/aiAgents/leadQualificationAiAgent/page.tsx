...
import { UserCheck, UserPlus, Filter, BarChart3, MessageCircle, Phone, Mail, Database, Bot, Star, Zap, Cpu, Brain, Globe, Settings, Play, ArrowRight, ChevronRight, Shield, Smartphone, Users, CheckCircle, Clock, TrendingUp } from 'lucide-react';
import { NavbarDemo } from "@/components/navbar";
import Footer from "@/components/Footer";
import Link from 'next/link';

export default function LeadQualificationAIAgent() {
    ...
    // Stats for lead qualification
    const stats = [
        { label: 'Avg Lead Response', value: '2m', icon: Clock, color: 'from-blue-500 to-cyan-500' },
        { label: 'Qualification Accuracy', value: '95%', icon: CheckCircle, color: 'from-green-500 to-emerald-500' },
        { label: 'Conversion Increase', value: '34%', icon: TrendingUp, color: 'from-purple-500 to-pink-500' },
        { label: 'Time Saved', value: '80%', icon: Zap, color: 'from-yellow-500 to-orange-500' },
    ];

    // Features for lead qualification
    const features = [
        {
            title: 'Instant Lead Scoring',
            description: 'AI analyzes and scores new leads based on multiple qualification criteria in real-time.',
            icon: Filter,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Automated Follow-Ups',
            description: 'Schedules and sends personalized follow-ups across all communication channels.',
            icon: MessageCircle,
            gradient: 'from-purple-500 to-pink-500'
        },
        {
            title: 'CRM Integration',
            description: 'Syncs with major CRM platforms for seamless lead management and tracking.',
            icon: Database,
            gradient: 'from-green-500 to-emerald-500'
        },
        {
            title: 'Multi-Channel Outreach',
            description: 'Qualify leads via chat, email, phone, and SMS automatically with unified data.',
            icon: Globe,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: 'Conversational Intelligence',
            description: 'Understands intent and sentiment to personalize qualification conversations.',
            icon: Brain,
            gradient: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Lead Routing',
            description: 'Automatically assigns hot leads to the right sales reps with detailed context.',
            icon: Users,
            gradient: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Compliance & Security',
            description: 'GDPR-ready and SOC 2 compliant to keep your lead data safe and confidential.',
            icon: Shield,
            gradient: 'from-yellow-500 to-orange-500'
        },
        {
            title: 'Analytics Dashboard',
            description: 'Get real-time insights into lead sources, engagement, and conversion funnels.',
            icon: BarChart3,
            gradient: 'from-cyan-500 to-blue-500'
        },
    ];

    // How it works for lead qualification
    const howItWorks = [
        {
            step: 1,
            title: 'Lead Capture',
            description: 'Leads flow in from website forms, ads, emails, or uploads, captured instantly.',
            icon: UserPlus,
        ...
        },
        {
            ...
            description: 'AI evaluates each lead using company data, engagement history, and qualification rules.',
            icon: Cpu,
        ...
        },
        {
            ...
            description: 'AI sends relevant messages, asks qualifying questions, and records responses.',
            icon: MessageCircle,
        ...
        },
        {
            step: 4,
            title: 'Lead Handover',
            description: 'Qualified leads are routed to sales with full conversation and score details.',
            icon: UserCheck,
            color: 'from-orange-500 to-red-500'
        }
    ];

    // Integrations for lead qualification
    const integrations = [
        ...
        { name: 'Google Sheets', category: 'Data', logo: '🗃️' },
        { name: 'Microsoft Teams', category: 'Collaboration', logo: '👥' },
        { name: 'Zendesk', category: 'Support', logo: '🎫' },
        { name: 'Marketo', category: 'Automation', logo: '⚡' },
        { name: 'Facebook Lead Ads', category: 'Ads', logo: '📢' },
        { name: 'LinkedIn Lead Gen', category: 'Ads', logo: '🔗' },
        { name: 'Freshsales', category: 'CRM', logo: '🌱' },
        { name: 'Copper', category: 'CRM', logo: '🥇' },
    ];

    // Communication channels for lead engagement
    const channels = [
        { name: 'Live Chat', icon: MessageCircle, description: 'Engage leads instantly on your website' },
        { name: 'Email Outreach', icon: Mail, description: 'Automate qualification emails' },
        { name: 'Phone Calls', icon: Phone, description: 'Qualify leads with AI-powered calls' },
        { name: 'Mobile App', icon: Smartphone, description: 'Manage and qualify leads on-the-go' },
    ];

    // Benefits for lead qualification
    const benefits = [
        {
            title: 'Faster Lead Response',
            description: 'Engage every lead within minutes, increasing conversion rates.',
            percentage: '7x',
            metric: 'faster response'
        },
        {
            title: 'Higher Pipeline Quality',
            description: 'Prioritize leads that match your ICP and are ready to buy.',
            percentage: '52%',
            metric: 'more qualified leads'
        },
        {
            title: 'Reduce Manual Work',
            description: 'Automate repetitive qualification and follow-up tasks.',
            percentage: '80%',
            metric: 'less manual effort'
        },
        {
            title: 'Boost Sales Productivity',
            description: 'Let your sales team focus on closing, not chasing unqualified leads.',
            percentage: '32%',
            metric: 'boost in productivity'
        },
        {
            title: 'Consistent Lead Experience',
            description: 'Every lead gets the right questions and engagement, every time.',
            percentage: '100%',
            metric: 'consistency'
        }
    ];
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Accelerate your sales pipeline with AI that qualifies, scores, and routes leads instantly. Engage, qualify, and hand over high-intent prospects 24/7 across all channels.
                    </div>
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            ...
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">Lead Qualification AI Agent</h3>
                                        <div className="text-slate-400 text-sm flex items-center gap-2">
                                            <div className="w-2 h-2 bg-emerald-400 rounded-full animate-ping"></div>
                                            Online • Qualifying leads now
                                        </div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4">
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-blue-400">95%</div>
                                        <div className="text-xs text-slate-400">Qualification Accuracy</div>
                                    </div>
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-purple-400">2m</div>
                            ...
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3 animate-slideInLeft">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Hi, I’m interested in your SaaS demo. Can you tell me more about pricing and integrations?</span>
                                        <span className="text-xs text-slate-400 mt-1 block">12:05 PM</span>
                                    </div>
                                </div>
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '0.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Thanks for reaching out! Can you share your company size and main use case, so I can match the right plan and integration options?</span>
                                        <span className="text-xs text-blue-100 mt-1 block">12:05 PM</span>
                                    </div>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">We’re a team of 30, mainly looking for CRM integration and workflow automation.</span>
                                        <span className="text-xs text-slate-400 mt-1 block">12:06 PM</span>
                                    </div>
                                </div>
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '1.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Perfect – you qualify for our Growth plan. Would you like to schedule a call with our sales team?</span>
                                        <span className="text-xs text-blue-100 mt-1 block">12:06 PM</span>
                                    </div>
                                    <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center">
                                        <Bot className="w-4 h-4 text-white" />
                                    </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('how-it-works') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            From first touch
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> to qualified lead</span>
                        </h2>
                    </div>
                    <div className="relative">
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> smart lead qualification</span>
                        </h2>
                    </div>
            ...
            <section id="channels" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('channels') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Reach and qualify leads
                            <span className="bg-gradient-to-r from-blue-400 to-cyan-600 bg-clip-text text-transparent"> wherever they are</span>
                        </h2>
                    </div>
            ...
            <section id="capabilities" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Advanced AI for smarter
                            <span className="bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent"> lead qualification</span>
                        </h2>
                    </div>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className={`relative transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
                            <div className="relative">
                                ...
                                <div className="relative w-80 h-80 mx-auto">
                                    ...
                                    {[
                                        { label: 'Lead Scoring', angle: 0, color: 'from-blue-500 to-cyan-500' },
                                        { label: 'Intent', angle: 60, color: 'from-emerald-500 to-teal-500' },
                        ...
                        <div className={`space-y-8 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
                            {[
                                {
                                    title: 'Multi-Factor Lead Scoring',
                                    description: 'Scores leads using firmographics, behavior, and engagement in real time.',
                                    icon: Filter,
                                    color: 'from-blue-500 to-cyan-500'
                                },
                                {
                                    title: 'Intent Detection',
                                    description: 'Understands buying signals and urgency through conversation and form data.',
                                    icon: Brain,
                                    color: 'from-purple-500 to-pink-500'
                                },
                                {
                                    title: 'Automated Outreach',
                                    description: 'Personalizes and automates email, SMS, and chat follow-ups.',
                                    icon: Zap,
                                    color: 'from-emerald-500 to-teal-500'
                                },
                                {
                                    title: 'Real-Time Analytics',
                                    description: 'Get instant insights on lead quality, source performance, and pipeline velocity.',
                                    icon: BarChart3,
                                    color: 'from-orange-500 to-red-500'
                                },
                                {
                                    title: 'Enterprise Security',
                                    description: 'SOC 2, GDPR, and CCPA compliant for safe lead handling.',
                                    icon: Shield,
                                    color: 'from-indigo-500 to-purple-500'
                                },
                                {
                                    title: 'Plug-and-Play Integrations',
                                    description: 'Works seamlessly with CRM, marketing, and sales platforms.',
                                    icon: Database,
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Join top sales teams using AI to boost qualified pipeline and eliminate manual lead chasing. Deploy your agent in minutes and never miss a hot lead again.
                        </p>
                        {/* Trust Indicators */}
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-8 border-t border-slate-700/50">
                            {[
                                ...
                                { label: 'CRM Integrations', value: '10+ Supported' },
