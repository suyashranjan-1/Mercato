...
import { FileText, Clock, Users, Star, CheckCircle, ArrowRight, Bot, Shield, Zap, BarChart3, Globe, Play, ChevronRight, Brain, Cpu, Database, Settings, Mail, MessageSquare, Smartphone, FolderOpen, Search, Briefcase, CreditCard } from 'lucide-react';
import { NavbarDemo } from "@/components/navbar";
import Footer from "@/components/Footer";

export default function InsuranceClaimsAIAgent() {
    ...
    const stats = [
        { label: 'Avg Claim Processing', value: '<3m', icon: Clock, color: 'from-blue-500 to-cyan-500' },
        { label: 'Claims Resolved', value: '200k+', icon: CheckCircle, color: 'from-yellow-500 to-orange-500' },
        { label: 'Detection Accuracy', value: '99.2%', icon: Star, color: 'from-emerald-500 to-teal-500' },
        { label: 'Fraud Prevention', value: '98%', icon: Shield, color: 'from-purple-500 to-pink-500' },
    ];

    const features = [
        {
            title: 'Instant Claim Filing',
            description: 'Intuitive form-driven claim submission, supporting document/photo uploads and automated data capture.',
            icon: FileText,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Automated Document Review',
            description: 'AI extracts data from forms, receipts, and photos to speed up claim verification and reduce manual effort.',
            icon: Search,
            gradient: 'from-purple-500 to-pink-500'
        },
        {
            title: 'Smart Fraud Detection',
            description: 'Advanced algorithms flag suspicious activity, duplicate claims, and anomalous patterns in real-time.',
            icon: Shield,
            gradient: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Seamless Omnichannel Support',
            description: 'Accept claims via web, mobile, email, or API, with real-time status updates to claimants.',
            icon: Globe,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: 'Automated Communication',
            description: 'AI sends updates, requests additional info, and resolves common questions via chat or email.',
            icon: MessageSquare,
            gradient: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Claims Analytics Dashboard',
            description: 'Visualize claim volumes, approval rates, processing times, and fraud metrics in real-time.',
            icon: BarChart3,
            gradient: 'from-pink-500 to-rose-500'
        },
        {
            title: 'Regulatory Compliance',
            description: 'Ensures every claim is processed according to insurance, privacy, and regional regulations.',
            icon: Briefcase,
            gradient: 'from-rose-500 to-pink-500'
        },
        {
            title: 'Automated Payouts',
            description: 'Integrates with payment providers for direct, secure, and timely settlement of approved claims.',
            icon: CreditCard,
    ...
    const howItWorks = [
        {
            ...
            description: 'Customer files a claim with supporting details and documents via preferred channel.',
            icon: MessageSquare,
            color: 'from-blue-500 to-cyan-500'
        },
        {
            step: 2,
            title: 'AI Review & Triage',
            description: 'AI reviews the submission, extracts data, checks for completeness, and detects anomalies.',
            icon: Brain,
        ...
        },
        {
            ...
            description: 'Claim is validated via data sources, policy rules, and fraud detection. Automated or human review as needed.',
            icon: CheckCircle,
        ...
        },
        {
            ...
            description: 'Claimant is notified of decision, and approved claims are paid out directly and securely.',
            icon: CreditCard,
    ...
    const integrations = [
        { name: 'Guidewire', category: 'Claims Mgmt', logo: '🛡️' },
        { name: 'Duck Creek', category: 'Insurance Suite', logo: '🦆' },
        ...
        { name: 'DocuSign', category: 'eSignatures', logo: '✍️' },
        ...
        { name: 'Workday', category: 'HR/Payroll', logo: '💼' },
    ];

    const channels = [
        { name: 'Web Portal', icon: Smartphone, description: 'Easy-to-use online claim submission and tracking.' },
        { name: 'Email/Fax', icon: Mail, description: 'Accept claims and docs via secure email or digital fax.' },
        { name: 'Mobile App', icon: Smartphone, description: 'File, check, and update claims on the go.' },
        { name: 'API', icon: Cpu, description: 'Integrate automated claim intake into your existing systems.' }
    ];

    const benefits = [
        {
            title: 'Accelerate Claims Processing',
            description: 'Reduce claim cycle times from weeks to minutes with AI triage and automation.',
            percentage: '20x',
            metric: 'faster resolutions'
        },
        {
            title: 'Minimize Fraud Losses',
            description: 'Advanced detection stops fraudulent payouts and reduces investigative workload.',
            percentage: '92%',
            metric: 'fraud reduction'
        },
        {
            title: 'Boost Customer Satisfaction',
            description: 'Delight customers with transparent, real-time claim updates and instant payouts.',
            percentage: '4.7★',
            metric: 'user rating'
        },
        {
            title: 'Cut Operational Costs',
            description: 'Reduce manual reviews, paperwork, and errors with fully digital workflows.',
            percentage: '50%',
            metric: 'cost reduction'
        },
        {
            title: 'Regulatory Confidence',
            description: 'Automated audit trails and compliance safeguards for every claim.',
            percentage: '100%',
            metric: 'compliance'
        }
    ];
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Automate and accelerate insurance claims processing with AI. File, review, and settle claims faster, with confidence and compliance.
                    </div>
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">Insurance Claims AI Agent</h3>
                                ...
                                <div className="flex items-center gap-4">
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-emerald-400">&lt;3m</div>
                                        <div className="text-xs text-slate-400">Avg Processing</div>
                                    </div>
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-blue-400">99.2%</div>
                            ...
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3 animate-slideInLeft">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">My car was damaged in a storm. Can I file a claim and upload photos?</span>
                                        <span className="text-xs text-slate-400 mt-1 block">12:41 PM</span>
                                    </div>
                                </div>
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '0.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Absolutely! Please upload photos and a short description. I’ll review the claim details and update you within minutes.</span>
                                        <span className="text-xs text-blue-100 mt-1 block">12:41 PM</span>
                                    </div>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Do I need to submit a police report for storm damage?</span>
                                        <span className="text-xs text-slate-400 mt-1 block">12:42 PM</span>
                                    </div>
                                </div>
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    <div className="w-8 h-8 bg-slate-700 rounded-full flex items-center justify-center">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">No, police reports are not required for weather-related claims. Please provide a brief statement of events.</span>
                                        <span className="text-xs text-slate-400 mt-1 block">12:42 PM</span>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('how-it-works') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Settle claims in
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> record time</span>
                        </h2>
                    </div>
                    <div className="relative">
            ...
            <section id="features" className="py-16 sm:py-24 lg:py-32 px-4 bg-gradient-to-br from-slate-900/50 to-slate-800/30">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Power your claims process with
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> advanced AI</span>
                        </h2>
                    </div>
            ...
            <section id="channels" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('channels') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Seamlessly connect claims
                            <span className="bg-gradient-to-r from-blue-400 to-cyan-600 bg-clip-text text-transparent"> across your ecosystem</span>
                        </h2>
                    </div>
            ...
            <section id="capabilities" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Next-generation claims intelligence
                            ...
                            <div className="relative">
                                <div className="relative w-80 h-80 mx-auto">
                                    ...
                                    {[
                                        ...
                                        { label: 'Payouts', angle: 120, color: 'from-orange-500 to-red-500' },
                                        { label: 'Compliance', angle: 180, color: 'from-purple-500 to-pink-500' },
                                        { label: 'Omnichannel', angle: 240, color: 'from-yellow-500 to-orange-500' },
                            ...
                            {[
                                {
                                    ...
                                    description: 'AI prioritizes and routes claims to the right workflow, reducing manual review.',
                                    icon: Cpu,
                                    color: 'from-blue-500 to-cyan-500'
                                },
                                {
                                    title: 'Fraud and Anomaly Detection',
                                    description: 'Real-time detection of suspicious activity, false claims, and duplicate submissions.',
                                    icon: Shield,
                                    color: 'from-purple-500 to-pink-500'
                                },
                                {
                                    title: 'Automated Payouts',
                                    description: 'Integrates with payment systems for instant, secure settlements.',
                                    icon: CreditCard,
                                    color: 'from-emerald-500 to-teal-500'
                                },
                                {
                                    title: 'End-to-End Compliance',
                                    description: 'Built-in rules, audit trails, and privacy safeguards for regulatory confidence.',
                                    icon: Briefcase,
                                    color: 'from-orange-500 to-red-500'
                                },
                                {
                                    title: 'Omnichannel Communication',
                                    description: 'Claimants receive instant updates and can interact via web, email, app, or chat.',
                                    icon: MessageSquare,
                                    color: 'from-indigo-500 to-purple-500'
                                },
                                {
                                    title: 'Claims Analytics',
                                    description: 'Track KPIs, volumes, and trends to optimize your claims process.',
                                    icon: BarChart3,
            ...
            <section id="cta" className="py-16 sm:py-24 lg:py-32 px-4 bg-gradient-to-br from-slate-900/50 to-slate-800/30">
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        <div className="inline-flex items-center px-4 sm:px-6 py-2 mb-6 sm:mb-8 rounded-full border border-slate-700/50 bg-slate-800/30 backdrop-blur-sm text-xs sm:text-sm text-slate-300">
                            <Zap className="w-4 h-4 mr-2 text-emerald-400" />
                            Ready to streamline claims?
                        </div>
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 sm:mb-8 leading-tight">
                            Deliver faster, fairer settlements
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> with AI</span>
                        </h2>
                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Join insurers and TPAs using AI to accelerate claim cycles, reduce fraud, and boost customer satisfaction. Get started today—no hidden fees or credit card required.
                        </p>
