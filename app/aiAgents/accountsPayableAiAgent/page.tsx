...
export default function AccountsPayableAIAgent() {
    ...
    // --- DATA for AccountsPayableAIAgent ---

    const stats = [
        { label: 'Avg Invoice Approval', value: '<2h', icon: Clock, color: 'from-blue-500 to-cyan-500' },
        { label: 'Policy Compliance', value: '99.7%', icon: CheckCircle, color: 'from-emerald-500 to-teal-500' },
        { label: 'Fraudulent Payment Reduction', value: '-78%', icon: Shield, color: 'from-orange-500 to-red-500' },
    ...
    const howItWorks = [
        {
            ...
            description: 'Vendors submit invoices via email, portal, or upload. AI captures and validates all data.',
            icon: MessageCircle,
            color: 'from-blue-500 to-cyan-500'
        },
        {
            step: 2,
            title: 'PO Match & Policy Check',
            description: 'AI matches invoices to POs/receipts and flags duplicates, errors, or fraud.',
            icon: Cpu,
        ...
        },
        {
            ...
            description: 'Invoices are routed, reviewed, and approved instantly—then paid automatically.',
            icon: CheckCircle,
        ...
        },
        {
            ...
            description: 'Real-time visibility into AP status, cash flow, and compliance for finance teams.',
            icon: BarChart3,
    ...
    const integrations = [
        ...
        { name: 'Bank of America', category: 'Bank', logo: '🏦' },
        { name: 'Chase', category: 'Bank', logo: '🏦' },
        { name: 'HSBC', category: 'Bank', logo: '🏦' },
    ...
    const channels = [
        { name: 'Web Portal', icon: Globe, description: 'Submit and approve invoices online' },
        { name: 'Mobile App', icon: Smartphone, description: 'Manage AP from your phone or tablet' },
        { name: 'Email Processing', icon: Mail, description: 'Forward invoices for instant AI capture' },
        { name: 'Chat Integration', icon: MessageCircle, description: 'Approve and track AP in Slack/Teams' }
    ];

    const benefits = [
        {
            title: 'Accelerate Invoice Processing',
            description: 'Reduce approval time with touchless workflows and smart routing.',
            percentage: '-68%',
            metric: 'processing time'
        },
        {
            title: 'Slash Fraud & Duplicate Payments',
            description: 'AI flags issues before they reach payment, protecting your bottom line.',
            percentage: '-78%',
            metric: 'fraud rate'
        },
        {
            title: 'Boost Compliance',
            description: 'Automated checks ensure every invoice meets company and regulatory policies.',
            percentage: '99.7%',
            metric: 'compliance'
        },
        {
            title: 'Enhance Cash Flow',
            description: 'Real-time visibility and early payment discounts optimize working capital.',
            percentage: '+22%',
            metric: 'cash flow'
        },
        {
            title: 'Empower Finance Teams',
            description: 'Free up time for analysis and strategy—not manual AP.',
            percentage: '+4.3x',
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Automate, secure, and accelerate your invoice-to-pay process with <span className="text-white font-medium">AI-powered accounts payable</span>. Improve compliance, reduce fraud, and free your finance team from manual work—on any device.
                    </div>
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            ...
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">Accounts Payable AI Agent</h3>
                                        <div className="text-slate-400 text-sm flex items-center gap-2">
                                            <div className="w-2 h-2 bg-emerald-400 rounded-full animate-ping"></div>
                                            Online • Processing invoices
                                        </div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4">
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-emerald-400">99.7%</div>
                                        <div className="text-xs text-slate-400">Compliance</div>
                                    </div>
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-blue-400">&lt;2h</div>
                            ...
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3 animate-slideInLeft">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">I just uploaded an invoice from ABC Supplies for $2,100. Is it approved and ready to pay?</span>
                                ...
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '0.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Invoice matched to PO-402. No policy violations detected. Routed for approval—expected payout in next cycle.</span>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Can you show me outstanding payables by vendor for this month?</span>
                                ...
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '1.2s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Here’s a breakdown of payables by vendor, due dates, and early payment discount opportunities. Export or drill down for more detail.</span>
                                        <span className="text-xs text-blue-100 mt-1 block">3:13 PM</span>
                                    </div>
                                    <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center">
                                        <Bot className="w-4 h-4 text-white" />
                                    </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> next-gen AP</span>
                        </h2>
                    </div>
            ...
            <section id="benefits" className="py-16 sm:py-24 lg:py-32 px-4 bg-gradient-to-br from-slate-900/50 to-slate-800/30">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('benefits') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Transform payables with
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> AI automation</span>
                        </h2>
                    </div>
            ...
            <section id="capabilities" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            AI for every invoice and payment
                            <span className="bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent"> at any scale</span>
                        </h2>
                    </div>
                            ...
                            <div className="relative">
                                <div className="relative w-80 h-80 mx-auto">
                                    ...
                                    {[
                                        ...
                                        { label: 'Match', angle: 120, color: 'from-orange-500 to-red-500' },
                            ...
                            {[
                                {
                                    ...
                                    description: 'AI checks every invoice and payment against your AP rules and compliance.',
                                    icon: Settings,
                                    color: 'from-blue-500 to-cyan-500'
                                },
                                {
                                    title: 'Fraud & Duplicate Detection',
                                    description: 'Flags anomalies, outliers, and duplicate invoices before payment.',
                                    icon: Shield,
                                    color: 'from-purple-500 to-pink-500'
                                },
                                {
                                    title: 'PO & Receipt Matching',
                                    description: 'Ensures every invoice is matched to POs/receipts for accuracy.',
                                    icon: Cpu,
                                    color: 'from-emerald-500 to-teal-500'
                                },
                                {
                                    title: 'Analytics & Reporting',
                                    description: 'Dashboards for spend, DPO, compliance, and early payment discounts.',
                                    icon: BarChart3,
                                    color: 'from-orange-500 to-red-500'
                                },
                                {
                                    title: 'ERP & Bank Integrations',
                                    description: 'Connects to your ERP, payment, and analytics stack.',
                                    icon: Database,
                                    color: 'from-yellow-500 to-orange-500'
                                },
                                {
                                    title: 'Mobile-First Experience',
                                    description: 'Approve, pay, and track AP from any device.',
                                    icon: Smartphone,
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 sm:mb-8 leading-tight">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> with AI accounts payable</span>
                        </h2>

                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Get started with guided onboarding, instant ERP/bank integration, and 24/7 AP expert support. Automate payables, boost compliance, and control cash flow—today.
                        </p>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-8 border-t border-slate-700/50">
                            {[
                                ...
                                { label: 'ERP/Bank Integration', value: 'Plug & Play' },
