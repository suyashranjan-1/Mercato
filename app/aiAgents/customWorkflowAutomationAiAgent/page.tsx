...
import { MessageCircle, Clock, Users, Star, CheckCircle, ArrowRight, Bot, Shield, Zap, BarChart3, Globe, Play, ChevronRight, Brain, Cpu, Database, Settings, Mail, Smartphone } from 'lucide-react';
import { NavbarDemo } from "@/components/navbar";
import Footer from "@/components/Footer";
import Link from 'next/link';

export default function CustomWorkflowAutomationAIAgent() {
    ...
    const stats = [
        { label: 'Processes Automated', value: '90%', icon: Zap, color: 'from-blue-500 to-cyan-500' },
        { label: 'Avg Time Saved', value: '5h/day', icon: Clock, color: 'from-emerald-500 to-teal-500' },
        { label: 'Error Reduction', value: '99%', icon: CheckCircle, color: 'from-yellow-500 to-orange-500' },
        { label: 'Workflow Uptime', value: '99.99%', icon: Star, color: 'from-pink-500 to-rose-500' },
    ];

    const features = [
        {
            title: 'No-Code Workflow Builder',
            description: 'Design and launch automated workflows using a visual drag-and-drop builder—no coding required.',
            icon: Settings,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Intelligent Task Routing',
            description: 'AI automatically assigns, escalates, and routes tasks based on priority and context.',
            icon: Users,
            gradient: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Multi-App Integration',
            description: 'Connect to 300+ apps and platforms—CRM, ERP, Slack, email, databases, and more.',
            icon: Cpu,
            gradient: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Real-Time Monitoring',
            description: 'Track workflow status, bottlenecks, and performance with live dashboards.',
            icon: BarChart3,
            gradient: 'from-yellow-500 to-orange-500'
        },
        {
            title: 'Automated Notifications',
            description: 'Send automated alerts, reminders, and status updates through email, SMS, and chat.',
            icon: Mail,
            gradient: 'from-pink-500 to-rose-500'
        },
        {
            title: 'Conditional Logic & Branching',
            description: 'Build smart flows with if/else logic, triggers, and dynamic paths.',
            icon: Brain,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: 'Enterprise Security',
            description: 'SOC 2, GDPR, SSO, RBAC, and full audit logs to keep your workflows secure.',
            icon: Shield,
            gradient: 'from-green-500 to-blue-500'
        },
        {
            title: 'Human-in-the-Loop',
            description: 'Insert approvals and manual checkpoints for critical steps in your automations.',
            icon: Users,
    ...
    const howItWorks = [
        {
            step: 1,
            title: 'Connect & Map',
            description: 'Link your apps and map your process with a visual workflow designer.',
            icon: Globe,
        ...
        },
        {
            ...
            description: 'Set triggers, conditions, and AI-based routing to automate decision-making.',
            icon: Brain,
        ...
        },
        {
            ...
            description: 'Launch your workflow and monitor progress, status, and results in real time.',
            icon: Zap,
        ...
        },
        {
            ...
            description: 'Gather analytics and feedback, then tweak flows for maximum efficiency.',
            icon: BarChart3,
    ...
    const channels = [
        { name: 'Web Portal', icon: Globe, description: 'Design and monitor workflows from any browser' },
        { name: 'API Access', icon: Settings, description: 'Integrate and trigger automations programmatically' },
        { name: 'Email Actions', icon: Mail, description: 'Approve or reject tasks directly from your inbox' },
        { name: 'Mobile App', icon: Smartphone, description: 'Manage workflows and get notifications on the go' }
    ];

    const benefits = [
        {
            title: 'Slash Manual Work',
            description: 'Eliminate repetitive tasks and free up your team for strategic projects.',
            percentage: '90%',
            metric: 'manual reduction'
        },
        {
            title: 'Accelerate Approvals',
            description: 'Speed up review cycles and decision-making with automated routing and nudges.',
            percentage: '6x',
            metric: 'faster approvals'
        },
        {
            title: 'Reduce Errors',
            description: 'Minimize costly mistakes by automating handoffs and enforcing logic.',
            percentage: '99%',
            metric: 'error reduction'
        },
        {
            title: 'Boost Visibility',
            description: 'Track every step, status, and metric in real time for full process transparency.',
            percentage: '100%',
            metric: 'visibility'
        },
        {
            title: 'Scale Operations',
            description: 'Handle unlimited workflows and processes as your business grows.',
            percentage: '∞',
            metric: 'scalability'
        }
    ];
    ...
    const capabilities = [
        ...
        { label: 'Integration', angle: 60, color: 'from-indigo-500 to-purple-500' },
        { label: 'Logic', angle: 120, color: 'from-orange-500 to-red-500' },
        { label: 'Analytics', angle: 180, color: 'from-yellow-500 to-orange-500' },
        { label: 'Security', angle: 240, color: 'from-green-500 to-blue-500' },
        { label: 'Human-in-Loop', angle: 300, color: 'from-emerald-500 to-teal-500' }
    ];

    const capabilityList = [
        {
            title: 'Automated Task Routing',
            description: 'AI directs tasks to the right team or stakeholder instantly.',
            icon: Users,
            color: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Deep Integrations',
            description: 'Connect and sync data across all your business apps.',
            icon: Cpu,
            color: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Smart Logic & Branching',
            description: 'Use AI-driven conditions and branching for dynamic workflows.',
            icon: Brain,
            color: 'from-orange-500 to-red-500'
        },
        {
            title: 'Actionable Analytics',
            description: 'Analyze bottlenecks, optimize flows, and drive process improvement.',
            icon: BarChart3,
            color: 'from-yellow-500 to-orange-500'
        },
        {
            title: 'Enterprise-Grade Security',
            description: 'All automations are safe, compliant, and fully auditable.',
            icon: Shield,
            color: 'from-green-500 to-blue-500'
        },
        {
            title: 'Human-in-the-Loop',
            description: 'Insert approvals and manual tasks where needed for compliance or oversight.',
            icon: Users,
            color: 'from-emerald-500 to-teal-500'
        }
    ];
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    <div className="inline-flex items-center px-4 sm:px-6 py-2 mb-6 sm:mb-8 rounded-full border border-slate-700/50 bg-slate-800/30 backdrop-blur-sm text-xs sm:text-sm text-slate-300 hover:border-slate-600/50 transition-all duration-300">
                        ...
                        Custom Workflow Automation AI Agent
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Build, automate, and monitor your business processes with intelligent workflow automation. <span className="text-white font-medium">Streamline operations, save time, and eliminate errors</span>—all in one platform.
                    </div>
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            ...
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">Workflow AI Agent</h3>
                                        <div className="text-slate-400 text-sm flex items-center gap-2">
                                            <div className="w-2 h-2 bg-emerald-400 rounded-full animate-ping"></div>
                                            Online • Automating Processes
                                        </div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-blue-400">90%</div>
                            ...
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3 animate-slideInLeft">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Can you set up an automated onboarding workflow for new hires?</span>
                                        <span className="text-xs text-slate-400 mt-1 block">8:45 AM</span>
                                    </div>
                                </div>
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '0.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Onboarding workflow is ready. Would you like to include IT approvals and welcome emails?</span>
                                        <span className="text-xs text-blue-100 mt-1 block">8:45 AM</span>
                                    </div>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Yes, add IT approvals and set reminders for day one tasks.</span>
                                        <span className="text-xs text-slate-400 mt-1 block">8:46 AM</span>
                                    </div>
                                </div>
                            </div>
                            {/* Typing Indicator */}
                            <div className="flex gap-3 justify-end">
                                <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 rounded-2xl p-3 border border-blue-500/30">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-xs text-blue-300">AI is building workflow...</span>
                                    </div>
                                </div>
                                <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center">
                                    <Bot className="w-4 h-4 text-white" />
            ...
            <section id="features" className="py-16 sm:py-24 lg:py-32 px-4 bg-gradient-to-br from-slate-900/50 to-slate-800/30">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            All you need for
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> automation at scale</span>
                        </h2>
                    </div>
            ...
            <section id="channels" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('channels') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Automate across your
                            <span className="bg-gradient-to-r from-blue-400 to-cyan-600 bg-clip-text text-transparent"> connected apps</span>
                        </h2>
                    </div>
            ...
            <section id="benefits" className="py-16 sm:py-24 lg:py-32 px-4 bg-gradient-to-br from-slate-900/50 to-slate-800/30">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('benefits') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Automate. Analyze.
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> Accelerate</span>
                        </h2>
                    </div>
            ...
            <section id="capabilities" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Next-gen AI for
                            <span className="bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent"> workflow automation</span>
                        </h2>
                    </div>
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 sm:mb-8 leading-tight">
                            Start building
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> custom workflows</span>
                        </h2>
                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Book a personalized demo and see how Workflow Automation AI Agents can transform your operations. Automate anything, optimize everything.
                        </p>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-8 border-t border-slate-700/50">
                            {[
                                ...
                                { label: 'Flexibility', value: 'No-Code/Low-Code' },
                                { label: 'Support', value: 'Workflow Experts' }
                            ].map((item, index) => (
