...
export default function InventoryForecastingAIAgent() {
    ...
    // Stats for Inventory Forecasting AI Agent
    const stats = [
        { label: 'Forecast Accuracy', value: '98.6%', icon: Star, color: 'from-blue-500 to-cyan-500' },
        { label: 'SKU Coverage', value: '10K+', icon: Database, color: 'from-yellow-500 to-orange-500' },
        { label: 'Reduction in Stockouts', value: '85%', icon: CheckCircle, color: 'from-emerald-500 to-teal-500' },
        { label: 'System Uptime', value: '99.99%', icon: Zap, color: 'from-purple-500 to-pink-500' },
    ];

    // Features for Inventory Forecasting AI Agent
    const features = [
        {
            title: 'AI-Driven Forecasting',
            description: 'Leverage deep learning and statistical models to predict inventory needs across all SKUs and locations.',
            icon: Brain,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Multi-Channel Demand Sensing',
            description: 'Integrate sales, weather, promotions, and supply chain data for hyper-accurate demand forecasts.',
            icon: Globe,
            gradient: 'from-purple-500 to-pink-500'
        },
        {
            title: 'Real-Time Inventory Visibility',
            description: 'Track inventory levels and movements live, across warehouses, stores, and suppliers.',
            icon: BarChart3,
            gradient: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Smart Replenishment Suggestions',
            description: 'Automate reorder points and get actionable restock recommendations to minimize stockouts and excess.',
            icon: Cpu,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: 'Scenario Planning',
            description: 'Run what-if simulations on price, lead time, and demand fluctuations to optimize inventory strategy.',
            icon: Settings,
            gradient: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Supplier Collaboration',
            description: 'Share forecasts and order plans directly with suppliers for streamlined procurement.',
            icon: Users,
            gradient: 'from-pink-500 to-rose-500'
        },
        {
            title: 'Automated Alerts',
            description: 'Receive instant notifications for low inventory, overstock risk, or supply chain disruptions.',
            icon: Mail,
            gradient: 'from-rose-500 to-pink-500'
        },
        {
            title: 'Seamless ERP Integration',
            description: 'Connect easily to SAP, Oracle, NetSuite, QuickBooks, and more for end-to-end automation.',
            icon: Database,
            gradient: 'from-amber-500 to-orange-500'
        }
    ];

    // How It Works for Inventory Forecasting AI Agent
    const howItWorks = [
        {
            step: 1,
            title: 'Connect Data Sources',
            description: 'Import sales, inventory, suppliers, and external data through ERP, POS, or spreadsheets.',
            icon: Database,
        ...
        },
        {
            ...
            description: 'AI analyzes trends, seasonality, and external signals to generate precise demand forecasts.',
            icon: Brain,
        ...
        },
        {
            ...
            description: 'Get reorder points, safety stock levels, and replenishment schedules tailored to your business.',
            icon: Cpu,
        ...
        },
        {
            ...
            description: 'Track performance, receive alerts, and fine-tune parameters as conditions change.',
            icon: BarChart3,
            color: 'from-orange-500 to-red-500'
        }
    ];

    // Integrations for Inventory Forecasting
    const integrations = [
        ...
        { name: 'Amazon Seller Central', category: 'Marketplace', logo: '🛒' },
        ...
        { name: 'EDI', category: 'Supply Chain', logo: '🔗' },
    ];

    // Channels for Inventory Forecasting
    const channels = [
        { name: 'Web Dashboard', icon: Globe, description: 'Centralized forecasting and inventory management' },
        { name: 'API Access', icon: Settings, description: 'Integrate forecasts and alerts into your business apps' },
        { name: 'Email Reports', icon: Mail, description: 'Get regular forecast and inventory reports in your inbox' },
        { name: 'Mobile App', icon: Smartphone, description: 'Manage inventory and view forecasts on the go' }
    ];

    // Benefits for Inventory Forecasting
    const benefits = [
        {
            title: 'Reduce Stockouts',
            description: 'Never miss a sale due to inventory gaps—automated forecasting reduces stockouts by up to 85%.',
            percentage: '85%',
            metric: 'stockout reduction'
        },
        {
            title: 'Cut Inventory Costs',
            description: 'Reduce excess inventory and carrying costs with precise, AI-driven recommendations.',
            percentage: '30%',
            metric: 'cost savings'
        },
        {
            title: 'Boost Service Levels',
            description: 'Meet customer demand reliably and improve fill rates with accurate forecasts.',
            percentage: '99%',
            metric: 'order fulfillment'
        },
        {
            title: 'Save Time',
            description: 'Automate manual planning and spend more time growing your business.',
            percentage: '90%',
            metric: 'manual effort saved'
        },
        {
            title: 'Improve Supplier Relations',
            description: 'Share plans and collaborate better with suppliers using real-time insights.',
            percentage: '5x',
            metric: 'supplier efficiency'
        }
    ];

    // Capabilities for Inventory Forecasting
    const capabilities = [
        {
            title: 'Deep Learning Forecasts',
            description: 'Advanced ML and deep learning models for SKU-level, multi-location inventory predictions.',
            icon: Brain,
            color: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Anomaly & Trend Detection',
            description: 'Identify seasonal spikes, outliers, and demand shifts instantly.',
            icon: BarChart3,
            color: 'from-purple-500 to-pink-500'
        },
        {
            title: 'Automated Replenishment',
            description: 'AI calculates optimal reorder points and generates purchase recommendations.',
            icon: Cpu,
            color: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Scenario & Simulation',
            description: 'Test “what-if” scenarios for lead time, price, and demand changes.',
            icon: Settings,
            color: 'from-orange-500 to-red-500'
        },
        {
            title: 'Real-Time Collaboration',
            description: 'Share plans and reports with teams and suppliers instantly.',
            icon: Users,
            color: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Comprehensive Reporting',
            description: 'Automated dashboards and alerts for inventory, demand, and forecast accuracy.',
            icon: Mail,
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Predict demand, optimize stock, and automate your supply chain with AI. Reduce costs, prevent stockouts, and always stay ahead of demand—across every channel and location.
                    </div>
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            ...
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">Inventory Forecasting AI Agent</h3>
                                        <div className="text-slate-400 text-sm flex items-center gap-2">
                                            <div className="w-2 h-2 bg-emerald-400 rounded-full animate-ping"></div>
                                            Online • Forecasting instantly
                                        </div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4">
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-emerald-400">98.6%</div>
                                        <div className="text-xs text-slate-400">Accuracy</div>
                                    </div>
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-blue-400">10K+</div>
                                        <div className="text-xs text-slate-400">SKU Coverage</div>
                                    </div>
                                </div>
                            </div>
                            {/* Chat Interface */}
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3 animate-slideInLeft">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">How many units of SKU123 will I need next month?</span>
                                ...
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '0.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Forecasted demand for SKU123 in June is 245 units. Suggested reorder date: May 29th.</span>
                                        <span className="text-xs text-blue-100 mt-1 block">10:07 AM</span>
                                    </div>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Alert me if inventory falls below 100 for any SKU.</span>
                                ...
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '1.2s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Alert set! You’ll receive instant notifications for low inventory items.</span>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> world-class inventory planning</span>
                        </h2>
                    </div>
            ...
            <section id="channels" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('channels') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Seamlessly connect across your
                            <span className="bg-gradient-to-r from-blue-400 to-cyan-600 bg-clip-text text-transparent"> supply chain</span>
                        </h2>
                    </div>
            ...
            <section id="capabilities" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Next-level inventory optimization with
                            ...
                            <div className="relative">
                                ...
                                <div className="relative w-80 h-80 mx-auto">
                                    ...
                                    {[
                                        ...
                                        { label: 'Alerts', angle: 180, color: 'from-purple-500 to-pink-500' },
                                        { label: 'ERP', angle: 240, color: 'from-yellow-500 to-orange-500' },
                                        { label: 'Report', angle: 300, color: 'from-indigo-500 to-purple-500' }
                                    ].map((node, index) => {
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Join retailers, manufacturers, and distributors using AI to eliminate guesswork and maximize inventory ROI. Try the Inventory Forecasting AI Agent free—get results in days, not months.
                        </p>
                        {/* Trust Indicators */}
