...
import { MessageCircle, Clock, Users, Star, CheckCircle, ArrowRight, Bot, Shield, Zap, BarChart3, Globe, Play, ChevronRight, Brain, Cpu, Database, Settings, Mail, MessageSquare, Smartphone, Slash } from 'lucide-react';
...
export default function CommentModerationAIAgent() {
    ...
    const stats = [
        { label: 'Moderation Speed', value: '<1s', icon: Clock, color: 'from-blue-500 to-cyan-500' },
        { label: 'Toxicity Detection', value: '99.5%', icon: Shield, color: 'from-yellow-500 to-orange-500' },
        { label: 'False Positive Rate', value: '<0.3%', icon: CheckCircle, color: 'from-emerald-500 to-teal-500' },
        { label: 'Languages Supported', value: '50+', icon: Globe, color: 'from-purple-500 to-pink-500' },
    ];

    const features = [
        {
            title: 'Real-Time Moderation',
            description: 'Scan and moderate thousands of comments per second across platforms, blocking spam, abuse, and hate speech instantly.',
            icon: Zap,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Toxicity & Hate Speech Detection',
            description: 'Advanced NLP detects offensive, harassing, or inappropriate comments with industry-leading accuracy.',
            icon: Shield,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: 'Custom Rule Engine',
            description: 'Create, edit, and manage keyword lists, thresholds, and escalation paths tailored to your community.',
            icon: Settings,
            gradient: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Automated Actions',
            description: 'Auto-hide, flag, or remove comments and ban repeat offenders with no manual intervention.',
            icon: Slash,
            gradient: 'from-pink-500 to-rose-500'
        },
        {
            title: 'Multi-Language Support',
            description: 'Moderate discussions in 50+ languages, with context-aware translation and detection.',
            icon: Globe,
            gradient: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'User Reputation Scoring',
            description: 'Track user behaviors, identify trolls, and promote healthy community engagement.',
            icon: Users,
            gradient: 'from-yellow-500 to-orange-500'
        },
        {
            title: 'Human Review Workflow',
            description: 'Escalate edge cases to moderators with full context and suggested actions.',
            icon: Mail,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Analytics Dashboard',
            description: 'Visualize moderation stats, trends, and policy effectiveness in real time.',
            icon: BarChart3,
    ...
    const howItWorks = [
        {
            ...
            description: 'User submits a comment on any connected platform—website, app, or forum.',
            icon: MessageSquare,
        ...
        },
        {
            step: 2,
            title: 'AI Moderation',
            description: 'Comment is scanned for spam, abuse, hate speech, and custom rule violations in under 1 second.',
            icon: Brain,
        ...
        },
        {
            ...
            description: 'Safe comments are posted immediately. Risky ones are flagged, hidden, or escalated to human moderators.',
            icon: Shield,
        ...
        },
        {
            ...
            description: 'AI learns from moderator feedback and evolving patterns to improve accuracy.',
            icon: Cpu,
    ...
    const integrations = [
        { name: 'Disqus', category: 'Commenting', logo: '💬' },
        { name: 'WordPress', category: 'CMS', logo: '📝' },
        ...
        { name: 'Custom API', category: 'Any Platform', logo: '⚡' },
        { name: 'Telegram', category: 'Chat', logo: '✈️' },
        { name: 'Twitch', category: 'Streaming', logo: '🎮' },
        { name: 'Instagram', category: 'Social', logo: '📸' },
        { name: 'TikTok', category: 'Video', logo: '🎵' },
        { name: 'GitHub', category: 'Code', logo: '🐙' },
        { name: 'Teams', category: 'Communication', logo: '👥' },
        { name: 'Sitecore', category: 'CMS', logo: '🌐' }
    ];

    const channels = [
        { name: 'Websites', icon: Globe, description: 'Moderate blog, news, and forum comments in real time' },
        { name: 'Social Media', icon: MessageCircle, description: 'Keep your brand safe across Facebook, Instagram, and more' },
        { name: 'Video Platforms', icon: Play, description: 'YouTube, Twitch, TikTok, and live stream moderation' },
        { name: 'E-commerce', icon: Smartphone, description: 'Protect reviews and Q&A from spam and abuse' }
    ];

    const benefits = [
        {
            title: 'Protect Your Brand',
            description: 'Instant detection and removal of toxic content ensures a safe, positive environment.',
            percentage: '99.5%',
            metric: 'accuracy'
        },
        {
            title: 'Save Moderator Time',
            description: 'Automate 90% of moderation and let humans focus on complex cases.',
            percentage: '90%',
            metric: 'efficiency'
        },
        {
            title: 'Boost Engagement',
            description: 'Cleaner comment sections drive 34% more participation and constructive conversations.',
            percentage: '34%',
            metric: 'engagement lift'
        },
        {
            title: 'Scale Effortlessly',
            description: 'Moderate millions of comments across languages and platforms without extra staff.',
            percentage: '∞',
            metric: 'scalability'
        },
        {
            title: 'Comply with Policies',
            description: 'Meet global safety, privacy, and anti-abuse standards automatically.',
            percentage: '100%',
            metric: 'compliance'
        }
    ];
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Instantly detect and remove toxic, spam, and off-topic comments — across languages, platforms, and scales. Protect your brand and foster healthy conversations with AI-powered moderation.
                    </div>
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            ...
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">Comment Moderation AI Agent</h3>
                                        <div className="text-slate-400 text-sm flex items-center gap-2">
                                            <div className="w-2 h-2 bg-emerald-400 rounded-full animate-ping"></div>
                                            Live • Moderating comments
                                        </div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4">
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-emerald-400">99.5%</div>
                                        <div className="text-xs text-slate-400">Toxicity Detection</div>
                                    </div>
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-blue-400">&lt;1s</div>
                                        <div className="text-xs text-slate-400">Moderation Speed</div>
                                    </div>
                                </div>
                            </div>
                            {/* Chat Interface */}
                            <div className="space-y-4 mb-6">
                                ...
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '0.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Comment flagged and auto-removed for abusive language. User warned.</span>
                                        <span className="text-xs text-blue-100 mt-1 block">6:18 PM</span>
                                    </div>
                                ...
                                <div className="flex gap-3 justify-end">
                                    <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 rounded-2xl p-3 border border-blue-500/30">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-xs text-blue-300">AI is responding...</span>
                                        </div>
                                    </div>
                                    <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center">
                                        <Bot className="w-4 h-4 text-white" />
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('how-it-works') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Safer content, <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent">automatically</span>
                        </h2>
                    </div>
                    <div className="relative">
            ...
            <section id="features" className="py-16 sm:py-24 lg:py-32 px-4 bg-gradient-to-br from-slate-900/50 to-slate-800/30">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            All you need for
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> safe communities</span>
                        </h2>
                    </div>
            ...
            <section id="channels" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('channels') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Moderate everywhere your
                            <span className="bg-gradient-to-r from-blue-400 to-cyan-600 bg-clip-text text-transparent"> users comment</span>
                        </h2>
                    </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('benefits') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> safer brands</span>
                        </h2>
                    </div>
            ...
            <section id="capabilities" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Next-gen moderation
                            <span className="bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent"> that protects</span>
                        </h2>
                    </div>
                            ...
                            <div className="relative">
                                <div className="relative w-80 h-80 mx-auto">
                                    ...
                                    {[
                                        ...
                                        { label: 'Toxicity', angle: 60, color: 'from-orange-500 to-red-500' },
                                        { label: 'Rules', angle: 120, color: 'from-emerald-500 to-teal-500' },
                                        { label: 'Learning', angle: 180, color: 'from-purple-500 to-pink-500' },
                                        { label: 'Multi-Lang', angle: 240, color: 'from-yellow-500 to-orange-500' },
                            ...
                            {[
                                {
                                    ...
                                    description: 'Detects nuanced hate, sarcasm, and context-specific abuse in 50+ languages.',
                                    icon: Brain,
                                    color: 'from-blue-500 to-cyan-500'
                                },
                                {
                                    title: 'Dynamic Rule Engine',
                                    description: 'Customizable moderation rules for keywords, spam, and behavior patterns.',
                                    icon: Settings,
                                    color: 'from-orange-500 to-red-500'
                                },
                                {
                                    title: 'Continuous Learning',
                                    description: 'AI adapts to new slang, trends, and feedback for ever-improving accuracy.',
                                    icon: Cpu,
                                    color: 'from-emerald-500 to-teal-500'
                                },
                                {
                                    title: 'Multi-Language Moderation',
                                    description: 'Detects policy violations across languages with context-aware translation.',
                                    icon: Globe,
                                    color: 'from-yellow-500 to-orange-500'
                                },
                                {
                                    title: 'Policy Analytics',
                                    description: 'Track effectiveness, false positives, and trends to tune moderation.',
                                    icon: BarChart3,
                                    color: 'from-indigo-500 to-purple-500'
                                },
                                {
                                    title: 'Moderator Collaboration',
                                    description: 'Seamlessly escalate edge cases with context and suggested actions.',
                                    icon: Mail,
                                    color: 'from-purple-500 to-pink-500'
                                }
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Empower your team with instant, automated moderation and build a safe, thriving community. Book a demo or get started today!
                        </p>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-8 border-t border-slate-700/50">
                            {[
                                { label: 'Setup Time', value: '3 Days' },
                                { label: 'Real-Time Results', value: 'Instant' },
