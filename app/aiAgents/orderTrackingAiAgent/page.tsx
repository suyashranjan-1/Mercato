...
import { Bot, Globe, Zap, BarChart3, Database, MessageCircle, Settings, Cpu, Shield, Play, ArrowRight, ChevronRight, Users, Clock, Star, CheckCircle, Smartphone, Mail, Phone, MessageSquare, Truck, PackageCheck, LocateFixed, Receipt, MapPin, Navigation2 } from 'lucide-react';
...
export default function OrderTrackingAIAgent() {
    ...
    // Stats for Order Tracking AI Agent
    const stats = [
        { label: 'Orders Tracked', value: '2M+', icon: PackageCheck, color: 'from-blue-500 to-cyan-500' },
        { label: 'Avg Response Time', value: '<3s', icon: Clock, color: 'from-yellow-500 to-orange-500' },
        { label: 'Live Tracking Accuracy', value: '99.2%', icon: LocateFixed, color: 'from-emerald-500 to-teal-500' },
        { label: 'System Uptime', value: '99.99%', icon: Zap, color: 'from-purple-500 to-pink-500' },
    ];

    // Features for Order Tracking AI Agent
    const features = [
        {
            title: 'Real-Time Order Tracking',
            description: 'Track orders live from warehouse to doorstep with interactive maps and instant updates.',
            icon: LocateFixed,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Multi-Carrier Integration',
            description: 'Seamlessly connect with FedEx, DHL, UPS, USPS, and 100+ local carriers for unified tracking.',
            icon: Truck,
            gradient: 'from-purple-500 to-pink-500'
        },
        {
            title: 'Automated Status Alerts',
            description: 'Send SMS, email, or app notifications for every shipment event: shipped, out for delivery, delivered, delayed.',
            icon: Mail,
            gradient: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Customer Self-Service',
            description: 'Allow customers to check order status, ETA, and location instantly on web or mobile.',
            icon: Smartphone,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: 'Exception & Delay Handling',
            description: 'AI flags delivery issues early and proactively suggests resolutions or compensation.',
            icon: Shield,
            gradient: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Analytics & Performance',
            description: 'Monitor delivery times, carrier performance, and customer satisfaction on a real-time dashboard.',
            icon: BarChart3,
            gradient: 'from-pink-500 to-rose-500'
        },
        {
            title: 'Order History & Receipts',
            description: 'Provide access to full order history, receipts, and downloadable proof of delivery.',
            icon: Receipt,
            gradient: 'from-amber-500 to-orange-500'
        },
        {
            title: 'Seamless Integration',
            description: 'Connect easily to Shopify, WooCommerce, Magento, Salesforce, and more.',
            icon: Settings,
            gradient: 'from-cyan-500 to-blue-500'
        }
    ];

    // How It Works for Order Tracking AI Agent
    const howItWorks = [
        {
            step: 1,
            title: 'Order Placed',
            description: 'Customer places order through website, app, or POS. Tracking ID is generated.',
            icon: MessageSquare,
        ...
        },
        {
            ...
            description: 'Order is shipped and assigned to a carrier. Real-time tracking link sent to customer.',
            icon: Truck,
        ...
        },
        {
            ...
            description: 'AI tracks location, status, and ETA. Customers get updates at every milestone.',
            icon: LocateFixed,
        ...
        },
        {
            ...
            description: 'Customer receives order, confirms delivery, and is prompted for feedback automatically.',
            icon: PackageCheck,
            color: 'from-orange-500 to-red-500'
        }
    ];

    // Integrations for Order Tracking
    const integrations = [
        { name: 'FedEx', category: 'Carrier', logo: '🚚' },
        { name: 'DHL', category: 'Carrier', logo: '✈️' },
        { name: 'UPS', category: 'Carrier', logo: '📦' },
        { name: 'USPS', category: 'Carrier', logo: '🇺🇸' },
        ...
        { name: 'Google Maps', category: 'Maps', logo: '🗺️' },
        { name: 'Shopify POS', category: 'POS', logo: '🏪' },
        { name: 'Stripe', category: 'Payments', logo: '💳' },
        { name: 'QuickBooks', category: 'Accounting', logo: '📒' },
        { name: 'S3', category: 'Storage', logo: '🗄️' },
    ];

    // Channels for Order Tracking
    const channels = [
        { name: 'Web Portal', icon: Globe, description: 'Track orders online with live status and maps' },
        { name: 'Mobile App', icon: Smartphone, description: 'Real-time tracking and push notifications' },
        { name: 'Email/SMS Alerts', icon: Mail, description: 'Automated updates for every shipment event' },
        { name: 'API Access', icon: Settings, description: 'Integrate tracking and notifications anywhere' }
    ];

    // Benefits for Order Tracking
    const benefits = [
        {
            title: 'Reduce WISMO Queries',
            description: '"Where is my order?" calls drop up to 90% with proactive, AI-powered tracking.',
            percentage: '90%',
            metric: 'fewer WISMO calls'
        },
        {
            title: 'Increase Customer Satisfaction',
            description: 'Keep customers informed and in control—average CSAT rises by 18%.',
            percentage: '+18%',
            metric: 'higher CSAT'
        },
        {
            title: 'Boost Repeat Purchases',
            description: 'Transparent tracking and smooth delivery experience drives loyalty.',
            percentage: '+22%',
            metric: 'repeat orders'
        },
        {
            title: 'Lower Delivery Costs',
            description: 'Reduce failed deliveries and support workload through automation.',
            percentage: '30%',
            metric: 'delivery savings'
        },
        {
            title: 'Faster Resolutions',
            description: 'AI flags and resolves exceptions, reducing average resolution time by 60%.',
            percentage: '60%',
            metric: 'resolution speed'
        }
    ];

    // Capabilities for Order Tracking
    const capabilities = [
        {
            title: 'Live Order Location',
            description: 'Track every shipment on a live map with accurate ETA and carrier data.',
            icon: LocateFixed,
            color: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Multi-Carrier Support',
            description: 'Connect to 100+ carriers for global, unified order visibility.',
            icon: Truck,
            color: 'from-purple-500 to-pink-500'
        },
        {
            title: 'Automated Notifications',
            description: 'Send real-time SMS, email, and app updates at every status change.',
            icon: Mail,
            color: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Exception Management',
            description: 'Instantly detect and resolve delivery delays, lost packages, or address issues.',
            icon: Shield,
            color: 'from-orange-500 to-red-500'
        },
        {
            title: 'Order Search & History',
            description: 'Full order lookup by ID, phone, name, or email with timeline and receipts.',
            icon: Receipt,
            color: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Analytics & Reporting',
            description: 'Detailed insights into delivery SLAs, carrier performance, and customer feedback.',
            icon: BarChart3,
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Track, update, and resolve every order with AI. Deliver real-time status, live maps, and proactive alerts—across all carriers and channels.
                    </div>
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            ...
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">Order Tracking AI Agent</h3>
                                        <div className="text-slate-400 text-sm flex items-center gap-2">
                                            <div className="w-2 h-2 bg-emerald-400 rounded-full animate-ping"></div>
                                            Online • Tracking orders
                                        </div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-yellow-400">&lt;3s</div>
                            ...
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3 animate-slideInLeft">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Where is my order #12345?</span>
                                        <span className="text-xs text-slate-400 mt-1 block">11:10 AM</span>
                                    </div>
                                </div>
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '0.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Order #12345 is out for delivery and currently 2 miles from your location. ETA: 12:05 PM. Live map and carrier link sent to your email and SMS.</span>
                                        <span className="text-xs text-blue-100 mt-1 block">11:10 AM</span>
                                    </div>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Can I get a receipt and proof of delivery?</span>
                                        <span className="text-xs text-slate-400 mt-1 block">11:11 AM</span>
                                    </div>
                                </div>
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '1.2s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Sure! Your receipt and proof of delivery for order #12345 have been sent to your email.</span>
                                        <span className="text-xs text-blue-100 mt-1 block">11:11 AM</span>
                                    </div>
                                    <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center">
                                        <Bot className="w-4 h-4 text-white" />
                                    </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('how-it-works') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> real time</span>
                        </h2>
                    </div>
                    <div className="relative">
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> seamless order tracking</span>
                        </h2>
                    </div>
            ...
            <section id="channels" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('channels') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Connect tracking to every
                            <span className="bg-gradient-to-r from-blue-400 to-cyan-600 bg-clip-text text-transparent"> sales & delivery channel</span>
                        </h2>
                    </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('benefits') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> with effortless tracking</span>
                        </h2>
                    </div>
            ...
            <section id="capabilities" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            The most advanced tracking platform
                            <span className="bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent"> for modern commerce</span>
                        </h2>
                    </div>
                        ...
                        <div className={`relative transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
                            <div className="relative">
                                ...
                                <div className="relative w-80 h-80 mx-auto">
                                    ...
                                    {[
                                        { label: 'Live', angle: 0, color: 'from-blue-500 to-cyan-500' },
                                        { label: 'Carriers', angle: 60, color: 'from-emerald-500 to-teal-500' },
                                        { label: 'Notify', angle: 120, color: 'from-orange-500 to-red-500' },
                                        { label: 'Exceptions', angle: 180, color: 'from-purple-500 to-pink-500' },
                                        { label: 'History', angle: 240, color: 'from-yellow-500 to-orange-500' },
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 sm:mb-8 leading-tight">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> AI-powered tracking today</span>
                        </h2>
                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Join retailers, brands, and logistics providers transforming order tracking and customer experience with AI. Try our Order Tracking AI Agent free and keep customers delighted.
                        </p>
                        {/* Trust Indicators */}
