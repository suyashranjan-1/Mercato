...
export default function ExpenseManagementAIAgent() {
    ...
    // --- DATA for ExpenseManagementAIAgent ---

    const stats = [
        { label: 'Avg Report Approval Time', value: '<3h', icon: Clock, color: 'from-blue-500 to-cyan-500' },
        { label: 'Policy Compliance', value: '99.5%', icon: CheckCircle, color: 'from-emerald-500 to-teal-500' },
        { label: 'Expense Fraud Reduction', value: '-72%', icon: Shield, color: 'from-orange-500 to-red-500' },
    ...
    const features = [
        {
            ...
            description: 'AI reads receipts from email, photos, or uploads and auto-extracts data to prefill expense reports.',
            icon: Cpu,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Real-Time Policy Check',
            description: 'Every expense is checked and flagged for policy violations or missing documentation.',
            icon: Shield,
            gradient: 'from-purple-500 to-pink-500'
        },
        {
            title: 'Automated Approvals',
            description: 'AI routes reports for manager and finance approval, notifies stakeholders, and chases delays.',
            icon: Zap,
            gradient: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Fraud & Duplicate Detection',
            description: 'AI detects duplicate receipts, suspicious vendors, and outlier spending patterns.',
            icon: Brain,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: 'Mobile Expense Management',
            description: 'Submit, review, and approve expenses from any device, anywhere.',
            icon: Smartphone,
            gradient: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Advanced Spend Analytics',
            description: 'Dashboards for spend by team, project, category, vendor, and trend analysis.',
            icon: BarChart3,
            gradient: 'from-pink-500 to-rose-500'
        },
        {
            title: 'ERP & Card Integration',
            description: 'Connects with SAP, Oracle, NetSuite, QuickBooks, Visa, Mastercard, and more.',
            icon: Database,
            gradient: 'from-yellow-500 to-orange-500'
        },
        {
            title: 'Automated Reimbursements',
            description: 'AI triggers payroll or ACH reimbursements instantly after approval.',
            icon: Settings,
    ...
    const howItWorks = [
        {
            ...
            description: 'Employees submit receipts via mobile, email, or web—AI auto-captures data and attaches documentation.',
            icon: MessageCircle,
            color: 'from-blue-500 to-cyan-500'
        },
        {
            step: 2,
            title: 'AI Policy & Fraud Check',
            description: 'AI validates every transaction against company policy and flags anomalies or duplicates.',
            icon: Brain,
        ...
        },
        {
            ...
            description: 'Valid expenses are routed to managers and finance for instant approval and payment.',
            icon: CheckCircle,
            color: 'from-emerald-500 to-teal-500'
        },
        {
            step: 4,
            title: 'Analytics & Reimbursement',
            description: 'Get real-time spend insights and trigger reimbursements automatically.',
            icon: BarChart3,
    ...
    const integrations = [
        { name: 'SAP Concur', category: 'ERP', logo: '🏢' },
        { name: 'Oracle', category: 'ERP', logo: '☁️' },
        { name: 'NetSuite', category: 'ERP', logo: '💼' },
        { name: 'QuickBooks', category: 'Finance', logo: '📒' },
        { name: 'Visa', category: 'Corporate Card', logo: '💳' },
        { name: 'Mastercard', category: 'Corporate Card', logo: '💳' },
        { name: 'Amex', category: 'Corporate Card', logo: '💳' },
    ...
    const channels = [
        { name: 'Web Portal', icon: Globe, description: 'Submit and track expenses online' },
        { name: 'Mobile App', icon: Smartphone, description: 'Upload receipts and approve on the go' },
        { name: 'Email Processing', icon: Mail, description: 'Forward receipts and have AI process them' },
        { name: 'Chat Integration', icon: MessageCircle, description: 'Expense actions in Slack, Teams, or chat' }
    ];

    const benefits = [
        {
            title: 'Speed Up Approvals',
            description: 'Reduce time-to-approval from days to hours with automated workflows.',
            percentage: '-73%',
            metric: 'approval time'
        },
        {
            title: 'Reduce Fraud & Errors',
            description: 'AI flags duplicates, outliers, and policy violations before they cause problems.',
            percentage: '-72%',
            metric: 'fraud rate'
        },
        {
            title: 'Increase Compliance',
            description: 'Automated checks ensure every expense meets company policy.',
            percentage: '99.5%',
            metric: 'compliance'
        },
        {
            title: 'Boost Productivity',
            description: 'No more manual entry or chasing receipts—AI does the work.',
            percentage: '+5.1x',
            metric: 'productivity'
        },
        {
            title: 'Real-time Spend Insights',
            description: 'Stay on budget, spot trends, and optimize spend with instant analytics.',
            percentage: '+42%',
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Automate your company spend with <span className="text-white font-medium">AI-powered expense management</span>: policy-compliant, fraud-resistant, and effortless for employees and finance teams, anywhere.
                    </div>
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            ...
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">Expense Management AI Agent</h3>
                                        <div className="text-slate-400 text-sm flex items-center gap-2">
                                            <div className="w-2 h-2 bg-emerald-400 rounded-full animate-ping"></div>
                                            Online • Processing expenses
                                        </div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-blue-400">&lt;3h</div>
                            ...
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3 animate-slideInLeft">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">I just uploaded a lunch receipt for the NYC trip. Is it compliant and approved?</span>
                                        <span className="text-xs text-slate-400 mt-1 block">8:17 AM</span>
                                    </div>
                                </div>
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '0.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Receipt verified, policy-compliant, and approved! Reimbursement will be processed in the next payroll.</span>
                                        <span className="text-xs text-blue-100 mt-1 block">8:17 AM</span>
                                    </div>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Can you show me a monthly spend breakdown for my team?</span>
                                        <span className="text-xs text-slate-400 mt-1 block">8:18 AM</span>
                                    </div>
                                </div>
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '1.2s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Here’s your team’s expense report by category and vendor for this month. Export or drill down for more detail.</span>
                                        <span className="text-xs text-blue-100 mt-1 block">8:18 AM</span>
                                    </div>
                                    <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center">
                                        <Bot className="w-4 h-4 text-white" />
                                    </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('how-it-works') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            From receipt to reimbursement in
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> hours</span>
                        </h2>
                    </div>
                    <div className="relative">
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> effortless expense management</span>
                        </h2>
                    </div>
            ...
            <section id="capabilities" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            AI that understands every expense
                            <span className="bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent"> and every policy</span>
                        </h2>
                    </div>
                            ...
                            <div className="relative">
                                <div className="relative w-80 h-80 mx-auto">
                                    ...
                                    {[
                                        ...
                                        { label: 'Reimburse', angle: 120, color: 'from-orange-500 to-red-500' },
                                        { label: 'Analytics', angle: 180, color: 'from-purple-500 to-pink-500' },
                                        { label: 'Integrate', angle: 240, color: 'from-yellow-500 to-orange-500' },
                                        { label: 'Mobile', angle: 300, color: 'from-indigo-500 to-purple-500' }
                                    ].map((node, index) => {
                            ...
                            {[
                                {
                                    ...
                                    description: 'AI checks every expense against the latest policies and approvals.',
                                    icon: Settings,
                                    color: 'from-blue-500 to-cyan-500'
                                },
                                {
                                    title: 'Fraud & Error Detection',
                                    description: 'Detects duplicates, anomalies, and risky vendors in real time.',
                                    icon: Shield,
                                    color: 'from-purple-500 to-pink-500'
                                },
                                {
                                    title: 'Automated Reimbursement',
                                    description: 'Triggers payout as soon as expenses are approved.',
                                    icon: Zap,
                                    color: 'from-emerald-500 to-teal-500'
                                },
                                {
                                    title: 'Analytics & Reporting',
                                    description: 'Smart dashboards for spend, compliance, and trends.',
                                    icon: BarChart3,
                                    color: 'from-orange-500 to-red-500'
                                },
                                {
                                    title: 'Integrations',
                                    description: 'Works with your ERP, payroll, card, and analytics stack.',
                                    icon: Database,
                                    color: 'from-yellow-500 to-orange-500'
                                },
                                {
                                    title: 'Mobile-First Experience',
                                    description: 'Capture, approve, and track expenses from any device.',
                                    icon: Smartphone,
            ...
            <section id="cta" className="py-16 sm:py-24 lg:py-32 px-4 bg-gradient-to-br from-slate-900/50 to-slate-800/30">
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        <div className="inline-flex items-center px-4 sm:px-6 py-2 mb-6 sm:mb-8 rounded-full border border-slate-700/50 bg-slate-800/30 backdrop-blur-sm text-xs sm:text-sm text-slate-300">
                            <Zap className="w-4 h-4 mr-2 text-emerald-400" />
                            Ready to Automate Expenses?
                        </div>

                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 sm:mb-8 leading-tight">
                            Empower your finance team
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> with AI expense management</span>
                        </h2>

                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Get started with guided onboarding, instant ERP integration, and 24/7 expert support. Eliminate manual entry and gain real-time spend control—today.
                        </p>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-8 border-t border-slate-700/50">
                            {[
                                ...
                                { label: 'ERP Integration', value: 'Plug & Play' },
