...
export default function InterviewSchedulerAIAgent() {
    ...
    const stats = [
        { label: 'Avg Scheduling Time', value: '<30s', icon: Clock, color: 'from-blue-500 to-cyan-500' },
        { label: 'Interview Success Rate', value: '96%', icon: Star, color: 'from-yellow-500 to-orange-500' },
        { label: 'Schedule Accuracy', value: '99%', icon: CheckCircle, color: 'from-emerald-500 to-teal-500' },
    ...
    const features = [
        {
            ...
            description: 'Automatically finds optimal interview slots considering time zones, interviewer/candidate availability, and preferences.',
            icon: Zap,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Multi-Calendar Integration',
            description: 'Seamlessly syncs with Google Calendar, Outlook, and other major platforms for real-time availability and updates.',
            icon: MessageCircle,
            gradient: 'from-purple-500 to-pink-500'
        },
        {
            title: 'Intelligent Rescheduling',
            description: 'Handles last-minute changes and conflicts by suggesting and automating alternative time slots.',
            icon: Users,
            gradient: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Data Security',
            description: 'Enterprise-grade security to protect candidate and interviewer data, compliant with GDPR and SOC 2.',
            icon: Shield,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: 'Analytics Dashboard',
            description: 'Track interview metrics, scheduling efficiency, and candidate experience with actionable analytics.',
            icon: BarChart3,
            gradient: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Video Conferencing Integration',
            description: 'Built-in support for Zoom, Teams, Google Meet, and more for seamless virtual interviews.',
            icon: Headphones,
            gradient: 'from-pink-500 to-rose-500'
        },
        {
            title: 'Time Zone Intelligence',
            description: 'Effortlessly coordinate interviews across different cities and time zones worldwide.',
            icon: Brain,
            gradient: 'from-rose-500 to-pink-500'
        },
        {
            title: 'Automated Reminders',
            description: 'Send smart notifications and reminders to reduce no-shows and improve participation rates.',
            icon: Database,
    ...
    const howItWorks = [
        {
            ...
            description: 'Recruiter or hiring manager initiates an interview request with candidate and role details.',
            icon: MessageSquare,
        ...
        },
        {
            step: 2,
            title: 'AI Scheduling',
            description: 'AI analyzes all calendars, preferences, and constraints to find the best possible times.',
            icon: Brain,
            color: 'from-purple-500 to-pink-500'
        },
        {
            step: 3,
            title: 'Confirmation & Invites',
            description: 'System books the interview, sends out calendar invites, and integrates video conferencing links.',
            icon: Cpu,
        ...
        },
        {
            ...
            description: 'Automated reminders are sent and any changes or reschedules are handled instantly.',
            icon: Database,
    ...
    const integrations = [
        { name: 'Google Calendar', category: 'Calendar', logo: '📅' },
        { name: 'Microsoft Outlook', category: 'Calendar', logo: '📆' },
        { name: 'Zoom', category: 'Video', logo: '🎥' },
        { name: 'Microsoft Teams', category: 'Video', logo: '👥' },
        ...
        { name: 'iCal', category: 'Calendar', logo: '📅' },
        { name: 'Calendly', category: 'Scheduling', logo: '📊' },
        { name: 'SAP SuccessFactors', category: 'HRIS', logo: '🔄' },
        { name: 'Oracle HCM', category: 'HRIS', logo: '☁️' },
        { name: 'BambooHR', category: 'HRIS', logo: '🎋' },
        { name: 'LinkedIn', category: 'Professional', logo: '🔗' },
        { name: 'SmartRecruiters', category: 'ATS', logo: '🤖' },
    ];

    const channels = [
        { name: 'Web Dashboard', icon: MessageCircle, description: 'Centralized interface for recruiters and candidates' },
        { name: 'Email Integration', icon: Mail, description: 'Schedule directly via email threads and notifications' },
        { name: 'Mobile App', icon: Smartphone, description: 'Manage interviews on the go, anywhere' },
        { name: 'Calendar Sync', icon: Clock, description: 'Direct sync with your preferred calendar platform' }
    ];

    const benefits = [
        {
            title: 'Save Time',
            description: 'Reduce interview scheduling time from hours to seconds with automation.',
            percentage: '95%',
            metric: 'time saved'
        },
        {
            title: 'Increase Efficiency',
            description: 'Automate repetitive tasks and focus on interview quality, not logistics.',
            percentage: '80%',
            metric: 'efficiency gain'
        },
        {
            title: 'Improve Candidate Experience',
            description: 'Frictionless scheduling and rescheduling for every participant.',
            percentage: '92%',
            metric: 'satisfaction rate'
        },
        {
            title: 'Global Coordination',
            description: 'Effortlessly manage interviews across time zones and geographies.',
            percentage: '24/7',
            metric: 'availability'
        },
        {
            title: 'Fewer No-Shows',
            description: 'Automated reminders and confirmations reduce interview no-shows drastically.',
            percentage: '75%',
            metric: 'reduction in no-shows'
        }
    ];
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Revolutionize your hiring process with AI that coordinates, confirms, and manages interviews across calendars, time zones, and platforms. Effortless scheduling, fewer no-shows, and a seamless candidate experience.
                    </div>
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            ...
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">Interview Scheduler AI Agent</h3>
                                        <div className="text-slate-400 text-sm flex items-center gap-2">
                                            <div className="w-2 h-2 bg-emerald-400 rounded-full animate-ping"></div>
                                            Online • Scheduling instantly
                                        </div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="text-right">
                                        ...
                                        <div className="text-xs text-slate-400">Avg Scheduling</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3 animate-slideInLeft">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Can you schedule a panel interview for Jane Doe with the engineering team next week?</span>
                                ...
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '0.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Confirmed! Interview scheduled for Tuesday, 11:00 AM - 12:00 PM (PST) via Zoom. All participants have been notified and calendar invites sent.</span>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Thanks! Can you move the interview to Friday instead?</span>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1.2s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">And please add a reminder for all participants 1 hour before.</span>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('how-it-works') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            From request to confirmation in
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> seamless interviews</span>
                        </h2>
                    </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('channels') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-blue-400 to-cyan-600 bg-clip-text text-transparent"> recruitment platforms</span>
                        </h2>
                    </div>
            ...
            <section id="benefits" className="py-16 sm:py-24 lg:py-32 px-4 bg-gradient-to-br from-slate-900/50 to-slate-800/30">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('benefits') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Deliver seamless interview scheduling
            ...
            <section id="capabilities" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Advanced AI for
                            <span className="bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent"> effortless scheduling</span>
                        </h2>
                    </div>
                        ...
                        <div className={`relative transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
                            <div className="relative">
                                ...
                                <div className="relative w-80 h-80 mx-auto">
                                    ...
                                    {[
                                        { label: 'Calendar', angle: 0, color: 'from-blue-500 to-cyan-500' },
                            ...
                            {[
                                {
                                    ...
                                    description: 'AI cross-checks multiple calendars and time zones to guarantee no scheduling overlaps.',
                                    icon: Clock,
                                    color: 'from-blue-500 to-cyan-500'
                                },
                                {
                                    title: 'Machine Learning Optimization',
                                    description: 'Learns interviewer/candidate preferences and proposes best-fit interview times.',
                                    icon: Brain,
                                    color: 'from-purple-500 to-pink-500'
                                },
                                {
                                    title: 'Automated Reminders & Updates',
                                    description: 'Sends reminders and handles all changes automatically, reducing manual follow-up.',
                                    icon: Database,
                                    color: 'from-emerald-500 to-teal-500'
                                },
                                {
                                    title: 'Real-time Analytics',
                                    description: 'Analyze scheduling performance and candidate experience with actionable insights.',
                                    icon: BarChart3,
                                    color: 'from-orange-500 to-red-500'
                                },
                                {
                                    title: 'Enterprise Security',
                                    description: 'GDPR/SOC 2 compliant, encrypted data, and single sign-on support.',
                                    icon: Shield,
                                    color: 'from-indigo-500 to-purple-500'
                                },
                                {
                                    title: 'Comprehensive History',
                                    description: 'Maintain audit logs and interview history for compliance and optimization.',
                                    icon: Database,
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 sm:mb-8 leading-tight">
                            Start scheduling smarter with
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> Interview Scheduler AI</span>
                        </h2>
                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Join leading companies already using AI to hire faster and smarter.
                            Get started in minutes with a free trial—let interviews schedule themselves!
                        </p>
                        {/* Trust Indicators */}
