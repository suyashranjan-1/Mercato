...
import {
    Users, Clock, Star, CheckCircle, ArrowRight, Bot, Shield, Zap, BarChart3, Globe, Play, ChevronRight, Brain, Cpu, Database, Settings, Mail, Smartphone, MessageCircle, MessageSquare
} from 'lucide-react';
...
export default function ResumeScreeningAIAgent() {
    ...
    // --- DATA for ResumeScreeningAIAgent ---

    const stats = [
        { label: 'Avg Screening Time', value: '<10s', icon: Clock, color: 'from-blue-500 to-cyan-500' },
        { label: 'Shortlisting Accuracy', value: '97%', icon: Star, color: 'from-yellow-500 to-orange-500' },
        { label: 'Bias Reduction', value: '95%', icon: CheckCircle, color: 'from-emerald-500 to-teal-500' },
    ...
    const features = [
        {
            ...
            description: 'Extracts skills, experience, education, and achievements from any resume format in seconds.',
            icon: Cpu,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'AI-Powered Shortlisting',
            description: 'Ranks applicants based on job fit, required skills, and customizable criteria.',
            icon: BarChart3,
            gradient: 'from-purple-500 to-pink-500'
        },
        {
            title: 'Bias-Free Screening',
            description: 'Removes personal identifiers and applies fair scoring for diversity and inclusion.',
            icon: Shield,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: 'Bulk Resume Screening',
            description: 'Screen thousands of resumes simultaneously, saving hours of manual review.',
            icon: Zap,
            gradient: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Customizable Job Profiles',
            description: 'Easily define and update requirements for every role and department.',
            icon: Settings,
            gradient: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Seamless ATS Integration',
            description: 'Works with Greenhouse, Lever, Workday, iCIMS, and other major ATS platforms.',
            icon: Database,
            gradient: 'from-pink-500 to-rose-500'
        },
        {
            title: 'Candidate Communication',
            description: 'Automated responses, interview scheduling, and feedback at every stage.',
            icon: Mail,
            gradient: 'from-yellow-500 to-orange-500'
        },
        {
            title: 'Role-Based Access',
            description: 'Granular access controls for recruiters, hiring managers, and HR teams.',
            icon: Users,
    ...
    const howItWorks = [
        {
            ...
            description: 'Candidates submit resumes via portal, email, or ATS integration.',
            icon: MessageSquare,
        ...
        },
        {
            ...
            description: 'AI extracts and analyzes all relevant candidate data and skills.',
            icon: Brain,
            color: 'from-purple-500 to-pink-500'
        },
        {
            step: 3,
            title: 'Scoring & Shortlisting',
            description: 'AI scores resumes against job profiles and shortlists top candidates.',
            icon: CheckCircle,
        ...
        },
        {
            ...
            description: 'Candidates and hiring teams are instantly notified, and next steps are triggered.',
            icon: Mail,
    ...
    const channels = [
        { name: 'Web Portal', icon: Globe, description: 'Candidates upload resumes and track status online' },
        { name: 'Mobile App', icon: Smartphone, description: 'Screen, review, and communicate on the go' },
        { name: 'Email Submission', icon: Mail, description: 'Parse resumes received via email automatically' },
        { name: 'ATS Integration', icon: Database, description: 'Plug AI into your existing applicant tracking system' }
    ];

    const benefits = [
        {
            title: 'Screen Faster',
            description: 'Reduce screening time from hours to seconds, even for high-volume roles.',
            percentage: '95%',
            metric: 'time saved'
        },
        {
            title: 'Improve Quality',
            description: 'Shortlist only the most qualified and relevant candidates for each role.',
            percentage: '+44%',
            metric: 'quality hires'
        },
        {
            title: 'Boost Diversity',
            description: 'Remove unconscious bias and ensure fair, inclusive screening.',
            percentage: '+34%',
            metric: 'diversity increase'
        },
        {
            title: 'Lower Cost per Hire',
            description: 'Reduce manual hours and recruitment expenses significantly.',
            percentage: '-61%',
            metric: 'cost per hire'
        },
        {
            title: 'Enhance Candidate Experience',
            description: 'Automated updates and instant feedback keep candidates informed and engaged.',
            percentage: '4.8★',
            metric: 'candidate rating'
        }
    ];
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Accelerate hiring with <span className="text-white font-medium">AI-powered resume screening</span>: faster, fairer, and more accurate shortlisting. Empower recruiters and delight candidates at scale, on any device.
                    </div>
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            ...
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">Resume Screening AI Agent</h3>
                                ...
                                <div className="flex items-center gap-4">
                                    <div className="text-right">
                                        ...
                                        <div className="text-xs text-slate-400">Shortlisting</div>
                                    </div>
                                    <div className="text-right">
                            ...
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3 animate-slideInLeft">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">I just uploaded 200 resumes for the Software Engineer role. Can you shortlist the top 10?</span>
                                ...
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '0.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Screening completed! Here are the 10 best-fit candidates based on your requirements. Would you like to notify them or schedule interviews?</span>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Can I see a diversity breakdown of the shortlisted applicants?</span>
                                ...
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '1.2s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Here’s a diversity report (anonymized). You can also export results or adjust screening criteria at any time.</span>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('how-it-works') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            From submission to shortlist in
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> smarter hiring</span>
                        </h2>
                    </div>
            ...
            <section id="channels" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('channels') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Screen and engage candidates on
            ...
            <section id="capabilities" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Smart hiring with
                            <span className="bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent"> unbiased AI</span>
                        </h2>
                    </div>
                        ...
                        <div className={`relative transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
                            <div className="relative">
                                <div className="relative w-80 h-80 mx-auto">
                                    ...
                                    {[
                                        { label: 'Parsing', angle: 0, color: 'from-blue-500 to-cyan-500' },
                                        { label: 'Shortlist', angle: 60, color: 'from-emerald-500 to-teal-500' },
                                        { label: 'Bias-Free', angle: 120, color: 'from-orange-500 to-red-500' },
                                        { label: 'Analytics', angle: 180, color: 'from-purple-500 to-pink-500' },
                                        { label: 'Integrations', angle: 240, color: 'from-yellow-500 to-orange-500' },
                                        { label: 'Comms', angle: 300, color: 'from-indigo-500 to-purple-500' }
                                    ].map((node, index) => {
                            ...
                            {[
                                {
                                    ...
                                    description: 'Extracts candidate data, skills, and experience from any file type.',
                                    icon: Cpu,
                                    color: 'from-blue-500 to-cyan-500'
                                },
                                {
                                    title: 'Shortlisting & Ranking',
                                    description: 'Ranks applicants based on custom-fit job profiles and required skills.',
                                    icon: BarChart3,
                                    color: 'from-emerald-500 to-teal-500'
                                },
                                {
                                    title: 'Bias-Free Screening',
                                    description: 'Removes personal data and ensures fair, inclusive shortlisting.',
                                    icon: Shield,
                                    color: 'from-orange-500 to-red-500'
                                },
                                {
                                    title: 'Analytics & Reporting',
                                    description: 'Provides instant insights into pipeline, quality, and diversity.',
                                    icon: BarChart3,
                                    color: 'from-purple-500 to-pink-500'
                                },
                                {
                                    title: 'ATS & HRIS Integration',
                                    description: 'Connects to all major tracking and HR systems for seamless workflow.',
                                    icon: Database,
                                    color: 'from-indigo-500 to-purple-500'
                                },
                                {
                                    title: 'Automated Communication',
                                    description: 'Sends updates, schedules interviews, and collects feedback automatically.',
                                    icon: Mail,
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 sm:mb-8 leading-tight">
                            Empower recruiters with
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> AI screening</span>
                        </h2>

                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Get guided onboarding, enterprise support, and seamless ATS integrations. Start screening smarter, faster, and fairer—today.
                        </p>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-8 border-t border-slate-700/50">
                            {[
                                ...
                                { label: 'Go-Live Time', value: '< 5 Days' },
                                { label: 'ATS Integration', value: 'Plug & Play' },
