...
export default function DataEntryAIAgent() {
    ...
    const stats = [
        { label: 'Avg Data Entry Time', value: '<2s/record', icon: Clock, color: 'from-blue-500 to-cyan-500' },
        { label: 'Data Accuracy', value: '99.98%', icon: CheckCircle, color: 'from-emerald-500 to-teal-500' },
        { label: 'Records Processed', value: '5M+/mo', icon: Database, color: 'from-yellow-500 to-orange-500' },
    ...
    const features = [
        {
            ...
            description: 'Process forms, invoices, receipts, and spreadsheets automatically with advanced OCR and NLP.',
            icon: Zap,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Bulk Document Handling',
            description: 'Upload and process thousands of documents and records simultaneously for high-volume workflows.',
            icon: Database,
            gradient: 'from-purple-500 to-pink-500'
        },
        {
            title: 'Data Validation',
            description: 'AI validates entries for completeness, consistency, and correctness, reducing manual errors.',
            icon: CheckCircle,
            gradient: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Seamless Integration',
            description: 'Connect to ERP, CRM, and custom databases, exporting data in your required formats.',
            icon: Globe,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: 'Real-Time Analytics',
            description: 'Get insights into productivity, error rates, and workflow bottlenecks instantly.',
            icon: BarChart3,
            gradient: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Intelligent Correction',
            description: 'Automatically flags and corrects common entry mistakes using ML-driven suggestions.',
            icon: Brain,
            gradient: 'from-pink-500 to-rose-500'
        },
        {
            title: 'Multi-format Support',
            description: 'Supports images, PDFs, scanned docs, Excel, CSV, and more.',
            icon: Cpu,
            gradient: 'from-rose-500 to-pink-500'
        },
        {
            title: 'Enterprise Security',
            description: 'All data is encrypted at rest and in transit. 100% GDPR and SOC 2 compliant.',
            icon: Shield,
    ...
    const howItWorks = [
        {
            step: 1,
            title: 'Upload Data',
            description: 'User uploads files or connects data sources (scans, spreadsheets, forms, etc).',
            icon: MessageSquare,
        ...
        },
        {
            step: 2,
            title: 'AI Extraction',
            description: 'AI extracts key fields, tables, and values using OCR and natural language processing.',
            icon: Brain,
        ...
        },
        {
            ...
            description: 'System validates, corrects, and flags inconsistent or incomplete entries automatically.',
            icon: CheckCircle,
        ...
        },
        {
            ...
            description: 'Clean, validated data is exported to your desired system (ERP, CRM, database, or files).',
            icon: Globe,
    ...
    const channels = [
        { name: 'Web App', icon: MessageCircle, description: 'Accessible dashboard for uploads and management' },
        { name: 'Email Upload', icon: Mail, description: 'Forward documents to auto-capture data' },
        { name: 'Mobile App', icon: Smartphone, description: 'Scan and upload using your phone' },
        { name: 'API Integration', icon: Cpu, description: 'Automate data entry via API endpoints' }
    ];

    const benefits = [
        {
            title: 'Accelerate Data Entry',
            description: 'Process records up to 10x faster than manual entry with 99.98% accuracy.',
            percentage: '10x',
            metric: 'speed boost'
        },
        {
            title: 'Lower Costs',
            description: 'Reduce operational costs by automating repetitive data entry tasks.',
            percentage: '70%',
            metric: 'cost reduction'
        },
        {
            title: 'Improve Data Quality',
            description: 'AI validation and correction drastically reduce errors and rework.',
            percentage: '90%',
            metric: 'fewer errors'
        },
        {
            title: 'Scale Effortlessly',
            description: 'Handle millions of records per month without hiring more staff.',
            percentage: '∞',
            metric: 'scalability'
        },
        {
            title: 'Secure & Compliant',
            description: 'Full encryption and compliance keep sensitive data safe at every step.',
            percentage: '100%',
            metric: 'compliance'
        }
    ];
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Automate your data processing with AI. Extract, validate, and enter data from any source with unmatched speed and accuracy. Secure, scalable, and fully integrated with your workflow.
                    </div>
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            ...
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">Data Entry AI Agent</h3>
                            ...
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3 animate-slideInLeft">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Please process these scanned invoices and export to Excel.</span>
                                        <span className="text-xs text-slate-400 mt-1 block">9:04 AM</span>
                                    </div>
                                </div>
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '0.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">All 120 invoices processed and validated. Downloaded as Excel and synced with your ERP.</span>
                                        <span className="text-xs text-blue-100 mt-1 block">9:05 AM</span>
                                    </div>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Thanks! Can you flag any entries with missing tax IDs?</span>
                                        <span className="text-xs text-slate-400 mt-1 block">9:06 AM</span>
                                    </div>
                                </div>
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1.2s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">And export those as a separate spreadsheet.</span>
                                        <span className="text-xs text-slate-400 mt-1 block">9:07 AM</span>
                                    </div>
                                </div>
                            </div>
                            {/* Typing Indicator */}
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> fast & accurate data entry</span>
                        </h2>
                    </div>
            ...
            <section id="capabilities" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Advanced AI for
                            <span className="bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent"> flawless data entry</span>
                        </h2>
                    </div>
                            ...
                            <div className="relative">
                                <div className="relative w-80 h-80 mx-auto">
                                    ...
                                    {[
                                        ...
                                        { label: 'Validation', angle: 120, color: 'from-orange-500 to-red-500' },
                            ...
                            {[
                                {
                                    ...
                                    description: 'Extracts data from scanned documents, images, and PDFs with near-perfect accuracy.',
                                    icon: Cpu,
                                    color: 'from-blue-500 to-cyan-500'
                                },
                                {
                                    title: 'Machine Learning Validation',
                                    description: 'ML models check and correct entries, learning from user feedback and historical data.',
                                    icon: Brain,
                                    color: 'from-purple-500 to-pink-500'
                                },
                                {
                                    title: 'Bulk Data Processing',
                                    description: 'Handles millions of records and documents with parallelized processing.',
                                    icon: Database,
                                    color: 'from-emerald-500 to-teal-500'
                                },
                                {
                                    title: 'Real-time Productivity Analytics',
                                    description: 'Monitor throughput, error rates, and spot workflow bottlenecks instantly.',
                                    icon: BarChart3,
                                    color: 'from-orange-500 to-red-500'
                                },
                                {
                                    title: 'Enterprise Security',
                                    description: 'AES-256 encryption, SSO, audit logs, and compliance built-in.',
                                    icon: Shield,
                                    color: 'from-indigo-500 to-purple-500'
                                },
                                {
                                    title: 'API-first Integration',
                                    description: 'Plug into any workflow, system, or database with robust API endpoints.',
                                    icon: Cpu,
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 sm:mb-8 leading-tight">
                            Start smarter, faster data entry with
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> Data Entry AI Agent</span>
                        </h2>
                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Join industry leaders automating data entry. Try it free—eliminate errors, save time, and focus on what matters.
                        </p>
                        {/* Trust Indicators */}
