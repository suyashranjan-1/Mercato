...
import {
    MessageCircle, Clock, Users, Star, CheckCircle, ArrowRight, Bot, Shield, Zap, BarChart3, Globe, Play, ChevronRight, Brain, Cpu, Database, Settings, Phone, Mail, MessageSquare, Smartphone
} from 'lucide-react';
...
export default function SalesOutreachAIAgent() {
    ...
    const stats = [
        { label: 'Avg Response Rate', value: '67%', icon: Star, color: 'from-yellow-500 to-orange-500' },
        { label: 'Lead Conversion', value: '43%', icon: CheckCircle, color: 'from-emerald-500 to-teal-500' },
        { label: 'Automated Touchpoints', value: '12x', icon: Zap, color: 'from-blue-500 to-cyan-500' },
        { label: 'System Uptime', value: '99.99%', icon: Cpu, color: 'from-purple-500 to-pink-500' },
    ];

    const features = [
        {
            title: 'Personalized Outreach at Scale',
            description: 'AI crafts hyper-personalized emails, messages, and LinkedIn content for every lead using CRM data and behavioral signals.',
            icon: MessageCircle,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Multi-Channel Sequencing',
            description: 'Automate and coordinate outreach across email, phone, SMS, LinkedIn, and chat for maximum engagement.',
            icon: Globe,
            gradient: 'from-purple-500 to-pink-500'
        },
        {
            title: 'AI-Powered Lead Scoring',
            description: 'Instantly prioritize leads based on intent, engagement, and fit using predictive analytics.',
            icon: BarChart3,
            gradient: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Conversation Insights',
            description: 'Analyze prospect replies in real time, detect buying signals, and suggest next best actions.',
            icon: Brain,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: 'Automated Follow-ups',
            description: 'Never miss a touchpoint. AI schedules and delivers timely reminders and follow-up messages until a response.',
            icon: Clock,
            gradient: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'CRM & Tool Integrations',
            description: 'Works seamlessly with Salesforce, HubSpot, Outreach, Salesloft, and more.',
            icon: Database,
            gradient: 'from-pink-500 to-rose-500'
        },
        {
            title: 'Compliance & Security',
            description: 'GDPR/CCPA ready and includes enterprise-grade encryption for all prospect data.',
            icon: Shield,
            gradient: 'from-yellow-500 to-orange-500'
        },
        {
            title: 'Sales Agent Co-Pilot',
            description: 'Empower reps with AI-driven templates, objection handling, and real-time coaching.',
            icon: Users,
    ...
    const howItWorks = [
        {
            step: 1,
            title: 'Lead Captured',
            description: 'AI ingests leads from CRM, web forms, or list uploads and enriches with real-time data.',
            icon: Database,
        ...
        },
        {
            ...
            description: 'AI creates and sends tailored messages and multi-step sequences across preferred channels.',
            icon: MessageCircle,
        ...
        },
        {
            ...
            description: 'Prospect replies are analyzed, scored, and routed to sales reps or further automated journeys.',
            icon: Brain,
        ...
        },
        {
            ...
            description: 'Closed deals and responses are logged, and AI refines tactics based on outcomes.',
            icon: BarChart3,
    ...
    const integrations = [
        ...
        { name: 'Outreach', category: 'Sales Engagement', logo: '🚀' },
        { name: 'Salesloft', category: 'Sales Engagement', logo: '🛎️' },
        { name: 'LinkedIn', category: 'Social', logo: '🔗' },
        ...
        { name: 'ZoomInfo', category: 'Data Enrichment', logo: '💡' },
        { name: 'Google Sheets', category: 'Spreadsheet', logo: '📄' },
        { name: 'Zapier', category: 'Automation', logo: '⚡' },
        { name: 'Calendly', category: 'Scheduling', logo: '📆' },
        { name: 'Pipedrive', category: 'CRM', logo: '📊' },
        { name: 'Intercom', category: 'Chat', logo: '🔔' },
    ];

    const channels = [
        { name: 'Email', icon: Mail, description: 'Automated and personalized email outreach' },
        { name: 'Phone & SMS', icon: Phone, description: 'Integrated click-to-call and SMS sequences' },
        { name: 'LinkedIn', icon: Globe, description: 'LinkedIn InMail and connection requests' },
        { name: 'Live Chat', icon: MessageCircle, description: 'Real-time web and in-app chat' }
    ];

    const benefits = [
        {
            title: 'Increase Pipeline',
            description: 'Fill your pipeline faster with more meetings and qualified leads.',
            percentage: '+3.2x',
            metric: 'pipeline growth'
        },
        {
            title: 'Boost Response Rates',
            description: 'AI-personalized content increases prospect engagement and replies.',
            percentage: '+52%',
            metric: 'reply rate'
        },
        {
            title: 'Close More Deals',
            description: 'Stay top-of-mind and nurture until conversion with automated follow-ups.',
            percentage: '+31%',
            metric: 'conversion rate'
        },
        {
            title: 'Save Rep Time',
            description: 'Automate admin, research, and repetitive messaging so sales can focus on closing.',
            percentage: '-68%',
            metric: 'manual effort'
        },
        {
            title: 'Consistent Messaging',
            description: 'Ensure every prospect gets a compliant, on-brand experience across all channels.',
            percentage: '100%',
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Supercharge your sales process with AI that <span className="text-white font-medium">personalizes, sequences, and analyzes every outreach</span>—across every channel. More leads, higher conversions, less manual work.
                    </div>
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            ...
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">Sales Outreach AI Agent</h3>
                                ...
                                <div className="flex items-center gap-4">
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-emerald-400">67%</div>
                                        <div className="text-xs text-slate-400">Response Rate</div>
                                    </div>
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-blue-400">12x</div>
                                        <div className="text-xs text-slate-400">Touchpoints</div>
                                    </div>
                                </div>
                            </div>
                            {/* Chat Interface */}
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3 animate-slideInLeft">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Hi, can you help me find a solution for my sales team’s workflow?</span>
                                        <span className="text-xs text-slate-400 mt-1 block">9:14 AM</span>
                                    </div>
                                </div>
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '0.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Absolutely! Based on your company’s profile, here’s a tailored proposal and a calendar link to schedule a demo.</span>
                                        <span className="text-xs text-blue-100 mt-1 block">9:14 AM</span>
                                    </div>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Thanks! Can you also send me some customer success stories?</span>
                                ...
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '1.2s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Here are three case studies from your industry. Would you like to connect with a reference client?</span>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> modern sales outreach</span>
                        </h2>
                    </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('benefits') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> AI outreach</span>
                        </h2>
                    </div>
            ...
            <section id="capabilities" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            AI that adapts to every prospect
                            <span className="bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent"> and every deal</span>
                        </h2>
                    </div>
                            ...
                            <div className="relative">
                                ...
                                <div className="relative w-80 h-80 mx-auto">
                                    ...
                                    {[
                                        ...
                                        { label: 'Sequencing', angle: 60, color: 'from-emerald-500 to-teal-500' },
                                        { label: 'Lead Score', angle: 120, color: 'from-orange-500 to-red-500' },
                            ...
                            {[
                                {
                                    ...
                                    description: 'Reads and writes like a human, personalizing every touchpoint for each prospect.',
                                    icon: MessageCircle,
                                    color: 'from-blue-500 to-cyan-500'
                                },
                                {
                                    title: 'Sequenced Automation',
                                    description: 'Builds multi-step, multi-channel outreach flows tailored to each buyer’s journey.',
                                    icon: Cpu,
                                    color: 'from-emerald-500 to-teal-500'
                                },
                                {
                                    title: 'Predictive Lead Scoring',
                                    description: 'Ranks and prioritizes leads based on intent, engagement, and fit.',
                                    icon: BarChart3,
                                    color: 'from-orange-500 to-red-500'
                                },
                                {
                                    title: 'Real-Time Analytics',
                                    description: 'Monitors every campaign and suggests improvements for better results.',
                                    icon: Brain,
                                    color: 'from-purple-500 to-pink-500'
                                },
                                {
                                    title: 'Compliance & Security',
                                    description: 'Enterprise-grade encryption and privacy compliance for all outreach.',
                                    icon: Shield,
                                    color: 'from-indigo-500 to-purple-500'
                                },
                                {
                                    title: 'CRM & Tool Integrations',
                                    description: 'Works with all major sales, CRM, and communication platforms.',
                                    icon: Database,
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Get up and running with expert onboarding, dedicated support, and proven outreach templates. Book a demo and start closing more deals—faster.
                        </p>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-8 border-t border-slate-700/50">
                            {[
                                ...
                                { label: 'Support', value: '24/7 Sales Experts' }
                            ].map((item, index) => (
