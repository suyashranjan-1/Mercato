...
import { MessageCircle, Clock, Users, Star, CheckCircle, ArrowRight, Bot, Headphones, Shield, Zap, BarChart3, Globe, Play, ChevronRight, Brain, Cpu, Database, Settings, Mail, Smartphone } from 'lucide-react';
import { NavbarDemo } from "@/components/navbar";
import Footer from "@/components/Footer";
import Link from 'next/link';

export default function CustomNlpAIAgent() {
    ...
    const stats = [
        { label: 'NLP Accuracy', value: '98.7%', icon: Star, color: 'from-blue-500 to-cyan-500' },
        { label: 'Languages Supported', value: '45+', icon: Globe, color: 'from-indigo-500 to-purple-500' },
        { label: 'Real-Time Processing', value: '<2s', icon: Clock, color: 'from-emerald-500 to-teal-500' },
        { label: 'Text Data Handled', value: '1B+', icon: Database, color: 'from-rose-500 to-pink-500' },
    ];

    const features = [
        {
            title: 'Custom Text Classification',
            description: 'Train, deploy, and monitor models for sentiment, intent, and topic detection suited for your business.',
            icon: Brain,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Entity Recognition',
            description: 'Identify names, places, products, and custom entities from unstructured text.',
            icon: Database,
            gradient: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Semantic Search',
            description: 'Search documents, chats, and emails with advanced semantic understanding.',
            icon: BarChart3,
            gradient: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Multilingual NLP',
            description: 'Process and analyze conversations in over 45 languages with consistent accuracy.',
            icon: Globe,
            gradient: 'from-pink-500 to-rose-500'
        },
        {
            title: 'Intent Detection',
            description: 'Recognize user intentions in real-time for smart routing and automation.',
            icon: MessageCircle,
            gradient: 'from-yellow-500 to-orange-500'
        },
        {
            title: 'Custom Model Training',
            description: 'Fine-tune models on your domain data for industry-leading performance.',
            icon: Cpu,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: 'Secure & Compliant',
            description: 'GDPR-ready, encrypted at rest and in transit, with audit trails for every API call.',
            icon: Shield,
            gradient: 'from-green-500 to-blue-500'
        },
        {
            title: 'API & Platform Integration',
            description: 'Connect with your SaaS stack for automated text workflows and analytics.',
            icon: Settings,
    ...
    const howItWorks = [
        {
            ...
            description: 'Import data from emails, chats, documents, or live streams.',
            icon: Database,
        ...
        },
        {
            ...
            description: 'Custom and pre-trained models analyze and extract meaning in real time.',
            icon: Brain,
        ...
        },
        {
            ...
            description: 'Extract actionable insights—sentiment, entities, intent, and more.',
            icon: BarChart3,
        ...
        },
        {
            ...
            description: 'Trigger automations, route messages, or visualize results in dashboards.',
            icon: Settings,
    ...
    const channels = [
        { name: 'Web Dashboard', icon: BarChart3, description: 'Analyze and monitor your NLP models' },
        { name: 'API Access', icon: Settings, description: 'Integrate directly into your applications' },
        { name: 'Email Parsing', icon: Mail, description: 'Extract and process information from emails' },
        { name: 'Mobile App', icon: Smartphone, description: 'Run analyses and get alerts on the go' }
    ];

    const benefits = [
        {
            title: 'Boost Productivity',
            description: 'Automate text-heavy tasks and reduce manual review by up to 80%.',
            percentage: '80%',
            metric: 'less manual work'
        },
        {
            title: 'Accelerate Insights',
            description: 'Get real-time, actionable analytics from every conversation and document.',
            percentage: '15x',
            metric: 'faster insights'
        },
        {
            title: 'Increase Accuracy',
            description: 'Custom training delivers state-of-the-art precision on your unique data.',
            percentage: '98.7%',
            metric: 'NLP accuracy'
        },
        {
            title: 'Scale Effortlessly',
            description: 'Handle millions of messages daily across languages, platforms, and teams.',
            percentage: '1B+',
            metric: 'text processed'
        },
        {
            title: 'Enhance Customer Experience',
            description: 'Respond to customers faster and more intelligently—across every channel.',
            percentage: '90%',
            metric: 'better CX'
        }
    ];

    // AI Capabilities for the animated "brain"
    const capabilities = [
        { label: 'Intent', angle: 0, color: 'from-blue-500 to-cyan-500' },
        { label: 'Entities', angle: 60, color: 'from-indigo-500 to-purple-500' },
        { label: 'Sentiment', angle: 120, color: 'from-yellow-500 to-orange-500' },
        { label: 'Multilingual', angle: 180, color: 'from-pink-500 to-rose-500' },
        { label: 'Search', angle: 240, color: 'from-emerald-500 to-teal-500' },
        { label: 'Automation', angle: 300, color: 'from-orange-500 to-red-500' }
    ];

    const capabilityList = [
        {
            title: 'Intent Detection',
            description: 'Understand what users want—route, respond, or automate actions based on intent.',
            icon: MessageCircle,
            color: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Entity Extraction',
            description: 'Identify key terms, people, places, and custom data in every message.',
            icon: Database,
            color: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Sentiment Analysis',
            description: 'Know how your customers feel with real-time emotion and opinion mining.',
            icon: Star,
            color: 'from-yellow-500 to-orange-500'
        },
        {
            title: 'Multilingual NLP',
            description: 'Analyze and respond across global markets in 45+ languages.',
            icon: Globe,
            color: 'from-pink-500 to-rose-500'
        },
        {
            title: 'Semantic Search',
            description: 'Go beyond keywords to understand meaning and context in search.',
            icon: BarChart3,
            color: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Workflow Automation',
            description: 'Trigger downstream actions, alerts, and integrations from NLP outputs.',
            icon: Zap,
            color: 'from-orange-500 to-red-500'
        }
    ];
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Unlock actionable insights from your text data with advanced NLP tailored to your business. <span className="text-white font-medium">Automate, analyze, and accelerate</span> your operations using the power of language AI.
                    </div>
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            ...
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">NLP AI Agent</h3>
                                        <div className="text-slate-400 text-sm flex items-center gap-2">
                                            <div className="w-2 h-2 bg-emerald-400 rounded-full animate-ping"></div>
                                            Online • Processing Language
                                        </div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4">
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-emerald-400">98.7%</div>
                                        <div className="text-xs text-slate-400">NLP Accuracy</div>
                                    </div>
                                    <div className="text-right">
                            ...
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3 animate-slideInLeft">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Can you analyze the sentiment in all our customer emails from last week?</span>
                                ...
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '0.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Sentiment analysis complete: 76% positive, 18% neutral, 6% negative. Would you like a keyword cloud or export?</span>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Export as CSV and alert the product team about negative trends.</span>
                            ...
                            <div className="flex gap-3 justify-end">
                                <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 rounded-2xl p-3 border border-blue-500/30">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-xs text-blue-300">NLP Agent is processing...</span>
                                    </div>
                                </div>
                                <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center">
                                    <Bot className="w-4 h-4 text-white" />
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('how-it-works') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            From raw text to
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> actionable insight</span>
                        </h2>
                    </div>
                    <div className="relative">
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> language intelligence</span>
                        </h2>
                    </div>
            ...
            <section id="benefits" className="py-16 sm:py-24 lg:py-32 px-4 bg-gradient-to-br from-slate-900/50 to-slate-800/30">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('benefits') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Transform how you
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> understand language</span>
                        </h2>
                    </div>
            ...
            <section id="capabilities" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Next-gen AI for
                            <span className="bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent"> language understanding</span>
                        </h2>
                    </div>
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 sm:mb-8 leading-tight">
                            Start building with
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> NLP AI today</span>
                        </h2>
                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Bring language intelligence to your business and get a custom demo from our NLP experts. Experience the future of text analytics, now.
                        </p>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-8 border-t border-slate-700/50">
                            {[
                                { label: 'Data Privacy', value: 'GDPR Ready' },
                                { label: 'Setup Time', value: '< 5 Days' },
                                { label: 'Custom Models', value: 'Domain Trained' },
                                { label: 'Support', value: 'NLP Experts' }
                            ].map((item, index) => (
