...
export default function LegalDocumentClassifierAIAgent() {
    ...
    // Stats for Legal Document Classifier AI Agent
    const stats = [
        { label: 'Avg Classification Time', value: '<2s', icon: Clock, color: 'from-blue-500 to-cyan-500' },
        { label: 'Classification Accuracy', value: '99.7%', icon: Star, color: 'from-yellow-500 to-orange-500' },
        { label: 'Documents Classified Daily', value: '250K+', icon: CheckCircle, color: 'from-emerald-500 to-teal-500' },
        { label: 'System Uptime', value: '99.999%', icon: Zap, color: 'from-purple-500 to-pink-500' },
    ];

    const features = [
        {
            title: 'Automated Legal Document Classification',
            description: 'Instantly classifies contracts, NDAs, briefs, court orders, policies, patents, and more using advanced AI models.',
            icon: FileText,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Multi-Class & Multi-Label Support',
            description: 'Assigns multiple relevant categories and tags to each legal document for granular sorting and search.',
            icon: BarChart3,
            gradient: 'from-purple-500 to-pink-500'
        },
        {
            title: 'Jurisdiction & Entity Detection',
            description: 'Detects jurisdictions, parties, and legal entities for fast routing and compliance checks.',
            icon: Globe,
            gradient: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Sensitive Data & PII Flagging',
            description: 'Automatically flags documents containing sensitive, confidential, or regulated information.',
            icon: Shield,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: 'Integration Ready',
            description: 'Works with DMS, CLM, eDiscovery, and law firm management platforms.',
            icon: Database,
            gradient: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Explainable AI',
            description: 'Each decision is accompanied by a rationale and confidence score for auditability.',
            icon: Brain,
            gradient: 'from-pink-500 to-rose-500'
        },
        {
            title: 'Bulk & Real-time Processing',
            description: 'Handles individual uploads or batch classification for thousands of documents at once.',
            icon: Cpu,
            gradient: 'from-yellow-500 to-orange-500'
        },
        {
            title: 'Advanced Search & Reporting',
            description: 'Enables efficient legal research, compliance checks, and trend analysis.',
            icon: BarChart3,
    ...
    const howItWorks = [
        {
            ...
            description: 'Upload files or sync from your DMS, email, or cloud storage.',
            icon: FileText,
        ...
        },
        {
            ...
            description: 'AI analyzes content, context, and metadata to classify document type and assign legal tags.',
            icon: Brain,
            color: 'from-purple-500 to-pink-500'
        },
        {
            step: 3,
            title: 'Jurisdiction & Risk Detection',
            description: 'Detects jurisdiction, involved entities, and sensitive data for compliance and routing.',
            icon: Globe,
        ...
        },
        {
            ...
            description: 'Classified documents are routed to downstream platforms; analytics and audit reports generated.',
            icon: BarChart3,
    ...
    const integrations = [
        ...
        { name: 'Relativity', category: 'eDiscovery', logo: '🔎' },
        ...
        { name: 'Litify', category: 'Legal', logo: '⚖️' },
        { name: 'Clio', category: 'Legal', logo: '📚' },
        { name: 'OneDrive', category: 'Storage', logo: '☁️' },
        { name: 'AWS S3', category: 'Cloud', logo: '☁️' },
    ];

    const channels = [
        { name: 'Web Dashboard', icon: Globe, description: 'Classify and search documents online' },
        { name: 'Email Ingestion', icon: Mail, description: 'Classify documents received by email' },
        { name: 'Mobile App', icon: Smartphone, description: 'Classify and review documents on mobile' },
        { name: 'DMS Integration', icon: Database, description: 'Classify documents directly from your DMS or storage' }
    ];

    const benefits = [
        {
            title: 'Accelerate Legal Workflows',
            description: 'Instantly sort and route legal documents for review, approval, or compliance.',
            percentage: '95%',
            metric: 'cycle time reduction'
        },
        {
            title: 'Improve Research & Compliance',
            description: 'Enable lightning-fast legal research and ensure nothing slips through the cracks.',
            percentage: '99.7%',
            metric: 'classification accuracy'
        },
        {
            title: 'Reduce Manual Review Time',
            description: 'Eliminate hours of manual sorting, tagging, and risk checks.',
            percentage: '80%',
            metric: 'manual effort saved'
        },
        {
            title: 'Enhance Security & Privacy',
            description: 'Detect and respond to sensitive content with robust audit trails.',
            percentage: '100%',
            metric: 'security coverage'
        },
        {
            title: 'Full Auditability & Reporting',
            description: 'Every decision and action is logged for effortless audits and compliance.',
            percentage: '100%',
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Instantly classify, tag, and route legal documents with AI. Enhance compliance, search, and workflow automation for law firms, corporate legal, and compliance teams.
                    </div>
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">Legal Document Classifier AI Agent</h3>
                                        <div className="text-slate-400 text-sm flex items-center gap-2">
                                            <div className="w-2 h-2 bg-emerald-400 rounded-full animate-ping"></div>
                                            Online • Classifying instantly
                                        </div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="text-right">
                                        ...
                                        <div className="text-xs text-slate-400">Avg Classification</div>
                                    </div>
                                </div>
                            </div>
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3 animate-slideInLeft">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Classify this document: "2025-05-Contract-ACME.pdf". Is it an NDA, Service Agreement, or something else?</span>
                                ...
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '0.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Classified as "Service Agreement" (confidence 98%). Jurisdiction: New York. Sensitive PII detected and flagged. Ready for DMS routing.</span>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Show me all employment contracts with GDPR-sensitive content.</span>
                            ...
                            <div className="flex gap-3 justify-end">
                                <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 rounded-2xl p-3 border border-blue-500/30">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-xs text-blue-300">AI is classifying...</span>
                                    </div>
                                </div>
                                <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center">
                                    <Bot className="w-4 h-4 text-white" />
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('how-it-works') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            From upload to classification in
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> legal document automation</span>
                        </h2>
                    </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('channels') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-blue-400 to-cyan-600 bg-clip-text text-transparent"> legal document sources</span>
                        </h2>
                    </div>
            ...
            <section id="benefits" className="py-16 sm:py-24 lg:py-32 px-4 bg-gradient-to-br from-slate-900/50 to-slate-800/30">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('benefits') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Instantly classify and route every legal document
            ...
            <section id="capabilities" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Advanced AI for
                            <span className="bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent"> legal document intelligence</span>
                        </h2>
                    </div>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div className={`relative transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
                            <div className="relative">
                                <div className="relative w-80 h-80 mx-auto">
                                    ...
                                    {[
                                        { label: 'Multi-Class', angle: 0, color: 'from-blue-500 to-cyan-500' },
                                        { label: 'PII', angle: 60, color: 'from-emerald-500 to-teal-500' },
                                        { label: 'Jurisdiction', angle: 120, color: 'from-orange-500 to-red-500' },
                                        { label: 'Bulk', angle: 180, color: 'from-purple-500 to-pink-500' },
                        ...
                        <div className={`space-y-8 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
                            {[
                                {
                                    title: 'Multi-Class & Multi-Label AI',
                                    description: 'Classifies by type, purpose, parties, jurisdiction, and more.',
                                    icon: BarChart3,
                                    color: 'from-blue-500 to-cyan-500'
                                },
                                {
                                    title: 'Sensitive Data Detection',
                                    description: 'Flags PII, confidential, and regulated data for compliance.',
                                    icon: Shield,
                                    color: 'from-purple-500 to-pink-500'
                                },
                                {
                                    title: 'Jurisdiction & Entity Recognition',
                                    description: 'Detects court, country, state, and named entities in legal docs.',
                                    icon: Globe,
                                    color: 'from-emerald-500 to-teal-500'
                                },
                                {
                                    title: 'Bulk & Real-time Processing',
                                    description: 'Scales from single uploads to thousands of docs per minute.',
                                    icon: Cpu,
                                    color: 'from-orange-500 to-red-500'
                                },
                                {
                                    title: 'Auditability & Security',
                                    description: 'Every decision and document is logged and protected with AES-256 encryption.',
                                    icon: Shield,
                                    color: 'from-yellow-500 to-orange-500'
                                },
                                {
                                    title: 'Integrates Everywhere',
                                    description: 'API-first and pre-built connectors for DMS, CLM, eDiscovery, and cloud.',
                                    icon: Database,
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 sm:mb-8 leading-tight">
                            Start classifying legal documents
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> automatically</span>
                        </h2>
                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Join law firms, legal ops, and enterprises using AI for instant, accurate legal document classification and compliance. Get started in minutes with a free trial.
                        </p>
