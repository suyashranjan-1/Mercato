...
import { Bot, Globe, Zap, BarChart3, Database, MessageCircle, Settings, Cpu, Shield, Play, ArrowRight, ChevronRight, Users, Clock, Star, CheckCircle, Headphones, Smartphone, Mail, Phone, MessageSquare, Brain } from 'lucide-react';
import { NavbarDemo } from "@/components/navbar";
import Footer from "@/components/Footer";

export default function DatabaseQueryAIAgent() {
    ...
    // Stats for Database Query AI Agent
    const stats = [
        { label: 'Query Response Time', value: '<0.5s', icon: Clock, color: 'from-blue-500 to-cyan-500' },
        { label: 'Query Accuracy', value: '99.9%', icon: Star, color: 'from-yellow-500 to-orange-500' },
        { label: 'Supported DB Types', value: '15+', icon: Database, color: 'from-emerald-500 to-teal-500' },
        { label: 'System Uptime', value: '99.99%', icon: Zap, color: 'from-purple-500 to-pink-500' },
    ];

    // Features for Database Query AI Agent
    const features = [
        {
            title: 'Natural Language to SQL',
            description: 'Transform plain English requests into SQL/NoSQL queries for any supported database engine.',
            icon: Cpu,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Multi-Database Support',
            description: 'Query MySQL, PostgreSQL, MongoDB, Oracle, SQL Server, SQLite, BigQuery, and more from one interface.',
            icon: Database,
            gradient: 'from-purple-500 to-pink-500'
        },
        {
            title: 'Instant Data Insights',
            description: 'Get summaries, aggregations, and visualizations for your business questions instantly.',
            icon: BarChart3,
            gradient: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Secure Credential Handling',
            description: 'Encrypted storage and transmission of database credentials. Supports role-based access.',
            icon: Shield,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: 'Query Optimization',
            description: 'Suggests and rewrites queries for optimal performance and resource usage.',
            icon: Zap,
            gradient: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Visual Query Builder',
            description: 'Drag-and-drop interface to build and preview even complex queries without coding.',
            icon: Settings,
            gradient: 'from-pink-500 to-rose-500'
        },
        {
            title: 'Scheduled Reports & Alerts',
            description: 'Automate repeated queries and get notified on data changes or anomalies.',
            icon: Mail,
            gradient: 'from-rose-500 to-pink-500'
        },
        {
            title: 'Export & Integration',
            description: 'Export results to CSV, Excel, Google Sheets, or push directly to your BI tools.',
            icon: Globe,
            gradient: 'from-amber-500 to-orange-500'
        }
    ];

    // How It Works for Database Query AI Agent
    const howItWorks = [
        {
            step: 1,
            title: 'Connect Your Database',
            description: 'Securely connect to your on-prem or cloud database using credentials or OAuth.',
            icon: Database,
        ...
        },
        {
            ...
            description: 'Describe your data question in natural language—no need to know SQL or schema.',
            icon: MessageSquare,
            color: 'from-purple-500 to-pink-500'
        },
        {
            step: 3,
            title: 'AI Builds the Query',
            description: 'AI understands your intent, crafts the optimal query, and runs it safely.',
            icon: Cpu,
        ...
        },
        {
            ...
            description: 'Instantly view answers, charts, or export data—repeat or schedule with one click.',
            icon: BarChart3,
            color: 'from-orange-500 to-red-500'
        }
    ];

    // Integrations for Database Query
    const integrations = [
        { name: 'MySQL', category: 'SQL', logo: '🟦' },
        { name: 'PostgreSQL', category: 'SQL', logo: '🐘' },
        { name: 'MongoDB', category: 'NoSQL', logo: '🍃' },
        { name: 'Oracle', category: 'SQL', logo: '🟠' },
        { name: 'SQL Server', category: 'SQL', logo: '🔷' },
        { name: 'SQLite', category: 'SQL', logo: '💾' },
        { name: 'BigQuery', category: 'Cloud', logo: '☁️' },
        { name: 'Snowflake', category: 'Cloud', logo: '❄️' },
        { name: 'Redshift', category: 'Cloud', logo: '🟥' },
        { name: 'Elasticsearch', category: 'Search', logo: '🔎' },
        { name: 'Google Sheets', category: 'Spreadsheet', logo: '📄' },
        { name: 'Airtable', category: 'Spreadsheet', logo: '📊' },
        { name: 'Zapier', category: 'Automation', logo: '⚡' },
        { name: 'Looker', category: 'BI', logo: '🧑‍💻' },
        { name: 'Power BI', category: 'BI', logo: '📈' },
        { name: 'Tableau', category: 'BI', logo: '📊' },
    ];

    // Channels for Database Query
    const channels = [
        { name: 'Web Dashboard', icon: Globe, description: 'Query and visualize data from your browser' },
        { name: 'API Access', icon: Settings, description: 'Run queries and fetch results programmatically' },
        { name: 'Email Reports', icon: Mail, description: 'Receive scheduled query results in your inbox' },
        { name: 'Mobile App', icon: Smartphone, description: 'Access, query, and monitor from anywhere' }
    ];

    // Benefits for Database Query
    const benefits = [
        {
            title: 'Query Faster',
            description: 'Get answers from your data warehouse in less than a second—no waiting, no bottlenecks.',
            percentage: '99%',
            metric: 'faster data access'
        },
        {
            title: 'Empower Everyone',
            description: 'Make your data team, ops, and business users self-serve with AI-powered querying.',
            percentage: '5x',
            metric: 'team productivity'
        },
        {
            title: 'Reduce Errors',
            description: 'AI validation and query preview help prevent costly mistakes and data leaks.',
            percentage: '90%',
            metric: 'fewer errors'
        },
        {
            title: 'Save Engineering Time',
            description: 'Free up developers to focus on building, not writing queries for others.',
            percentage: '60%',
            metric: 'engineering savings'
        },
        {
            title: 'Enhance Security',
            description: 'Granular permissions, audit trails, and data masking protect sensitive information.',
            percentage: '100%',
            metric: 'data security'
        }
    ];

    // Capabilities for Database Query
    const capabilities = [
        {
            title: 'Multi-Model Querying',
            description: 'Supports SQL, NoSQL, time-series, and cloud databases in a single interface.',
            icon: Database,
            color: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Natural Language Understanding',
            description: 'AI comprehends complex business questions and generates safe, optimal queries.',
            icon: Brain,
            color: 'from-purple-500 to-pink-500'
        },
        {
            title: 'Data Visualization',
            description: 'Instantly turn raw data into charts and dashboards for deeper insights.',
            icon: BarChart3,
            color: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Query Scheduling',
            description: 'Automate recurring queries and receive reports at your chosen frequency.',
            icon: Settings,
            color: 'from-orange-500 to-red-500'
        },
        {
            title: 'Role-Based Access',
            description: 'Enforce permissions and approvals for sensitive queries and exports.',
            icon: Shield,
            color: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Explain & Debug',
            description: 'Get AI-powered query explanations and step-by-step debugging assistance.',
            icon: Cpu,
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Query any database with natural language. AI translates your questions into efficient, secure queries—delivering instant answers, insights, and charts across your data sources.
                    </div>
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            ...
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">Database Query AI Agent</h3>
                                        <div className="text-slate-400 text-sm flex items-center gap-2">
                                            <div className="w-2 h-2 bg-emerald-400 rounded-full animate-ping"></div>
                                            Online • Querying instantly
                                        </div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4">
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-emerald-400">15+</div>
                                        <div className="text-xs text-slate-400">DB Types</div>
                                    </div>
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-blue-400">&lt; 0.5s</div>
                                        <div className="text-xs text-slate-400">Avg Query</div>
                                    </div>
                                </div>
                            </div>
                            {/* Chat Interface */}
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3 animate-slideInLeft">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Show me last month’s sales grouped by region from our PostgreSQL database.</span>
                                        <span className="text-xs text-slate-400 mt-1 block">09:01 AM</span>
                                    </div>
                                </div>
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '0.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Here’s the summary chart and export link. The query was optimized and completed in 0.4s.</span>
                                        <span className="text-xs text-blue-100 mt-1 block">09:01 AM</span>
                                    </div>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Can you automate this every Monday and send it to my inbox?</span>
                                        <span className="text-xs text-slate-400 mt-1 block">09:02 AM</span>
                                    </div>
                                </div>
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '1.2s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Done! You’ll receive the sales summary every Monday at 8AM.</span>
                                        <span className="text-xs text-blue-100 mt-1 block">09:02 AM</span>
                                    </div>
                                    <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center">
                                        <Bot className="w-4 h-4 text-white" />
                                    </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> effortless data querying</span>
                        </h2>
                    </div>
            ...
            <section id="channels" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('channels') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Connect to all your
                            <span className="bg-gradient-to-r from-blue-400 to-cyan-600 bg-clip-text text-transparent"> data sources</span>
                        </h2>
                    </div>
            ...
            <section id="capabilities" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Advanced AI for
                            <span className="bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent"> effortless data access</span>
                        </h2>
                    </div>
                        ...
                        <div className={`relative transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
                            <div className="relative">
                                ...
                                <div className="relative w-80 h-80 mx-auto">
                                    ...
                                    {[
                                        { label: 'SQL', angle: 0, color: 'from-blue-500 to-cyan-500' },
                                        { label: 'NoSQL', angle: 60, color: 'from-emerald-500 to-teal-500' },
                                        { label: 'BI', angle: 120, color: 'from-orange-500 to-red-500' },
                                        { label: 'NLP', angle: 180, color: 'from-purple-500 to-pink-500' },
                                        { label: 'API', angle: 240, color: 'from-yellow-500 to-orange-500' },
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Join organizations using AI to make data access fast, secure, and effortless. Try our Database Query AI Agent free and empower your team with instant answers.
                        </p>
                        {/* Trust Indicators */}
