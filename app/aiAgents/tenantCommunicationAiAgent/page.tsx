...
import { MessageCircle, Clock, Users, Star, CheckCircle, ArrowRight, Bot, Headphones, Shield, Zap, BarChart3, Globe, Play, ChevronRight, Brain, Cpu, Database, Settings, Phone, Mail, MessageSquare, Smartphone, Home, Building2, FileText, Calendar, Bell, Smile, KeyRound } from 'lucide-react';
...
export default function TenantCommunicationAIAgent() {
    ...
    const stats = [
        { label: 'Avg Message Response', value: '<10s', icon: Clock, color: 'from-blue-500 to-cyan-500' },
        { label: 'Tenant Satisfaction', value: '97%', icon: Star, color: 'from-yellow-500 to-orange-500' },
        { label: 'Requests Resolved', value: '89%', icon: CheckCircle, color: 'from-emerald-500 to-teal-500' },
    ...
    const features = [
        {
            ...
            description: 'Enable tenants to reach property managers anytime, anywhere with instant messaging and response.',
            icon: MessageCircle,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Automated Maintenance Requests',
            description: 'Tenants can submit and track maintenance needs, while AI automatically schedules and updates jobs.',
            icon: Settings,
            gradient: 'from-purple-500 to-pink-500'
        },
        {
            title: 'Payment Reminders & Receipts',
            description: 'Automate rent reminders, confirmations, and receipts directly to tenants via preferred channels.',
            icon: Bell,
            gradient: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Document Sharing',
            description: 'Securely share lease agreements, notices, and documents with tenants for easy access.',
            icon: FileText,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: '24/7 Emergency Support',
            description: 'AI agent triages urgent issues and connects tenants to emergency contacts when needed.',
            icon: Headphones,
            gradient: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Multilingual Support',
            description: 'Communicate with tenants in their preferred language for global accessibility.',
            icon: Globe,
            gradient: 'from-pink-500 to-rose-500'
        },
        {
            title: 'Feedback Collection',
            description: 'Gather tenant feedback after every interaction to improve service quality.',
            icon: Smile,
            gradient: 'from-rose-500 to-pink-500'
        },
        {
            title: 'Data Security',
            description: 'Protect sensitive tenant data with end-to-end encryption and compliance features.',
            icon: Shield,
    ...
    const howItWorks = [
        {
            ...
            description: 'Tenant sends a message, request, or question through any supported channel.',
            icon: MessageSquare,
        ...
        },
        {
            ...
            description: 'AI agent understands the inquiry, provides answers, or routes to the correct team or vendor.',
            icon: Brain,
        ...
        },
        {
            ...
            description: 'AI schedules maintenance, sends reminders, and keeps tenants updated in real time.',
            icon: Calendar,
        ...
        },
        {
            ...
            description: 'Issues are resolved efficiently, and tenants provide feedback for continual improvement.',
            icon: CheckCircle,
    ...
    const integrations = [
        { name: 'Buildium', category: 'Property Management', logo: '🏢' },
        ...
        { name: 'Dropbox', category: 'Documents', logo: '📁' },
        { name: 'AWS S3', category: 'Storage', logo: '☁️' },
    ];

    const channels = [
        { name: 'Tenant Portal', icon: Building2, description: 'Centralized portal for all tenant requests and communication' },
        { name: 'Email', icon: Mail, description: 'Automated email notifications and updates' },
        { name: 'SMS & WhatsApp', icon: Smartphone, description: 'Instant mobile alerts and conversations' },
        { name: 'Phone Support', icon: Phone, description: 'Voice-enabled AI for urgent issues' }
    ];

    const benefits = [
        {
            title: 'Reduce Response Time',
            description: 'Resolve tenant issues and answer questions instantly using AI-powered messaging.',
            percentage: '80%',
            metric: 'faster replies'
        },
        {
            title: 'Lower Operational Cost',
            description: 'Automate repetitive tasks, reminders, and updates, freeing up management time.',
            percentage: '45%',
            metric: 'cost savings'
        },
        {
            title: 'Boost Tenant Satisfaction',
            description: 'Deliver timely, accurate, and transparent communication that builds trust.',
            percentage: '95%',
            metric: 'positive feedback'
        },
        {
            title: '24/7 Availability',
            description: 'Assist tenants outside of business hours with AI that never sleeps.',
            percentage: '100%',
            metric: 'coverage'
        },
        {
            title: 'Secure Tenant Data',
            description: 'Ensure all communications and documents are protected and compliant.',
            percentage: 'AES-256',
            metric: 'encryption'
        }
    ];
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Revolutionize your property management and tenant support with AI that answers, resolves, and updates 24/7. Enhance satisfaction, automate requests, and ensure clear, secure communication.
                    </div>
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">Tenant AI Assistant</h3>
                                        <div className="text-slate-400 text-sm flex items-center gap-2">
                                            <div className="w-2 h-2 bg-emerald-400 rounded-full animate-ping"></div>
                                            Online • Responding to tenants
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3 animate-slideInLeft">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">My sink is leaking. Can I get a plumber today?</span>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Will I get a rent receipt for this month?</span>
                                ...
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '1.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Yes! Your receipt will be emailed to you as soon as your payment is processed.</span>
                                        <span className="text-xs text-blue-100 mt-1 block">11:03 AM</span>
                                    </div>
                                    <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center">
                                        <Bot className="w-4 h-4 text-white" />
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> tenant engagement</span>
                        </h2>
                    </div>
            ...
            <section id="channels" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('channels') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Communicate across all your
                            <span className="bg-gradient-to-r from-blue-400 to-cyan-600 bg-clip-text text-transparent"> tenant touchpoints</span>
                        </h2>
                    </div>
            ...
            <section id="benefits" className="py-16 sm:py-24 lg:py-32 px-4 bg-gradient-to-br from-slate-900/50 to-slate-800/30">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('benefits') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Deliver excellent tenant support
            ...
            <section id="capabilities" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Smart AI for modern
                            <span className="bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent"> property management</span>
                        </h2>
                    </div>
                            ...
                            <div className="relative">
                                <div className="relative w-80 h-80 mx-auto">
                                    ...
                                    {[
                                        ...
                                        { label: 'Task Automation', angle: 60, color: 'from-emerald-500 to-teal-500' },
                                        { label: 'Multilingual', angle: 120, color: 'from-orange-500 to-red-500' },
                            ...
                            {[
                                {
                                    ...
                                    description: 'Comprehends tenant intent and context in multiple languages for accurate support.',
                                    icon: MessageCircle,
                                    color: 'from-blue-500 to-cyan-500'
                                },
                                {
                                    title: 'Automated Task Management',
                                    description: 'Schedules, tracks, and updates all maintenance and administrative requests.',
                                    icon: Settings,
                                    color: 'from-purple-500 to-pink-500'
                                },
                                {
                                    title: 'Secure Document Handling',
                                    description: 'Safely shares, stores, and retrieves tenant documents with full compliance.',
                                    icon: FileText,
                                    color: 'from-emerald-500 to-teal-500'
                                },
                                {
                                    title: 'Real-time Analytics',
                                    description: 'Provides instant insights into communication trends and satisfaction.',
                                    icon: BarChart3,
                                    color: 'from-orange-500 to-red-500'
                                },
                                {
                                    title: 'Robust Data Security',
                                    description: 'Offers AES-256 encryption and GDPR/CCPA compliance for all data.',
                                    icon: Shield,
                                    color: 'from-indigo-500 to-purple-500'
                                },
                                {
                                    title: 'Easy Integration',
                                    description: 'Connects seamlessly with property management and communication platforms.',
                                    icon: Database,
            ...
            <section id="cta" className="py-16 sm:py-24 lg:py-32 px-4 bg-gradient-to-br from-slate-900/50 to-slate-800/30">
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        <div className="inline-flex items-center px-4 sm:px-6 py-2 mb-6 sm:mb-8 rounded-full border border-slate-700/50 bg-slate-800/30 backdrop-blur-sm text-xs sm:text-sm text-slate-300">
                            <Zap className="w-4 h-4 mr-2 text-emerald-400" />
                            Ready for Effortless Tenant Care?
                        </div>
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 sm:mb-8 leading-tight">
                            Modernize your
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> property management today</span>
                        </h2>
                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Join innovative property managers using AI to deliver exceptional tenant experiences. Activate in minutes and start communicating smarter.
                        </p>
                        {/* Trust Indicators */}
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-8 border-t border-slate-700/50">
                            {[
                                { label: 'Setup Time', value: '< 5 Days' },
                                { label: 'Cloud Security', value: 'AES-256' },
                                { label: 'Support Time', value: '24/7 Available' },
                                { label: 'Channels', value: 'All Devices' }
                            ].map((item, index) => (
