...
export default function TaskAutomationAIAgent() {
    ...
    const stats = [
        { label: 'Automation Speed', value: '<1s/task', icon: Clock, color: 'from-blue-500 to-cyan-500' },
        { label: 'Work Hours Saved', value: '100k+/mo', icon: Star, color: 'from-yellow-500 to-orange-500' },
        { label: 'Error Reduction', value: '95%', icon: CheckCircle, color: 'from-emerald-500 to-teal-500' },
    ...
    const features = [
        {
            ...
            description: 'Automate multi-step business processes, approvals, and routine tasks with zero code.',
            icon: Zap,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Multi-App Integration',
            description: 'Connects seamlessly with Slack, Gmail, Excel, CRM, databases, and 50+ apps.',
            icon: Globe,
            gradient: 'from-purple-500 to-pink-500'
        },
        {
            title: 'Smart Scheduling',
            description: 'Automatically executes tasks at the best times, with advanced scheduling and triggers.',
            icon: Clock,
            gradient: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Intelligent Data Handling',
            description: 'Extract, transform, and route data between platforms, files, and APIs instantly.',
            icon: Database,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: 'Custom Bot Actions',
            description: 'Create custom bots for notifications, reporting, reminders, and more.',
            icon: Bot,
            gradient: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Error Detection & Recovery',
            description: 'Automatic error detection, retries, and notifications for failed automations.',
            icon: Shield,
            gradient: 'from-pink-500 to-rose-500'
        },
        {
            title: 'Real-Time Analytics',
            description: 'Monitor automation runs, results, and efficiency with live dashboards.',
            icon: BarChart3,
            gradient: 'from-amber-500 to-orange-500'
        },
        {
            title: 'Enterprise Security',
            description: 'SOC2/ISO-compliant, encrypted, and fully auditable automation pipelines.',
            icon: Shield,
    ...
    const howItWorks = [
        {
            step: 1,
            title: 'Task Intake',
            description: 'User specifies or triggers a task, workflow, or routine to automate.',
            icon: MessageCircle,
            color: 'from-blue-500 to-cyan-500'
        },
        {
            step: 2,
            title: 'AI Process Understanding',
            description: 'AI analyzes the workflow, required data, and app connections.',
            icon: Brain,
        ...
        },
        {
            ...
            description: 'Bot orchestrates actions, integrates with tools, handles data, and manages exceptions.',
            icon: Cpu,
        ...
        },
        {
            ...
            description: 'Outcomes, logs, and analytics are delivered in real time for visibility and optimization.',
            icon: BarChart3,
    ...
    const integrations = [
        ...
        { name: 'Trello', category: 'Project Mgmt', logo: '📋' },
        ...
        { name: 'Notion', category: 'Knowledge', logo: '🗄️' },
    ...
    const channels = [
        { name: 'Web Dashboard', icon: MessageCircle, description: 'Manage automations from anywhere' },
        { name: 'Mobile App', icon: Smartphone, description: 'Automate and monitor tasks on the go' },
        { name: 'Email Triggers', icon: Mail, description: 'Start automations via email commands' },
        { name: 'Chat Commands', icon: Users, description: 'Trigger tasks using Slack, Teams, and more' }
    ];
    ...
    const benefits = [
        ...
        {
            title: 'Reduce Errors',
            description: 'Automated workflows minimize manual mistakes and rework.',
            percentage: '95%',
            metric: 'error reduction'
        },
        {
            title: 'Boost Productivity',
            description: 'Run hundreds of tasks in parallel, 24/7.',
            percentage: '10x',
            metric: 'productivity'
        },
        {
            title: 'Scale Operations',
            description: 'Automate across teams, departments, and processes without extra headcount.',
            percentage: '∞',
            metric: 'scalability'
        },
        {
            title: 'Secure Automation',
            description: 'Enterprise-grade security and full compliance for every workflow.',
            percentage: '100%',
            metric: 'compliance'
        }
    ];
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Automate any repetitive task, workflow, or routine. Save hours, reduce errors, and keep your business running 24/7 with AI-powered automation—integrated with all your favorite tools.
                    </div>
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">Task Automation AI Agent</h3>
                                        <div className="text-slate-400 text-sm flex items-center gap-2">
                                            <div className="w-2 h-2 bg-emerald-400 rounded-full animate-ping"></div>
                                            Online • Automating instantly
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3 animate-slideInLeft">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Please generate a summary report of all new leads from Salesforce and email it to the team every Friday.</span>
                                        <span className="text-xs text-slate-400 mt-1 block">08:10</span>
                                    </div>
                                </div>
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '0.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Task scheduled. Reports will be generated and emailed automatically every Friday at 9:00 AM.</span>
                                        <span className="text-xs text-blue-100 mt-1 block">08:10</span>
                                    </div>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Can you also send a Slack notification if the report contains more than 10 new leads?</span>
                                        <span className="text-xs text-slate-400 mt-1 block">08:11</span>
                                    </div>
                                </div>
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1.2s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">And upload the report to Google Drive.</span>
                                        <span className="text-xs text-slate-400 mt-1 block">08:11</span>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> end-to-end automation</span>
                        </h2>
                    </div>
            ...
            <section id="channels" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('channels') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Automate with all your
                            <span className="bg-gradient-to-r from-blue-400 to-cyan-600 bg-clip-text text-transparent"> business tools</span>
                        </h2>
                    </div>
            ...
            <section id="benefits" className="py-16 sm:py-24 lg:py-32 px-4 bg-gradient-to-br from-slate-900/50 to-slate-800/30">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('benefits') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Let AI handle the busywork and
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> scale your impact</span>
                        </h2>
                    </div>
            ...
            <section id="capabilities" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Advanced AI for
                            <span className="bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent"> business automation</span>
                        </h2>
                    </div>
                            ...
                            <div className="relative">
                                <div className="relative w-80 h-80 mx-auto">
                                    ...
                                    {[
                                        ...
                                        { label: 'RPA', angle: 60, color: 'from-emerald-500 to-teal-500' },
                                        ...
                                        { label: 'Workflow', angle: 300, color: 'from-indigo-500 to-purple-500' }
                                    ].map((node, index) => {
                            ...
                            {[
                                {
                                    ...
                                    description: 'Design workflows and triggers visually—no programming required.',
                                    icon: Cpu,
                                    color: 'from-blue-500 to-cyan-500'
                                },
                                {
                                    title: 'Natural Language Processing',
                                    description: 'Understand and execute written or spoken task instructions.',
                                    icon: Brain,
                                    color: 'from-purple-500 to-pink-500'
                                },
                                {
                                    title: 'Robotic Process Automation',
                                    description: 'Automate repetitive, rule-based computer tasks across apps.',
                                    icon: Cpu,
                                    color: 'from-emerald-500 to-teal-500'
                                },
                                {
                                    title: 'Instant Data Integration',
                                    description: 'Sync data between cloud, local, and legacy business systems.',
                                    icon: Database,
                                    color: 'from-orange-500 to-red-500'
                                },
                                {
                                    title: 'Real-Time Analytics',
                                    description: 'Visualize task flows, bottlenecks, and ROI in live dashboards.',
                                    icon: BarChart3,
                                    color: 'from-indigo-500 to-purple-500'
                                },
                                {
                                    title: 'Enterprise-Grade Security',
                                    description: 'SSL encryption, audit logs, and full compliance for peace of mind.',
                                    icon: Shield,
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Join industry leaders automating their business. Try it free—eliminate busywork, save time, and focus on what matters most.
                        </p>
