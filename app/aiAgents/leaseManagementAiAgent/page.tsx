...
import { FileText, Clock, Users, Star, CheckCircle, ArrowRight, Bot, Shield, Zap, BarChart3, Globe, Play, ChevronRight, Brain, Cpu, Database, Settings, Mail, MessageSquare, Smartphone, FolderOpen, Home, Calendar, Briefcase } from 'lucide-react';
import { NavbarDemo } from "@/components/navbar";
import Footer from "@/components/Footer";
import Link from 'next/link';

export default function LeaseManagementAIAgent() {
    ...
    const stats = [
        { label: 'Avg Lease Approval Time', value: '<2h', icon: Clock, color: 'from-blue-500 to-cyan-500' },
        { label: 'Active Leases Managed', value: '5000+', icon: Home, color: 'from-green-500 to-teal-500' },
        { label: 'Renewal Rate', value: '87%', icon: Star, color: 'from-yellow-500 to-orange-500' },
        { label: 'Automated Notifications', value: '99.9%', icon: Zap, color: 'from-purple-500 to-pink-500' },
    ];

    const features = [
        {
            title: 'Automated Lease Tracking',
            description: 'Track start, end, and renewal dates; receive proactive alerts for upcoming actions.',
            icon: Calendar,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Smart Document Management',
            description: 'Store, search, and auto-fill lease agreements, addenda, and tenant documents in one secure place.',
            icon: FolderOpen,
            gradient: 'from-purple-500 to-pink-500'
        },
        {
            title: 'Digital Signing & E-Verification',
            description: 'Integrate e-signature and digital ID verification for streamlined onboarding and renewals.',
            icon: FileText,
            gradient: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Automated Payment Reminders',
            description: 'Send rent reminders, late notices, and track payment status with real-time updates.',
            icon: Mail,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: 'Tenant & Owner Portal',
            description: 'Enable tenants and property owners to view lease info, make requests, and download docs anytime.',
            icon: Users,
            gradient: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Analytics & Reporting',
            description: 'Visualize occupancy, lease expirations, revenue, and compliance with customizable dashboards.',
            icon: BarChart3,
            gradient: 'from-pink-500 to-rose-500'
        },
        {
            title: 'AI-Powered Lease Insights',
            description: 'Leverage AI to flag risky clauses, extract obligations, and recommend negotiation points.',
            icon: Brain,
            gradient: 'from-rose-500 to-pink-500'
        },
        {
            title: 'Compliance & Security',
            description: 'SOC2, GDPR, and local housing law compliance with robust access controls and encrypted storage.',
            icon: Shield,
    ...
    const howItWorks = [
        {
            ...
            description: 'Input property, tenant, and terms; AI drafts agreement and pre-fills standard clauses.',
            icon: FileText,
            color: 'from-blue-500 to-cyan-500'
        },
        {
            step: 2,
            title: 'Digital Review & Signature',
            description: 'Both parties review, negotiate, and e-sign; platform verifies and archives the lease.',
            icon: Cpu,
        ...
        },
        {
            ...
            description: 'System tracks payments, renewals, and compliance; sends smart alerts for actions.',
            icon: Calendar,
        ...
        },
        {
            ...
            description: 'AI drafts renewal offers, analyzes trends, and generates compliance reports on demand.',
            icon: BarChart3,
    ...
    const channels = [
        { name: 'Web Dashboard', icon: Smartphone, description: 'Manage leases, payments, and notices from any device.' },
        { name: 'Email Notifications', icon: Mail, description: 'Automated updates to tenants and owners.' },
        { name: 'Tenant Portal', icon: Users, description: 'Self-serve access for tenants to view, download, and request.' },
        { name: 'API Integrations', icon: Cpu, description: 'Sync data with property, CRM, and accounting systems.' }
    ];

    const benefits = [
        {
            title: 'Reduce Admin Time',
            description: 'Automate manual lease processes, reminders, and document management.',
            percentage: '80%',
            metric: 'less admin work'
        },
        {
            title: 'Fewer Missed Renewals',
            description: 'AI tracks deadlines and sends renewal offers on time.',
            percentage: '95%',
            metric: 'renewal accuracy'
        },
        {
            title: 'Boost Tenant Satisfaction',
            description: 'Tenants and owners get instant access to all lease information and reminders.',
            percentage: '4.8★',
            metric: 'user rating'
        },
        {
            title: 'Improve Compliance',
            description: 'Automated clause checks and audit trails minimize legal risk.',
            percentage: '100%',
            metric: 'compliance'
        },
        {
            title: 'Increase Revenue',
            description: 'Fewer vacancies and late payments with AI-driven occupancy and payment tracking.',
            percentage: '22%',
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Automate every stage of your leasing lifecycle. Draft, negotiate, approve, and renew leases with AI—seamlessly, securely, and on time.
                    </div>
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            ...
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">Lease Management AI Agent</h3>
                                        <div className="text-slate-400 text-sm flex items-center gap-2">
                                            <div className="w-2 h-2 bg-emerald-400 rounded-full animate-ping"></div>
                                            Online • Managing instantly
                                        </div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4">
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-emerald-400">&lt;2h</div>
                                        <div className="text-xs text-slate-400">Avg Approval</div>
                                    </div>
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-blue-400">87%</div>
                                        <div className="text-xs text-slate-400">Renewal Rate</div>
                                    </div>
                                </div>
                            </div>
                            {/* Chat Interface */}
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3 animate-slideInLeft">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Is my lease up for renewal soon? Can I get a copy of the agreement?</span>
                                ...
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '0.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Your lease expires in 43 days. A renewal offer has been drafted and your agreement is available for download in your portal.</span>
                                        <span className="text-xs text-blue-100 mt-1 block">10:17 AM</span>
                                    </div>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Can I e-sign the renewal and set up auto-pay?</span>
                                        <span className="text-xs text-slate-400 mt-1 block">10:18 AM</span>
                                    </div>
                                </div>
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    <div className="w-8 h-8 bg-slate-700 rounded-full flex items-center justify-center">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Absolutely! E-signature and auto-pay setup available in your portal under “My Leases”.</span>
                                        <span className="text-xs text-slate-400 mt-1 block">10:18 AM</span>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('how-it-works') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Effortless lease management in
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> smarter leasing</span>
                        </h2>
                    </div>
            ...
            <section id="benefits" className="py-16 sm:py-24 lg:py-32 px-4 bg-gradient-to-br from-slate-900/50 to-slate-800/30">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('benefits') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Optimize and grow your portfolio
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> with AI leasing</span>
                        </h2>
                    </div>
            ...
            <section id="capabilities" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Smarter, safer, and faster leasing
                        ...
                        <div className={`relative transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
                            <div className="relative">
                                <div className="relative w-80 h-80 mx-auto">
                                    ...
                                    {[
                                        { label: 'Tracking', angle: 0, color: 'from-blue-500 to-cyan-500' },
                                        { label: 'E-Sign', angle: 60, color: 'from-emerald-500 to-teal-500' },
                                        { label: 'Notifications', angle: 120, color: 'from-orange-500 to-red-500' },
                                        { label: 'Compliance', angle: 180, color: 'from-purple-500 to-pink-500' },
                                        { label: 'Insights', angle: 240, color: 'from-yellow-500 to-orange-500' },
                            ...
                            {[
                                {
                                    ...
                                    description: 'Drafts, reviews, and suggests edits for lease agreements based on best practices.',
                                    icon: FileText,
                                    color: 'from-blue-500 to-cyan-500'
                                },
                                {
                                    title: 'E-Signature Integration',
                                    description: 'Complete agreements securely online with leading e-sign vendors.',
                                    icon: Briefcase,
                                    color: 'from-purple-500 to-pink-500'
                                },
                                {
                                    title: 'Automated Deadline Tracking',
                                    description: 'Never miss a payment, renewal, or compliance date.',
                                    icon: Calendar,
                                    color: 'from-emerald-500 to-teal-500'
                                },
                                {
                                    title: 'Compliance & Audit Logging',
                                    description: 'Every action is tracked and exportable for audits.',
                                    icon: Shield,
                                    color: 'from-orange-500 to-red-500'
                                },
                                {
                                    title: 'Smart Analytics',
                                    description: 'Real-time insights on occupancy, revenue, and risk factors.',
                                    icon: BarChart3,
                                    color: 'from-indigo-500 to-purple-500'
                                },
                                {
                                    title: 'Tenant & Owner Access',
                                    description: 'Role-based portals for tenants and property owners.',
                                    icon: Users,
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Join property managers and owners using AI to streamline, secure, and optimize every aspect of lease management. No software installation or credit card required.
                        </p>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-8 border-t border-slate-700/50">
                            {[
                                { label: 'Leases Managed', value: '5000+' },
