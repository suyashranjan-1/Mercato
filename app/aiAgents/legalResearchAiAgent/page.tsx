...
import { BookOpen, Clock, Users, Star, CheckCircle, ArrowRight, Bot, Shield, Zap, BarChart3, Globe, Play, ChevronRight, Brain, Cpu, Database, Settings, Mail, MessageSquare, Smartphone, FileText, Search } from 'lucide-react';
...
export default function LegalResearchAIAgent() {
    ...
    const stats = [
        { label: 'Avg Research Time', value: '<1 min', icon: Clock, color: 'from-blue-500 to-cyan-500' },
        { label: 'Case Law Coverage', value: '98%', icon: BookOpen, color: 'from-yellow-500 to-orange-500' },
        { label: 'Document Accuracy', value: '99.7%', icon: CheckCircle, color: 'from-emerald-500 to-teal-500' },
        { label: 'Jurisdiction Support', value: '50+', icon: Zap, color: 'from-purple-500 to-pink-500' },
    ];

    const features = [
        {
            title: 'Instant Legal Research',
            description: 'Get case law, statutes, and regulations in seconds. AI scans millions of legal documents in real-time.',
            icon: Search,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Automated Case Summaries',
            description: 'Receive concise, AI-generated summaries for any legal case or statute. Save hours of manual review.',
            icon: FileText,
            gradient: 'from-purple-500 to-pink-500'
        },
        {
            title: 'Jurisdictional Intelligence',
            description: 'Filter results by state, federal, or international law for precise, relevant answers.',
            icon: Globe,
            gradient: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Citations & Precedent Tracking',
            description: 'Automatic citation extraction and precedent mapping for every result.',
            icon: BookOpen,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: 'Collaboration Tools',
            description: 'Share findings, annotate, and build legal memos collaboratively within your team.',
            icon: Users,
            gradient: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Data Security & Compliance',
            description: 'Military-grade encryption and GDPR/HIPAA compliance for legal confidentiality.',
            icon: Shield,
            gradient: 'from-pink-500 to-rose-500'
        },
        {
            title: 'AI Drafting Assistant',
            description: 'Draft motions, contracts, and legal opinions with context-aware AI suggestions.',
            icon: Cpu,
            gradient: 'from-rose-500 to-pink-500'
        },
        {
            title: 'Real-Time Legal Updates',
            description: 'Stay ahead with instant alerts on new cases, statutes, and changes in law.',
            icon: Zap,
    ...
    const howItWorks = [
        {
            step: 1,
            title: 'Legal Query Submission',
            description: 'Input your legal question, case citation, or statute in plain English.',
            icon: MessageSquare,
        ...
        },
        {
            ...
            description: 'AI parses and interprets your request, searching databases, court opinions, and statutes.',
            icon: Brain,
            color: 'from-purple-500 to-pink-500'
        },
        {
            step: 3,
            title: 'Relevant Document Delivery',
            description: 'Instantly receive the most relevant cases, laws, and secondary sources with context.',
            icon: BookOpen,
        ...
        },
        {
            ...
            description: 'Download summaries, citations, or full documents and integrate findings into your workflow.',
            icon: Database,
    ...
    const integrations = [
        { name: 'Westlaw', category: 'Legal Database', logo: '⚖️' },
        { name: 'LexisNexis', category: 'Legal Database', logo: '📚' },
        { name: 'PACER', category: 'Federal Courts', logo: '🏛️' },
        { name: 'Fastcase', category: 'Legal Database', logo: '🗄️' },
        { name: 'Clio', category: 'Practice Mgmt', logo: '📋' },
        { name: 'Dropbox', category: 'Docs', logo: '📁' },
        { name: 'Google Drive', category: 'Docs', logo: '☁️' },
        { name: 'Slack', category: 'Collaboration', logo: '💬' },
        { name: 'Microsoft Teams', category: 'Collaboration', logo: '👥' },
        { name: 'OneDrive', category: 'Docs', logo: '💾' },
        { name: 'Notion', category: 'Knowledge Base', logo: '📝' },
        { name: 'Outlook', category: 'Email', logo: '✉️' },
        { name: 'Gmail', category: 'Email', logo: '📧' },
        { name: 'Jira', category: 'Project Mgmt', logo: '📊' },
        { name: 'Evernote', category: 'Notes', logo: '🗒️' },
        { name: 'Trello', category: 'Project Mgmt', logo: '🗂️' },
    ];

    const channels = [
        { name: 'Web Dashboard', icon: Smartphone, description: 'Access from any device, anywhere, anytime' },
        { name: 'Email Reports', icon: Mail, description: 'Get research results and alerts in your inbox' },
        { name: 'Collaborative Sharing', icon: Users, description: 'Share findings with your team instantly' },
        { name: 'Secure Export', icon: FileText, description: 'Export documents, citations, and summaries securely' }
    ];

    const benefits = [
        {
            title: 'Accelerate Legal Research',
            description: 'Reduce research time from hours to seconds. Never miss a precedent or update.',
            percentage: '15x',
            metric: 'faster research'
        },
        {
            title: 'Increase Accuracy',
            description: 'AI cross-checks sources and highlights relevant law and conflicts automatically.',
            percentage: '99.7%',
            metric: 'accuracy'
        },
        {
            title: 'Boost Productivity',
            description: 'Automate repetitive legal tasks and focus on legal strategy, not paperwork.',
            percentage: '70%',
            metric: 'time saved'
        },
        {
            title: 'Reduce Costs',
            description: 'Lower billable hours on research and increase client value.',
            percentage: '60%',
            metric: 'cost reduction'
        },
        {
            title: 'Enhance Compliance',
            description: 'Stay in sync with changing laws and regulations for every jurisdiction.',
            percentage: '100%',
            metric: 'compliance'
        }
    ];
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Supercharge your legal research with an AI agent that finds, summarizes, and tracks legal information <span className="text-white font-medium">instantly</span>. Designed for lawyers, students, and legal teams.
                    </div>
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            ...
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">Legal Research AI Agent</h3>
                                        <div className="text-slate-400 text-sm flex items-center gap-2">
                                            <div className="w-2 h-2 bg-emerald-400 rounded-full animate-ping"></div>
                                            Online • Researching in seconds
                                        </div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4">
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-emerald-400">&lt;1min</div>
                                        <div className="text-xs text-slate-400">Avg Research</div>
                                    </div>
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-blue-400">99.7%</div>
                            ...
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3 animate-slideInLeft">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Find the most recent Supreme Court cases on workplace discrimination.</span>
                                        <span className="text-xs text-slate-400 mt-1 block">3:12 PM</span>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '0.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">I found 6 relevant Supreme Court cases since 2020. Would you like a summary or full text?</span>
                                        <span className="text-xs text-blue-100 mt-1 block">3:12 PM</span>
                                    </div>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Summaries, please. Highlight any key changes in interpretation.</span>
                                        <span className="text-xs text-slate-400 mt-1 block">3:13 PM</span>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Summaries generated. Major changes in 2022 and 2024 decisions. Would you like to export a memo?</span>
                                        <span className="text-xs text-slate-400 mt-1 block">3:13 PM</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-3 justify-end">
                                <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 rounded-2xl p-3 border border-blue-500/30">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-xs text-blue-300">AI is researching...</span>
                                    </div>
                                </div>
                                <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center">
                                    <Bot className="w-4 h-4 text-white" />
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('how-it-works') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            AI-powered legal research in
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> four steps</span>
                        </h2>
                    </div>
                    <div className="relative">
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> modern legal research</span>
                        </h2>
                    </div>
            ...
            <section id="channels" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('channels') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Connected to your
                            <span className="bg-gradient-to-r from-blue-400 to-cyan-600 bg-clip-text text-transparent"> favorite legal platforms</span>
                        </h2>
                    </div>
            ...
            <section id="benefits" className="py-16 sm:py-24 lg:py-32 px-4 bg-gradient-to-br from-slate-900/50 to-slate-800/30">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('benefits') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Unlock new efficiency in
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> legal practice</span>
                        </h2>
                    </div>
            ...
            <section id="capabilities" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Next-Generation <span className="bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent">legal intelligence</span>
                        </h2>
                    </div>
                        ...
                        <div className={`relative transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
                            <div className="relative">
                                <div className="relative w-80 h-80 mx-auto">
                                    ...
                                    {[
                                        { label: 'Case Law', angle: 0, color: 'from-blue-500 to-cyan-500' },
                                        { label: 'Drafting', angle: 60, color: 'from-emerald-500 to-teal-500' },
                                        { label: 'Updates', angle: 120, color: 'from-orange-500 to-red-500' },
                                        { label: 'Compliance', angle: 180, color: 'from-purple-500 to-pink-500' },
                                        { label: 'Collaboration', angle: 240, color: 'from-yellow-500 to-orange-500' },
                            ...
                            {[
                                {
                                    ...
                                    description: 'AI scans millions of cases and statutes across jurisdictions for the most relevant results.',
                                    icon: BookOpen,
                                    color: 'from-blue-500 to-cyan-500'
                                },
                                {
                                    title: 'AI-Powered Document Drafting',
                                    description: 'Draft legal memos, motions, and contracts with AI guidance, templates, and context-aware suggestions.',
                                    icon: Cpu,
                                    color: 'from-purple-500 to-pink-500'
                                },
                                {
                                    title: 'Legal Knowledge Updates',
                                    description: 'Instant alerts on new legal decisions, amendments, and news relevant to your practice.',
                                    icon: Zap,
                                    color: 'from-emerald-500 to-teal-500'
                                },
                                {
                                    title: 'Citation Extraction & Analysis',
                                    description: 'Automated citation and precedent mapping for faster legal argument building.',
                                    icon: FileText,
                                    color: 'from-orange-500 to-red-500'
                                },
                                {
                                    title: 'Collaboration & Sharing',
                                    description: 'Multi-user annotation, sharing, and workflow integration for legal teams.',
                                    icon: Users,
                                    color: 'from-indigo-500 to-purple-500'
                                },
                                {
                                    title: 'Security & Confidentiality',
                                    description: 'GDPR, HIPAA, and SOC2 compliance. Your data is protected with military-grade encryption.',
                                    icon: Shield,
            ...
            <section id="cta" className="py-16 sm:py-24 lg:py-32 px-4 bg-gradient-to-br from-slate-900/50 to-slate-800/30">
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        <div className="inline-flex items-center px-4 sm:px-6 py-2 mb-6 sm:mb-8 rounded-full border border-slate-700/50 bg-slate-800/30 backdrop-blur-sm text-xs sm:text-sm text-slate-300">
                            <Zap className="w-4 h-4 mr-2 text-emerald-400" />
                            Ready for the future of legal research?
                        </div>
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 sm:mb-8 leading-tight">
                            Transform your workflow with
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> AI legal research</span>
                        </h2>
                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Join top law firms and legal teams using AI for faster, smarter, and more secure research. Start your journey today—no setup fees or credit card required.
                        </p>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-8 border-t border-slate-700/50">
                            {[
                                { label: 'Jurisdiction Support', value: '50+' },
                                { label: 'Setup Time', value: '< 3 Days' },
                                { label: 'Enterprise Ready', value: 'SOC 2 Certified' },
                                { label: 'Legal Data Sources', value: '50M+' }
                            ].map((item, index) => (
