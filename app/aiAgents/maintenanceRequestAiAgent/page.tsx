...
import { Wrench, Clock, Users, Star, CheckCircle, ArrowRight, Bot, Shield, Zap, BarChart3, Globe, Play, ChevronRight, Brain, Cpu, Database, Settings, Mail, MessageSquare, Smartphone, Home, FileText, Calendar } from 'lucide-react';
import { NavbarDemo } from "@/components/navbar";
import Footer from "@/components/Footer";
import Link from 'next/link';

export default function MaintenanceRequestAIAgent() {
    ...
    const stats = [
        { label: 'Avg Response Time', value: '<10m', icon: Clock, color: 'from-blue-500 to-cyan-500' },
        { label: 'Requests Resolved', value: '15K+', icon: CheckCircle, color: 'from-green-500 to-teal-500' },
        { label: 'Tenant Rating', value: '4.9★', icon: Star, color: 'from-yellow-500 to-orange-500' },
        { label: 'Automated Updates', value: '99%', icon: Zap, color: 'from-purple-500 to-pink-500' },
    ];

    const features = [
        {
            title: 'Instant Maintenance Request',
            description: 'Tenants submit requests via web, app, or SMS with smart categorization and photo uploads.',
            icon: Wrench,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Automated Assignment',
            description: 'AI routes requests to the right maintenance staff or vendor based on skill, location, and urgency.',
            icon: Cpu,
            gradient: 'from-purple-500 to-pink-500'
        },
        {
            title: 'Real-Time Status Tracking',
            description: 'Tenants and managers get instant updates, ETA, and resolution progress on every request.',
            icon: Calendar,
            gradient: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Photo & Document Management',
            description: 'Attach photos, invoices, and service reports to every request for a complete audit trail.',
            icon: FileText,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: 'Smart Notifications',
            description: 'Automated reminders and alerts for overdue tasks, approvals, and follow-ups.',
            icon: Mail,
            gradient: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Analytics Dashboard',
            description: 'Monitor request volume, resolution times, satisfaction, and vendor performance.',
            icon: BarChart3,
            gradient: 'from-pink-500 to-rose-500'
        },
        {
            title: 'Multi-Channel Support',
            description: 'Web portal, mobile app, SMS, email, and voice—manage requests from anywhere.',
            icon: Globe,
            gradient: 'from-rose-500 to-pink-500'
        },
        {
            title: 'Role-Based Access & Security',
            description: 'SOC2, GDPR, and housing law compliant with robust access controls and encrypted storage.',
            icon: Shield,
    ...
    const howItWorks = [
        {
            ...
            description: 'Tenant or staff submits a maintenance request with details and optional photos.',
            icon: MessageSquare,
            color: 'from-blue-500 to-cyan-500'
        },
        {
            step: 2,
            title: 'AI Triage & Assignment',
            description: 'AI assesses urgency, categorizes the request, and assigns it to the right team or vendor.',
            icon: Cpu,
        ...
        },
        {
            ...
            description: 'All parties receive automatic notifications and can track progress until resolution.',
            icon: Calendar,
        ...
        },
        {
            ...
            description: 'Tenant provides feedback, and all records are archived for future reference and analytics.',
            icon: CheckCircle,
    ...
    const integrations = [
        ...
        { name: 'Entrata', category: 'Property Mgmt', logo: '🏘️' },
        { name: 'DocuSign', category: 'e-Signature', logo: '✍️' },
    ];

    const channels = [
        { name: 'Web Portal', icon: Smartphone, description: 'Request or track maintenance from any device.' },
        { name: 'Email & SMS', icon: Mail, description: 'Submit and receive real-time notifications.' },
        { name: 'Tenant App', icon: Users, description: 'Mobile-first self-serve maintenance for tenants.' },
        { name: 'API Integration', icon: Cpu, description: 'Connect requests to your property or workflow system.' }
    ];

    const benefits = [
        {
            title: 'Faster Response & Resolution',
            description: 'Reduce response times and resolve issues quickly with automated routing and updates.',
            percentage: '4x',
            metric: 'faster resolution'
        },
        {
            title: 'Fewer Missed Requests',
            description: 'No lost tickets—AI tracks, escalates, and auto-reminds until closure.',
            percentage: '99%',
            metric: 'resolution rate'
        },
        {
            title: 'Boost Tenant Satisfaction',
            description: 'Transparent status and instant feedback improve trust and retention.',
            percentage: '4.9★',
            metric: 'tenant rating'
        },
        {
            title: 'Reduce Operational Costs',
            description: 'Automate manual workflows, minimize errors, and cut unnecessary site visits.',
            percentage: '40%',
            metric: 'cost savings'
        },
        {
            title: 'Better Vendor Management',
            description: 'Track vendor performance, compliance, and billing in one dashboard.',
            percentage: '6x',
            metric: 'vendor efficiency'
        }
    ];
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Streamline maintenance with AI. Submit, track, and resolve issues instantly—on any device, across any property.
                    </div>
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            ...
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">Maintenance Request AI Agent</h3>
                                ...
                                <div className="flex items-center gap-4">
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-emerald-400">&lt;5m</div>
                                        <div className="text-xs text-slate-400">Avg Response</div>
                                    </div>
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-blue-400">4.9★</div>
                                        <div className="text-xs text-slate-400">Tenant Rating</div>
                                    </div>
                                </div>
                            </div>
                            {/* Chat Interface */}
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3 animate-slideInLeft">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">The AC stopped working in apartment 203. Can someone check it today?</span>
                                ...
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '0.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Maintenance ticket created and assigned. ETA for technician: 1:30 PM. Updates will be sent via SMS and email.</span>
                                        <span className="text-xs text-blue-100 mt-1 block">9:18 AM</span>
                                    </div>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Can I upload a photo of the AC display?</span>
                                        <span className="text-xs text-slate-400 mt-1 block">9:18 AM</span>
                                    </div>
                                </div>
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    <div className="w-8 h-8 bg-slate-700 rounded-full flex items-center justify-center">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Yes, please upload it here or reply to this message via SMS or email.</span>
                                        <span className="text-xs text-slate-400 mt-1 block">9:18 AM</span>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> modern maintenance</span>
                        </h2>
                    </div>
            ...
            <section id="channels" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('channels') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Connect with your
                            <span className="bg-gradient-to-r from-blue-400 to-cyan-600 bg-clip-text text-transparent"> property ecosystem</span>
                        </h2>
                    </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('benefits') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> every time</span>
                        </h2>
                    </div>
            ...
            <section id="capabilities" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Intelligent maintenance workflows
                            <span className="bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent"> with AI</span>
                        </h2>
                    </div>
                        ...
                        <div className={`relative transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
                            <div className="relative">
                                <div className="relative w-80 h-80 mx-auto">
                                    ...
                                    {[
                                        { label: 'Assignment', angle: 0, color: 'from-blue-500 to-cyan-500' },
                                        { label: 'Tracking', angle: 60, color: 'from-emerald-500 to-teal-500' },
                                        { label: 'Reminders', angle: 120, color: 'from-orange-500 to-red-500' },
                                        { label: 'Feedback', angle: 180, color: 'from-purple-500 to-pink-500' },
                            ...
                            {[
                                {
                                    ...
                                    description: 'Automatically routes requests to the best team or vendor for resolution.',
                                    icon: Cpu,
                                    color: 'from-blue-500 to-cyan-500'
                                },
                                {
                                    title: 'Automated Reminders & Escalations',
                                    description: 'No request gets forgotten—AI reminds, escalates, and tracks every step.',
                                    icon: Shield,
                                    color: 'from-purple-500 to-pink-500'
                                },
                                {
                                    title: 'Multi-Channel Request Intake',
                                    description: 'Accept requests via app, web, SMS, or API, with status updates on every channel.',
                                    icon: Globe,
                                    color: 'from-emerald-500 to-teal-500'
                                },
                                {
                                    title: 'Photo & Document Capture',
                                    description: 'Attach media and paperwork for better diagnostics and compliance.',
                                    icon: FileText,
                                    color: 'from-orange-500 to-red-500'
                                },
                                {
                                    title: 'Feedback Collection',
                                    description: 'Solicit instant feedback after completion for continuous improvement.',
                                    icon: Star,
                                    color: 'from-indigo-500 to-purple-500'
                                },
                                {
                                    title: 'Performance Analytics',
                                    description: 'Spot trends, bottlenecks, and opportunities to optimize your operation.',
                                    icon: BarChart3,
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 sm:mb-8 leading-tight">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> with AI requests</span>
                        </h2>
                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Join property managers and tenants using AI to automate, resolve, and optimize maintenance. No IT setup or credit card required.
                        </p>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-8 border-t border-slate-700/50">
                            {[
                                { label: 'Requests Resolved', value: '15K+' },
                                { label: 'Avg Response', value: '< 5m' },
                                { label: 'Tenant Rating', value: '4.9★' },
