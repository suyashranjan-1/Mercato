...
import { ShieldCheck, Clock, Users, Star, CheckCircle, ArrowRight, Bot, Shield, Zap, BarChart3, Globe, Play, ChevronRight, Brain, Cpu, Database, Settings, Mail, MessageSquare, Smartphone, ServerCog, FileText, AlertCircle, Scale, SearchCheck, ScanBarcode } from 'lucide-react';
...
export default function ComplianceMonitoringAIAgent() {
    ...
    const stats = [
        { label: 'Avg Detection Time', value: '<10s', icon: Clock, color: 'from-blue-500 to-cyan-500' },
        { label: 'Compliance Coverage', value: '99.8%', icon: Star, color: 'from-yellow-500 to-orange-500' },
        { label: 'Alerts Resolved', value: '96%', icon: CheckCircle, color: 'from-emerald-500 to-teal-500' },
        { label: 'Uptime', value: '99.99%', icon: Zap, color: 'from-purple-500 to-pink-500' },
    ];

    const features = [
        {
            title: 'Continuous Compliance Detection',
            description: 'Real-time scanning of systems, documents, and processes for regulatory and internal compliance violations.',
            icon: ShieldCheck,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Automated Policy Auditing',
            description: 'Checks activities, files, and communications against policy frameworks (GDPR, HIPAA, SOX, PCI, ISO 27001, and more).',
            icon: FileText,
            gradient: 'from-purple-500 to-pink-500'
        },
        {
            title: 'Risk & Violation Alerting',
            description: 'Instantly flags non-compliant events, misconfigurations, and high-risk activities with detailed context.',
            icon: AlertCircle,
            gradient: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Automated Remediation',
            description: 'Suggests or triggers remediation actions to resolve compliance breaches and prevents recurrence.',
            icon: SearchCheck,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: 'Audit Trail & Evidence Collection',
            description: 'Maintains tamper-proof logs and evidence for every alert, supporting regulatory audits.',
            icon: Database,
            gradient: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Custom Rule Engine',
            description: 'Configure company-specific rules and controls for tailored compliance monitoring.',
            icon: Cpu,
            gradient: 'from-pink-500 to-rose-500'
        },
        {
            title: 'Dashboard & Reporting',
            description: 'Visualize compliance status, trends, and risk posture with real-time dashboards and scheduled reports.',
            icon: BarChart3,
            gradient: 'from-rose-500 to-pink-500'
        },
        {
            title: 'Seamless Integrations',
            description: 'Connects to cloud, on-premise, SaaS, and custom systems for unified compliance coverage.',
            icon: ServerCog,
    ...
    const howItWorks = [
        {
            ...
            description: 'Connects to your data sources, systems, and documents for continuous monitoring.',
            icon: Database,
        ...
        },
        {
            ...
            description: 'Automatically scans for policy violations, misconfigurations, and risky behaviors.',
            icon: ShieldCheck,
        ...
        },
        {
            ...
            description: 'Issues real-time alerts and proposes or executes remediation actions.',
            icon: AlertCircle,
        ...
        },
        {
            ...
            description: 'Generates audit trails, compliance reports, and dashboards for stakeholders.',
            icon: BarChart3,
    ...
    const integrations = [
        ...
        { name: 'Jira', category: 'Task', logo: '✅' },
        { name: 'Google Drive', category: 'Storage', logo: '☁️' },
        { name: 'Confluence', category: 'Docs', logo: '📚' },
    ...
    const channels = [
        { name: 'Web Dashboard', icon: BarChart3, description: 'Centralized compliance status and risk visualization' },
        { name: 'Email Alerts', icon: Mail, description: 'Receive actionable alerts and summaries in your inbox' },
        { name: 'Mobile App', icon: Smartphone, description: 'Monitor and resolve compliance on the go' },
        { name: 'API Integration', icon: ServerCog, description: 'Plug into existing GRC, SIEM, or business systems' }
    ];

    const benefits = [
        {
            title: 'Reduce Compliance Risk',
            description: 'Early detection and resolution of violations minimizes regulatory risk and fines.',
            percentage: '90%',
            metric: 'risk reduction'
        },
        {
            title: 'Continuous Assurance',
            description: '24/7 automated monitoring for always-on compliance and peace of mind.',
            percentage: '24/7',
            metric: 'monitoring'
        },
        {
            title: 'Cut Audit Costs',
            description: 'Automated reporting and evidence collection streamline audit prep and reduce manual effort.',
            percentage: '80%',
            metric: 'audit savings'
        },
        {
            title: 'Accelerate Remediation',
            description: 'Faster response and automated fixes resolve compliance issues before they escalate.',
            percentage: '6x',
            metric: 'faster fixes'
        },
        {
            title: 'Scale Effortlessly',
            description: 'Covers thousands of systems, users, and files without expanding your compliance team.',
            percentage: '∞',
            metric: 'scalability'
        }
    ];
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    <div className="inline-flex items-center px-4 sm:px-6 py-2 mb-6 sm:mb-8 rounded-full border border-slate-700/50 bg-slate-800/30 backdrop-blur-sm text-xs sm:text-sm text-slate-300 hover:border-slate-600/50 transition-all duration-300">
                        <ShieldCheck className="w-4 h-4 mr-2 text-blue-400 animate-pulse" />
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Ensure regulatory and internal policy compliance <span className="text-white font-medium">automatically</span>. Detect, alert, and resolve violations in real time across your entire organization.
                    </div>
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            ...
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">Compliance Monitoring AI Agent</h3>
                                        <div className="text-slate-400 text-sm flex items-center gap-2">
                                            <div className="w-2 h-2 bg-emerald-400 rounded-full animate-ping"></div>
                                            Online • Monitoring continuously
                                        </div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4">
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-emerald-400">99.8%</div>
                                        <div className="text-xs text-slate-400">Compliance Coverage</div>
                                    </div>
                                    <div className="text-right">
                            ...
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3 animate-slideInLeft">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">GDPR data export detected in HR folder. User: john.doe@company.com</span>
                                        <span className="text-xs text-slate-400 mt-1 block">3:15 PM</span>
                                    </div>
                                </div>
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '0.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-green-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Alert: Potential GDPR violation flagged. Auto-remediation initiated: Access revoked, admin notified, incident logged.</span>
                                        <span className="text-xs text-blue-100 mt-1 block">3:15 PM</span>
                                    </div>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">PCI scan: Unencrypted credit card found in support ticket #4542.</span>
                                        <span className="text-xs text-slate-400 mt-1 block">3:16 PM</span>
                                    </div>
                                </div>
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    <div className="w-8 h-8 bg-slate-700 rounded-full flex items-center justify-center">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">HIPAA violation: PHI shared externally. Alert escalated to compliance officer.</span>
                                        <span className="text-xs text-slate-400 mt-1 block">3:17 PM</span>
                                    </div>
                                </div>
                            </div>
                            {/* Typing Indicator */}
                            <div className="flex gap-3 justify-end">
                                <div className="bg-gradient-to-r from-blue-600/20 to-green-600/20 rounded-2xl p-3 border border-blue-500/30">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-xs text-blue-300">AI is scanning...</span>
                                    </div>
                                </div>
                                <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-green-600 rounded-full flex items-center justify-center">
                                    <ShieldCheck className="w-4 h-4 text-white" />
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('how-it-works') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Automated compliance <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent">in every workflow</span>
                        </h2>
                    </div>
                    <div className="relative">
            ...
            <section id="features" className="py-16 sm:py-24 lg:py-32 px-4 bg-gradient-to-br from-slate-900/50 to-slate-800/30">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent">Smarter</span> compliance at scale
                        </h2>
                    </div>
            ...
            <section id="channels" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('channels') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            <span className="bg-gradient-to-r from-blue-400 to-green-600 bg-clip-text text-transparent">Unified</span> compliance everywhere
                        </h2>
                    </div>
            ...
            <section id="benefits" className="py-16 sm:py-24 lg:py-32 px-4 bg-gradient-to-br from-slate-900/50 to-slate-800/30">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('benefits') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent">Stay compliant</span> and secure at scale
                        </h2>
                    </div>
            ...
            <section id="capabilities" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            <span className="bg-gradient-to-r from-green-400 to-blue-600 bg-clip-text text-transparent">Intelligent</span> compliance automation
                        </h2>
                    </div>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            ...
                            <div className="relative">
                                <div className="relative w-80 h-80 mx-auto">
                                    ...
                                    {[
                                        ...
                                        { label: 'AI', angle: 60, color: 'from-emerald-500 to-teal-500' },
                                        { label: 'Audit', angle: 120, color: 'from-orange-500 to-red-500' },
                                        { label: 'Remediate', angle: 180, color: 'from-purple-500 to-pink-500' },
                        ...
                        <div className={`space-y-8 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
                            {[
                                {
                                    title: 'Policy Engine',
                                    description: 'Understands and enforces complex regulatory and internal policies automatically.',
                                    icon: Scale,
                                    color: 'from-blue-500 to-cyan-500'
                                },
                                {
                                    title: 'Advanced AI Detection',
                                    description: 'Uses natural language processing and ML for context-aware compliance and anomaly detection.',
                                    icon: Brain,
                                    color: 'from-green-500 to-teal-500'
                                },
                                {
                                    title: 'Automated Remediation',
                                    description: 'Recommends or executes fixes for compliance issues, reducing risk and workload.',
                                    icon: SearchCheck,
                                    color: 'from-orange-500 to-red-500'
                                },
                                {
                                    title: 'Visual Audit Trails',
                                    description: 'All events and actions logged in immutable, review-ready format for regulators.',
                                    icon: BarChart3,
                                    color: 'from-purple-500 to-pink-500'
                                },
                                {
                                    title: 'Security & Privacy',
                                    description: 'Data protected with industry-leading encryption and role-based access controls.',
                                    icon: Shield,
                                    color: 'from-indigo-500 to-purple-500'
                                },
                                {
                                    title: 'Open Integrations',
                                    description: 'API-first design for seamless fit with your GRC, SIEM, and business tools.',
                                    icon: ServerCog,
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 sm:mb-8 leading-tight">
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent">Automate compliance</span> and protect your business
                        </h2>
                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Join top enterprises using AI to ensure compliance, reduce risk, and accelerate audits. Deploy Compliance Monitoring AI Agent for peace of mind and continuous assurance.
                        </p>
