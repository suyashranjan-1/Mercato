...
export default function InfluencerOutreachAIAgent() {
    ...
    // Influencer Outreach AI Agent: SEO-driven Data
    const stats = [
        { label: 'Avg Campaign Launch', value: '2 mins', icon: Clock, color: 'from-blue-500 to-cyan-500' },
        { label: 'Influencer Match Rate', value: '97%', icon: Star, color: 'from-yellow-500 to-orange-500' },
        { label: 'Response Rate Boost', value: '4.2x', icon: CheckCircle, color: 'from-emerald-500 to-teal-500' },
        { label: 'Platform Coverage', value: '15+', icon: Zap, color: 'from-purple-500 to-pink-500' },
    ];

    const features = [
        {
            title: 'Smart Influencer Discovery',
            description: 'AI recommends the most relevant influencers based on your brand, audience, and campaign goals from a database of 200M+ profiles.',
            icon: Users,
            gradient: 'from-blue-500 to-cyan-500'
        },
        {
            title: 'Automated Personalized Outreach',
            description: 'Crafts and sends tailored messages to influencers at scale, increasing open and response rates with advanced personalization.',
            icon: MessageCircle,
            gradient: 'from-purple-500 to-pink-500'
        },
        {
            title: 'End-to-End Campaign Management',
            description: 'Plan, launch, monitor, and optimize influencer campaigns seamlessly from a single dashboard.',
            icon: Settings,
            gradient: 'from-emerald-500 to-teal-500'
        },
        {
            title: 'Multi-Channel Engagement',
            description: 'Connect with influencers across Instagram, YouTube, TikTok, X (Twitter), LinkedIn, and more.',
            icon: Globe,
            gradient: 'from-orange-500 to-red-500'
        },
        {
            title: 'AI-Powered Analytics',
            description: 'Track campaign ROI, engagement, true reach, conversion, and influencer effectiveness in real time.',
            icon: BarChart3,
            gradient: 'from-indigo-500 to-purple-500'
        },
        {
            title: 'Fraud Detection & Brand Safety',
            description: 'Advanced algorithms detect fake followers, bots, and unsafe content to protect your brand reputation.',
            icon: Shield,
            gradient: 'from-pink-500 to-rose-500'
        },
        {
            title: 'Relationship CRM',
            description: 'Maintain long-term relationships with top influencers and automate follow-ups and negotiations.',
            icon: Database,
            gradient: 'from-rose-500 to-pink-500'
        },
        {
            title: 'Compliance & Contract Automation',
            description: 'Automate contracts, disclosures, and ensure campaign compliance with platform and legal regulations.',
            icon: CheckCircle,
    ...
    const howItWorks = [
        {
            step: 1,
            title: 'Brief & Audience Targeting',
            description: 'Define campaign goals, target audience, and platforms. AI analyzes your brand and optimizes the brief.',
            icon: MessageSquare,
            color: 'from-blue-500 to-cyan-500'
        },
        {
            step: 2,
            title: 'Influencer Match & Outreach',
            description: 'AI identifies best-fit creators, personalizes outreach, and automates multi-channel communication.',
            icon: Brain,
        ...
        },
        {
            ...
            description: 'Streamline content approvals, automate reminders, and monitor campaign progress in real-time.',
            icon: Cpu,
        ...
        },
        {
            ...
            description: 'Get actionable insights, optimize influencer selection, and maximize campaign ROI with continuous learning.',
            icon: BarChart3,
    ...
    const integrations = [
        ...
        { name: 'TikTok', category: 'Short Video', logo: '🎵' },
        { name: 'X (Twitter)', category: 'Social', logo: '🐦' },
        ...
        { name: 'Slack', category: 'Team', logo: '💬' },
        { name: 'Discord', category: 'Community', logo: '🎮' },
        { name: 'Google Analytics', category: 'Analytics', logo: '📊' },
        { name: 'Airtable', category: 'Database', logo: '🗄️' },
        { name: 'Sprout Social', category: 'Social', logo: '🌿' },
        { name: 'Hootsuite', category: 'Social', logo: '🦉' },
    ];

    const channels = [
        { name: 'Instagram DMs', icon: Smartphone, description: 'Direct outreach on the most popular influencer platform' },
        { name: 'Email Outreach', icon: Mail, description: 'Personalized emails to influencers and managers' },
        { name: 'Twitter/X', icon: MessageCircle, description: 'Connect with creators on trending topics' },
        { name: 'LinkedIn Messaging', icon: Phone, description: 'Professional outreach to B2B influencers' }
    ];

    const benefits = [
        {
            title: 'Boost Campaign Efficiency',
            description: 'Automate influencer search, outreach, and reporting to cut campaign cycles from weeks to hours.',
            percentage: '8x',
            metric: 'faster execution'
        },
        {
            title: 'Expand Your Reach',
            description: 'Access global influencer pools and connect in any vertical, language, or region.',
            percentage: '110+',
            metric: 'countries covered'
        },
        {
            title: 'Increase Authentic Engagement',
            description: 'AI ensures contextual alignment between influencers and your brand for genuine audience trust.',
            percentage: '3.5x',
            metric: 'higher engagement'
        },
        {
            title: 'Reduce Manual Work',
            description: 'Eliminate repetitive tasks for your team with end-to-end automation, freeing up strategic focus.',
            percentage: '75%',
            metric: 'less manual effort'
        },
        {
            title: 'Improve ROI',
            description: 'AI-driven selection and analytics ensure every campaign delivers measurable business results.',
            percentage: '5.2x',
            metric: 'average ROI'
        }
    ];
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Accelerate your influencer marketing with an AI agent that finds, engages, and manages creators <span className="text-white font-medium">automatically</span>. Leverage data-driven decisions and reach the right audience on every platform.
                    </div>
                        ...
                        <div className="relative bg-slate-900/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 group">
                            ...
                            <div className="flex items-center justify-between mb-6 p-4 bg-slate-800/40 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold">Influencer Outreach AI Agent</h3>
                                        <div className="text-slate-400 text-sm flex items-center gap-2">
                                            <div className="w-2 h-2 bg-emerald-400 rounded-full animate-ping"></div>
                                            Active • Connecting instantly
                                        </div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="text-right">
                                        <div className="text-sm font-medium text-blue-400">2 mins</div>
                                        <div className="text-xs text-slate-400">Avg Launch</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3 animate-slideInLeft">
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Can you find top tech influencers in Germany with high engagement for our product launch?</span>
                                ...
                                <div className="flex gap-3 justify-end animate-slideInRight" style={{ animationDelay: '0.5s' }}>
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-3 max-w-sm">
                                        <span className="text-sm">Found 124 matching influencers. The top 10 have an average engagement rate of 7.2%. Sample outreach messages are ready for your review. Would you like to launch the campaign?</span>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Yes, and can you ensure all creators have verified audiences?</span>
                                ...
                                <div className="flex gap-3 animate-slideInLeft" style={{ animationDelay: '1s' }}>
                                    ...
                                    <div className="bg-slate-800/50 rounded-2xl p-3 flex-1 max-w-xs">
                                        <span className="text-sm">Absolutely! Filtering only verified influencers and updating campaign outreach now.</span>
                                        <span className="text-xs text-slate-400 mt-1 block">10:13 AM</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-3 justify-end">
                                <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 rounded-2xl p-3 border border-blue-500/30">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-xs text-blue-300">AI is working...</span>
                                    </div>
                                </div>
                                <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center">
                                    <Bot className="w-4 h-4 text-white" />
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('how-it-works') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            From brief to campaign launch in
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> influencer marketing success</span>
                        </h2>
                    </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('channels') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-blue-400 to-cyan-600 bg-clip-text text-transparent"> everywhere they are</span>
                        </h2>
                    </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('benefits') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            ...
                            <span className="bg-gradient-to-r from-emerald-400 to-blue-600 bg-clip-text text-transparent"> with intelligence</span>
                        </h2>
                    </div>
            ...
            <section id="capabilities" className="py-16 sm:py-24 lg:py-32 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold max-w-5xl mx-auto mb-6 sm:mb-8 leading-tight px-4">
                            Advanced AI for
                            <span className="bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent"> influencer outreach</span>
                        </h2>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className={`relative transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
                            <div className="relative">
                                ...
                                <div className="relative w-80 h-80 mx-auto">
                                    ...
                                    {[
                                        { label: 'Discovery', angle: 0, color: 'from-blue-500 to-cyan-500' },
                                        ...
                                        { label: 'Automation', angle: 240, color: 'from-yellow-500 to-orange-500' },
                                        { label: 'CRM', angle: 300, color: 'from-indigo-500 to-purple-500' }
                                    ].map((node, index) => {
                        ...
                        <div className={`space-y-8 transform transition-all duration-1000 ${isInView('capabilities') ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
                            {[
                                {
                                    title: 'Automated Influencer Discovery',
                                    description: 'Find the perfect influencers with AI-driven analysis of 200M+ profiles, engagement, and audience authenticity.',
                                    icon: Users,
                                    color: 'from-blue-500 to-cyan-500'
                                },
                                {
                                    title: 'Personalized Outreach at Scale',
                                    description: 'AI personalizes messages and follow-ups to maximize response and collaboration rates.',
                                    icon: MessageCircle,
                                    color: 'from-purple-500 to-pink-500'
                                },
                                {
                                    title: 'Real-Time Campaign Analytics',
                                    description: 'Get instant feedback on campaign performance, influencer impact, and ROI.',
                                    icon: BarChart3,
                                    color: 'from-emerald-500 to-teal-500'
                                },
                                {
                                    title: 'Fraud & Brand Safety',
                                    description: 'Detect fake followers, bots, and risky content for every influencer before outreach.',
                                    icon: Shield,
                                    color: 'from-orange-500 to-red-500'
                                },
                                {
                                    title: 'Automated Contracts & Compliance',
                                    description: 'Generate, send, and manage influencer contracts and ensure all campaigns meet legal standards.',
                                    icon: CheckCircle,
                                    color: 'from-indigo-500 to-purple-500'
                                },
                                {
                                    title: 'Influencer Relationship CRM',
                                    description: 'Nurture long-term partnerships, automate negotiations, and manage all influencer data in one place.',
                                    icon: Database,
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Start your first campaign in minutes and experience automated influencer discovery, outreach, and analytics—without the hassle. No credit card required to explore all features.
                        </p>

                        {/* Trust Indicators */}
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-8 border-t border-slate-700/50">
                            {[
                                { label: 'Verified Influencer Database', value: '50M+' },
