...
export default function HrChatbotAIAgent() {
    ...
    const howItWorks = [
        {
            ...
            description: 'Employee asks a question via chat, web, or mobile—about policies, leave, payroll, or HR tasks.',
            icon: MessageCircle,
    ...
    const integrations = [
        ...
        { name: 'Microsoft Teams', category: 'Chat', logo: '👥' },
        ...
        { name: 'Asana', category: 'Tasks', logo: '📌' },
        { name: 'Jira', category: 'Tasks', logo: '📋' },
    ];
    ...
    const benefits = [
        ...
        },
        {
            ...
            description: 'SOC2, GDPR, and enterprise security—your HR and employee data is always protected.',
            percentage: '100%',
            ...
            <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                ...
                <div className={`w-full max-w-7xl mx-auto text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-4">
                        Empower your workforce with <span className="text-white font-medium">24/7 HR support</span>. Answer questions, automate HR tasks, and analyze engagement—anytime, anywhere, on any device.
                    </div>
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isInView('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <p className="text-lg sm:text-xl text-slate-300 mb-8 sm:mb-12 leading-relaxed">
                            Unlock the future of HR with AI-powered chat support, automation, and analytics—trusted by leading enterprises. Contact us for a demo or to deploy your HR Chatbot AI Agent!
                        </p>
