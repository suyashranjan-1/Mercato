    ...
    <div className=" w-full   md:items-center md:justify-center bg-black/[0.96] antialiased bg-grid-white/[0.02] relative overflow-hidden ">
      ...
      <div className="md:flex items-start justify-center md:py-20 px-6">
          ...
          <div className="bg-[#f6f5f4] md:w-11/12  space-y-6 p-4 rounded-2xl my-4 hidden md:flex md:flex-col">
            <div className="flex gap-4 border-b ">
              <div className=" font-normal pb-4 ">
                One flexible agency for your entire company to optimize SEO,
                create stunning videos, run high-performing Google & Meta ads,
                design eye-catching thumbnails, and craft impactful graphics.
              </div>
            </div>

            <div className="flex gap-4 border-b ">
              <div className=" font-normal pb-4 ">
                Enterprise features to securely manage campaigns, analytics, and
                creative assets.
              </div>
            </div>
            ...
            <div className="flex gap-4  ">
              <div className=" font-normal pb-4 ">
                Dedicated support to work with you on your strategy and help you
                build the best plan for your business growth.
              </div>
            </div>
          </div>
        </div>
        ...
        <form
          ref={form}
          onSubmit={sendEmail}
          className=" space-y-3 h-full border rounded-3xl p-10 md:w-2/3"
        >
          <div className=" space-y-3 items-center justify-center w-full">
            <label className="font-medium peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-sm bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 bg-opacity-50">
              Full name *
            </label>
            <br />
            <input
              ...
              required
              name="first_name"
              className="form-control, flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
            />
          </div>
          ...
          <div className=" space-y-3 items-center justify-center w-full">
            ...
            <Select name="services" required>
              ...
              <SelectContent>
                ...
                <SelectItem value="Thumbnail Creation">
                  Thumbnail Creation
                </SelectItem>
          ...
          <div className="space-y-3 items-center justify-center w-full">
            ...
            <div className="flex space-x-2 w-full">
              ...
              className="w-1/2 uppercase" // Added uppercase class
              required
              />
          ...
          <div className=" space-y-3 items-center justify-center w-full">
            ...
            <textarea
              name="info"
              className="form-control, flex min-h-[80px] w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
            ></textarea>
          </div>
          <div className="form-check, flex gap-4 items-center">
            <input
              ...
              type="checkbox"
              name="terms"
              className="form-check-input, peer h-4 w-4 shrink-0 rounded-sm border border-primary ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:bg-primary data-[state=checked]:text-primary-foreground, outline
            ...
            <label className="text-xs font-light  md:w-3/4 mb-1 bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400">
              I agree to Mercato Agency&apos;s sending marketing communications
              related to Mercato Agency
            </label>
          </div>
          <div className="flex items-center gap-4">
            <Button
              type="submit"
              className="btn btn-primary, text-sm font-light"
              disabled={loading}
            >
              Submit
            </Button>
