...
// Deterministic pseudo-random generator for icon floating positions, delays, icons
function getFloatingIcons(count: number) {
    ...
    return Array.from({ length: count }).map(() => {
        ...
        const animationDuration = `${4 + random() * 4}s`;
        const icon = iconList[Math.floor(random() * iconList.length)];
        return { left, top, animationDelay, animationDuration, icon };
    });
}
...
export default function DatabasePage() {
    ...
    // Deterministic floating icons array
    const floatingIcons = getFloatingIcons(15);
        ...
        <>
            ...
            <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-black text-white overflow-hidden">
                ...
                <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 py-16 sm:py-20 lg:py-32">
                    ...
                    {/* Floating Database Icons (deterministic) */}
                        ...
                        {floatingIcons.map((iconData, i) => (
                            <div
                                ...
                                style={{
                                    ...
                                    animationDuration: iconData.animationDuration
                                }}
                            >
                                {iconData.icon}
                            </div>
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
                            {stats.map((stat, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div className={`w-12 h-12 sm:w-16 sm:h-16 rounded-2xl sm:rounded-3xl bg-gradient-to-r ${stat.color} flex items-center justify-center mb-3 sm:mb-4 group-hover:scale-110 transition-transform duration-300`}>
