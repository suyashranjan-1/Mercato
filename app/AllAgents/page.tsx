...
export default function AIAgentsPage() {
    ...
    agents: [
        ...
        },
        {
            ...
            "description": "AI agents that streamline financial operations, ensure accuracy in accounting, and enhance financial decision-making with intelligent automation.",
            "agents": [
                {
                    "id": 37,
        ...
        {
            "name": "Social Media",
            "description": "AI agents for managing, optimizing, and automating social media strategies across platforms to boost engagement and visibility.",
            "agents": [
                {
                    "id": 60,
                    "name": "Content Creation AI Agent",
                    "description": "Generate engaging posts, captions, and hashtags tailored for your audience across platforms like Instagram, LinkedIn, and Twitter.",
                    "icon": "📝",
                    "color": "from-indigo-500 to-purple-600",
                ...
                },
                {
                    ...
                    "description": "Plan and automatically publish posts at optimal times for maximum visibility and engagement.",
                    "icon": "🗓️",
                    "color": "from-green-500 to-teal-600",
                ...
                },
                {
                    ...
                    "description": "Monitor likes, shares, comments, and follower growth to evaluate campaign effectiveness in real-time.",
                    "icon": "📈",
                    "color": "from-blue-500 to-cyan-600",
                ...
                },
                {
                    ...
                    "description": "Automatically moderate comments by filtering spam, hate speech, and inappropriate content across platforms.",
                    "icon": "🛡️",
                    "color": "from-red-500 to-pink-600",
                ...
                },
                {
                    ...
                    "description": "Track brand mentions, sentiment, and competitor activity to stay ahead in your market niche.",
                    "icon": "👂",
                ...
                },
                {
                    ...
                    "description": "Identify and connect with relevant influencers, automate outreach messages, and track collaboration performance.",
                    "icon": "🤝",
                    "color": "from-pink-500 to-rose-600",
                ...
                },
                {
                    ...
                    "description": "Analyze real-time social data to spot emerging trends, hashtags, and viral topics before competitors.",
                    "icon": "📊",
        ...
        },
        {
            ...
            "description": "AI agents tailored for real estate and property management, automating leasing, maintenance, tenant communication, and more.",
            "agents": [
                {
                    "id": 53,
...

        {
            ...
            "agents": [
                ...
                },
                {
                    ...
                    "description": "Build AI agents tailored for your custom data analytics and reporting needs with adaptive algorithms.",
                    "icon": "📈",
                    "color": "from-blue-600 to-indigo-700",
                ...
                },
                {
                    ...
                    "description": "Develop AI agents focused on custom natural language processing tasks such as sentiment analysis and language translation.",
                    "icon": "🗣️",
                    "color": "from-green-500 to-teal-600",
                ...
                },
                {
                    ...
                    "description": "Create AI agents specialized in custom image recognition, object detection, and visual data analysis.",
                    "icon": "📷",
                    "color": "from-yellow-500 to-orange-600",
                ...
                },
                {
                    ...
                    "description": "Design AI agents that automate your unique business workflows and processes with full customization.",
                    "icon": "⚙️",
                    "color": "from-red-500 to-pink-600",
                ...
                },
                {
                    ...
                    "description": "Build chatbots customized to your brand voice, customer interaction style, and domain knowledge.",
                    "icon": "💬",
