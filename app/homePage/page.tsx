    ...
    const steps = [
        {
            ...
            description: "Share your current processes, pain points, and automation goals with our AI experts during a free consultation."
        },
        {
            number: "02",
            title: "We Build Your Custom AI Agent",
            description: "Our team creates a tailored AI solution designed specifically for your business needs, integrated with your existing tools."
        },
        {
            number: "03",
            title: "Watch It Work for You",
            description: "Deploy your AI agent and see immediate improvements in efficiency, productivity, and cost savings within days."
        }
    ];
    ...
    const useCases = [
        {
            ...
            description: "Automated lead nurturing sequences that convert 40% more prospects into clients through personalized follow-ups and scheduling.",
        ...
        },
        {
            ...
            description: "Instant order tracking, returns processing, and customer inquiries handled automatically, reducing support workload.",
        ...
        },
        {
            ...
            description: "Smart email management and scheduling automation that saves 15+ hours per week per employee on administrative tasks.",
                    ...
                    <div className="max-w-7xl mx-auto text-center">
                        ...
                        >
                            ...
                            <div className="text-center">
                                <p className="text-gray-400 text-sm mb-4">Trusted by innovative businesses</p>
                ...
                <section id="use-cases" className="py-24 px-4">
                    <div className="max-w-7xl mx-auto">
                        <div className="text-center mb-16">
                            ...
                            >
                                <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
                                    Success <span className="bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent">Stories</span>
                                </h2>
                                <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                            ...
                            {useCases.map((useCase, index) => (
                                ...
                                >
                                    <div className="flex items-center mb-4">
                                        <div className={`p-2 rounded-lg bg-gradient-to-r ${useCase.color} mr-3`}>
                                            <div className="text-white">
                                                {useCase.icon}
                                            </div>
                                        </div>
                                        <span className="text-blue-300 font-semibold">{useCase.industry}</span>
                                    </div>
                                    <h3 className="text-2xl font-bold mb-4 text-white">{useCase.useCase}</h3>
